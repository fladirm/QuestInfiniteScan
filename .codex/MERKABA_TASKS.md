...
- [x] Preserve QRS observation frontend while removing reconstruction authority.
...
- [x] Adapt donor-style controller ray and six-action Quest menu.
- [x] Implement canonical-state save/load/resume.
- [x] Implement/validate offline GLB PBR readout.
- [x] Consolidate target setup wizard and generic build/test/deploy scripts.
- [x] Delete legacy dense-field/generated-surface/appearance-cache/splat production systems.
- [x] Run Unity tests, setup, compile/shader checks, fresh Android build, and eligible deploy.
- [x] Run forensic, performance, serialized-reference, and donor-contamination audits.
- [x] Commit coherent checkpoints, update final state, and close pursuit.
