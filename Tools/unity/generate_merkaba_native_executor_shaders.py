...
PIPELINES = (
    ...
    Pipeline("IntegrateFlowerSkinRgb", "MerkabaIntegration.compute",
             "IntegrateFlowerSkinRgb", "signal_items"),
    Pipeline("IntegrateFlowerSkinV", "MerkabaIntegration.compute",
             "IntegrateFlowerSkinV", "signal_items"),
...
def command_schedules():
    ...
    observation = [
        ...
        "ResolveFlowerCarriers", "IntegrateFlowerSkinRgb", "IntegrateFlowerSkinV",
        "FinalizeObservation",
    ]
