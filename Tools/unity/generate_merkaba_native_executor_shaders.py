...
PIPELINES = (
    ...
    *tuple(Pipeline(f"DilateDepthStep[{8-index}]", "DepthDilation.compute",
    ...
    # Dependency preflight: ring of every tile the attempt may dirty.
    Pipeline("PrepareDependencyRingArgs", "MerkabaIntegration.compute",
             "PrepareDependencyRingArgs", "one"),
    Pipeline("QueryDependencyRing", "MerkabaIntegration.compute",
             "QueryDependencyRing", "observation_indirect"),
    ...
    Pipeline("BeginRenderBuild", "MerkabaReadout.compute",
             "BeginRenderBuild", "one"),
    Pipeline("PrepareRenderReclaim", "MerkabaReadout.compute",
             "PrepareRenderReclaim", "one"),
    Pipeline("ReclaimRenderPages", "MerkabaReadout.compute",
             "ReclaimRenderPages", "readout_indirect"),
    Pipeline("ApplyRenderReclaim", "MerkabaReadout.compute",
             "ApplyRenderReclaim", "one"),
    Pipeline("CopyRenderIndex", "MerkabaReadout.compute",
             "CopyRenderIndex", "front_tiles"),
    Pipeline("MarkRenderRebuildTiles", "MerkabaReadout.compute",
             "MarkRenderRebuildTiles", "one"),
    Pipeline("ApplyRenderMutationJournal", "MerkabaReadout.compute",
             "ApplyRenderMutationJournal", "readout_indirect"),
    Pipeline("RequestWarmResidency", "MerkabaReadout.compute",
             "RequestWarmResidency", "readout_query"),
    Pipeline("CollectRenderRebuildTiles", "MerkabaReadout.compute",
             "CollectRenderRebuildTiles", "front_tiles"),
    Pipeline("PrepareRenderBuild", "MerkabaReadout.compute",
             "PrepareRenderBuild", "one"),
    # ReadoutBatch job: one batch of the BACK transaction.
    Pipeline("AdvanceRenderBuildBatch", "MerkabaReadout.compute",
    ...
    Pipeline("PrepareFineEraseDependencyRingArgs",
             "MerkabaIntegration.compute", "PrepareDependencyRingArgs", "one"),
    Pipeline("QueryFineEraseDependencyRing", "MerkabaIntegration.compute",
             "QueryDependencyRing", "observation_indirect"),
