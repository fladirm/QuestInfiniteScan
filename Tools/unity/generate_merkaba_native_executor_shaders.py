...
PIPELINES = (
    ...
    *tuple(Pipeline(f"DilateDepthStep[{8-index}]", "DepthDilation.compute",
    ...
    Pipeline("PreflightReadout", "MerkabaReadout.compute",
             "PreflightReadout", "readout_indirect"),
    Pipeline("PrepareReadoutEmit", "MerkabaReadout.compute",
             "PrepareReadoutEmit", "one"),
    Pipeline("EmitReadoutVertices", "MerkabaReadout.compute",
             "EmitReadoutVertices", "readout_indirect"),
