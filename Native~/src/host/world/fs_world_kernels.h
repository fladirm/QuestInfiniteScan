...
static const KernelSpec kWorldKernels[K_COUNT] = {
    ...
    {"fuse_reduce",          FS_KS(kFuseReduceSpirv),         0,                     {B_MEAS, B_PAGES, B_SURFELS, B_EVIDENCE, B_GCTR, B_ASSOC_A, B_DIRTY, B_TOPO}, 8},
    ...
    {"fuse_maint_apply",     FS_KS(kFuseMaintApplySpirv),     0,                     {B_PAGES, B_SURFELS, B_EVIDENCE, B_INDEX, B_GCTR, B_POOLS, B_DIRTY, B_RETIRE}, 8},
    {"publish_leaves",       FS_KS(kPublishLeavesSpirv),      sizeof(PushRange),     {B_PAGES, B_SURFELS, B_INDEX, B_GCTR, B_POOLS, B_DIRTY, B_RENDER, B_RBLOCKS, B_RDIR, B_RETIRE}, 10},
