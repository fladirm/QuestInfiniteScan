...
namespace Genesis.RoomScan.Editor
{
    ...
    public static class MerkabaSphereFlowerCodegen
    {
        ...
        internal static string BuildGeneratedTableBlob()
        {
            ...
            int tableBytes = checked(16 * sectors.Length);
            ...
            output.AppendLine("    {");
            output.Append("        internal const int ByteSize = ").Append(checked(3 * tableBytes)).AppendLine(";");
            output.Append("        internal const int RowCount = ").Append(checked(3 * sectors.Length)).AppendLine(";");
