...
Source digest: `f1dab818f20a61fcf69611ab24219ba137cd6d8b6f564d4af148054e90a95a1c`

Scope: 113 files, 1712 symbols, 1389 functions/methods, 80 GPU kernels, 4 event links.
...
`Awake` (method, L88), `ClearAllDataAsync` (method, L273), `ClearScan` (method, L266), `CycleRenderMode` (method, L290), `EnsureScanAnchorAsync` (method, L305), `IsModeAvailable` (method, L300), `ObserveStart` (method, L252), `OnDestroy` (method, L143), `OnDisable` (method, L138), `ReleaseScanResources` (method, L258), `RoomScanner` (class, L37), `ScanLifecycleState` (enum, L16), `ScanRenderMode` (enum, L10), `SetRenderMode` (method, L281), `Start` (method, L109), `StartScanningAsync` (method, L151), `StartScanningCoreAsync` (method, L165), `StopScanning` (method, L220), `ToggleDebugMenu` (method, L303), `ToggleScanning` (method, L242)
...
`ApplyPendingEdges` (gpu_function, L1156), `AssignPendingRetentionSlots` (gpu_function, L1313), `BuildPendingEdges` (gpu_function, L894), `ClearExactClosure` (gpu_function, L869), `ClearTargetReduction` (gpu_function, L262), `ClosePendingEdges` (gpu_function, L989), `CommitPendingRetention` (gpu_function, L1442), `CompactTargetHeads` (gpu_function, L439), `DeferUnresolvedEdges` (gpu_function, L1228), `FinalizeExactClosure` (gpu_function, L1246), `FinalizePendingGauges` (gpu_function, L1202), `FinalizeReducedTargets` (gpu_function, L550), `GatherEdgeEndpoints` (gpu_function, L950), `MapTargetOrdinals` (gpu_function, L455), `MarkPendingRetention` (gpu_function, L1281), `MarkTargetHeads` (gpu_function, L375), `MergeTargetStage` (gpu_function, L318), `MergeTargetTails` (gpu_function, L340), `PersistPendingTargets` (gpu_function, L1361), `ReduceTargetWindow` (gpu_function, L476), `RelaxPendingLabels` (gpu_function, L1187), `ScanTargetHeadBlocks` (gpu_function, L404), `ScanTargetHeadSupers` (gpu_function, L420), `ScanTargetHeads` (gpu_function, L388), `SigmaFrameCompareI64` (gpu_function, L153), `SigmaFrameCompareTarget` (gpu_function, L162), `SigmaFrameCompareU32` (gpu_function, L144), `SigmaFrameEmptyTarget` (gpu_function, L129), `SigmaFrameQualifyEdge` (gpu_function, L840), `SigmaFrameReductionFullBounds` (gpu_function, L221), `SigmaFrameSameTarget` (gpu_function, L208), `SigmaFrameSelectKeys` (gpu_function, L821), `SigmaFrameSourceMask` (gpu_function, L803), `SigmaFrameSourceMaskIndependent` (gpu_function, L229), `SigmaFrameTargetAccepted` (gpu_function, L771), `SigmaFrameTargetActive` (gpu_function, L138), `SigmaFrameTargetChanged` (gpu_function, L788), `SigmaFrameTargetFlags` (gpu_function, L763), `SigmaFrameTargetLess` (gpu_function, L202), `SigmaFrameTargetPending` (gpu_function, L795), `SigmaFrameTargetTransform` (gpu_function, L248), `SigmaFrameTargetViable` (gpu_function, L779), `SigmaPendingSelectKeys` (gpu_function, L1341), `SortTargetBlocks` (gpu_function, L279), `if` (gpu_function, L1080), `if` (gpu_function, L1179), `if` (gpu_function, L1264), `if` (gpu_function, L575), `if` (gpu_function, L609), `ApplyPendingEdges` (gpu_kernel, L17), `AssignPendingRetentionSlots` (gpu_kernel, L23), `BuildPendingEdges` (gpu_kernel, L14), `ClearExactClosure` (gpu_kernel, L13), `ClearTargetReduction` (gpu_kernel, L1), `ClosePendingEdges` (gpu_kernel, L16), `CommitPendingRetention` (gpu_kernel, L25), `CompactTargetHeads` (gpu_kernel, L9), `DeferUnresolvedEdges` (gpu_kernel, L20), `FinalizeExactClosure` (gpu_kernel, L21), `FinalizePendingGauges` (gpu_kernel, L19), `FinalizeReducedTargets` (gpu_kernel, L12), `GatherEdgeEndpoints` (gpu_kernel, L15), `MapTargetOrdinals` (gpu_kernel, L10), `MarkPendingRetention` (gpu_kernel, L22), `MarkTargetHeads` (gpu_kernel, L5), `MergeTargetStage` (gpu_kernel, L3), `MergeTargetTails` (gpu_kernel, L4), `PersistPendingTargets` (gpu_kernel, L24), `ReduceTargetWindow` (gpu_kernel, L11), `RelaxPendingLabels` (gpu_kernel, L18), `ScanTargetHeadBlocks` (gpu_kernel, L7), `ScanTargetHeadSupers` (gpu_kernel, L8), `ScanTargetHeads` (gpu_kernel, L6), `SortTargetBlocks` (gpu_kernel, L2)

### `Runtime/Resources/SigmaPrism/SigmaFrameInverse.compute`

`BuildDepthSourceCells` (gpu_function, L533), `BuildFrameProposals` (gpu_function, L466), `BuildRgbSourceCells` (gpu_function, L662), `ClearFrameState` (gpu_function, L434), `ClearPendingProjection` (gpu_function, L332), `CompactResolvedTargets` (gpu_function, L1341), `EvaluateCandidateMeets` (gpu_function, L1018), `ProjectPendingDepth` (gpu_function, L343), `ResolvePendingProjection` (gpu_function, L386), `SigmaFrameBootstrapCoordinate` (gpu_function, L645), `SigmaFrameBuildNovelState` (gpu_function, L965), `SigmaFrameCandidateLess` (gpu_function, L284), `SigmaFrameCellAddress` (gpu_function, L148), `SigmaFrameEmptyCandidate` (gpu_function, L248), `SigmaFrameExactEnabled` (gpu_function, L135), `SigmaFrameFullBounds` (gpu_function, L140), `SigmaFrameLoadDepthJoint` (gpu_function, L607), `SigmaFrameLoadMetric` (gpu_function, L159), `SigmaFramePendingCandidate` (gpu_function, L312), `SigmaFramePixel` (gpu_function, L153), `SigmaFramePredictionCandidate` (gpu_function, L258), `SigmaFrameProjectDepth` (gpu_function, L193), `SigmaFrameProjectPending` (gpu_function, L219), `SigmaFrameReferenceWorld` (gpu_function, L169), `SigmaFrameSameCandidate` (gpu_function, L302), `SigmaFrameSourceBounds` (gpu_function, L906), `SigmaFrameSourceProvenance` (gpu_function, L937), `SigmaFrameTransformRow` (gpu_function, L951), `if` (gpu_function, L1036), `if` (gpu_function, L1086), `if` (gpu_function, L1091), `if` (gpu_function, L917), `if` (gpu_function, L923), `BuildDepthSourceCells` (gpu_kernel, L6), `BuildFrameProposals` (gpu_kernel, L5), `BuildRgbSourceCells` (gpu_kernel, L7), `ClearFrameState` (gpu_kernel, L1), `ClearPendingProjection` (gpu_kernel, L2), `CompactResolvedTargets` (gpu_kernel, L9), `EvaluateCandidateMeets` (gpu_kernel, L8), `ProjectPendingDepth` (gpu_kernel, L3), `ResolvePendingProjection` (gpu_kernel, L4)
...
`BindCarrier` (method, L1256), `BindEvaluate` (method, L1166), `BindExactClosureBase` (method, L713), `BindExactEdgeWindow` (method, L779), `BindExactTargetWindow` (method, L960), `BindExecutionWindow` (method, L1447), `BindFootprintWindow` (method, L1473), `BindFrameConstants` (method, L1036), `BindPendingClosureReadWindow` (method, L981), `BindPendingClosureWriteWindow` (method, L996), `BindPendingInverseWindow` (method, L1233), `BindPendingProjectionInput` (method, L1212), `BindPendingProjectionOutput` (method, L1197), `BindProposal` (method, L1072), `BindPublishKernel` (method, L806), `BindReductionCarrier` (method, L1016), `BindReductionCarrier` (method, L1021), `BindReductionSourceWindow` (method, L914), `BindSourceOutputs` (method, L1274), `BindSourceRead` (method, L1305), `BindSourceReads` (method, L1292), `BindTargetReductionBase` (method, L862), `BindTargetWindow` (method, L936), `CameraPose` (method, L18), `CeilDiv` (method, L1410), `CreateBuffer` (method, L1383), `Dispose` (method, L700), `FindKernels` (method, L1387), `FirstSegment` (method, L1369), `FromCamera` (method, L14), `Intrinsics` (method, L1396), `Packed` (method, L1400), `RecordCompactWindow` (method, L1418), `RecordCompactWindow` (method, L436), `RecordDepthSource` (method, L1105), `RecordExactClosure` (method, L580), `RecordExactClosureOnly` (method, L595), `RecordPendingProjection` (method, L387), `RecordRgbSource` (method, L1137), `RecordSourceAndResolve` (method, L265), `RecordTargetReduction` (method, L448), `RecordWindowChunks` (method, L1456), `RequireAlive` (method, L1480), `SetFrameMatrices` (method, L1323), `SigmaFrameGraph` (class, L129), `SigmaFrameInverseInput` (struct, L36), `SigmaFramePublicationTarget` (struct, L80), `SigmaRoomFrame` (class, L12), `Single` (method, L1359), `TryAcquire` (method, L255), `Window` (method, L1413)

### `Runtime/SigmaPrism/SigmaFrameResources.cs`

`AdditionalBytesFor` (method, L70), `BufferBytes` (method, L968), `ComputeExecutionWindowFootprints` (method, L774), `ComputeSegmentRecordCapacity` (method, L761), `CreateBuffer` (method, L959), `Dispose` (method, L106), `Dispose` (method, L220), `Dispose` (method, L241), `Dispose` (method, L276), `Dispose` (method, L857), `EstimateSourceBytes` (method, L746), `ExecutionWindow` (method, L799), `FrameSlot` (struct, L1015), `Get` (method, L231), `GetSources` (method, L824), `GrowTo` (method, L79), `Lower` (method, L211), `NextPowerOfTwo` (method, L971), `Provenance` (method, L218), `Release` (method, L837), `RequireAlive` (method, L117), `RequireAlive` (method, L953), `RequireSlot` (method, L942), `Retain` (method, L269), `Retain` (method, L830), `Segment` (method, L62), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameExecutionWindow` (struct, L1023), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L295), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L131), `SigmaOwnedFrameLease` (class, L250), `TryAcquireFrame` (method, L540), `TryEnsureCandidateCapacity` (method, L599), `TryEnsureClosureCapacity` (method, L700), `TryEnsureDirtyEdgeCapacity` (method, L694), `TryEnsurePendingCapacity` (method, L655), `TryEnsureRevisionCapacity` (method, L697), `TryEnsureTargetScratchCapacity` (method, L691), `TryGrow` (method, L928), `TryReserve` (method, L939), `UInt4` (method, L981), `Upper` (method, L214), `ValidateGeneratedAbi` (method, L984), `Validity` (method, L216), `WindowBuffer` (method, L809)
...
`AbsNanoseconds` (method, L754), `Add` (method, L906), `AdvanceAge` (method, L991), `Begin` (method, L967), `BuildTrackingPriorEnvelope` (method, L519), `CaptureTimingTelemetry` (method, L218), `CeilDiv` (method, L786), `Complete` (method, L1023), `CountPendingTickets` (method, L713), `CreateArrayTexture` (method, L792), `CreateBuffer` (method, L789), `CreatePersistentResources` (method, L616), `DestroyTexture` (method, L822), `Dispose` (method, L1038), `ElapsedMilliseconds` (method, L992), `EnsureCalibration` (method, L591), `EnsureDirectGraph` (method, L232), `EnsureFrameResources` (method, L994), `EnsurePosePartials` (method, L1011), `FillCalibration` (method, L640), `FillRgbCalibration` (method, L677), `FindKernels` (method, L604), `FromRaw` (method, L891), `IndependenceKey` (method, L759), `IngressSlot` (class, L927), `LatchCompletionFault` (method, L368), `LateUpdate` (method, L166), `LatencyTracker` (class, L894), `MaxRigRotationResidual` (method, L578), `MaxRigTranslationResidual` (method, L565), `Mix` (method, L781), `NextRevision` (method, L737), `OnDestroy` (method, L833), `OnModuleInitialize` (method, L101), `OnPredictionReady` (method, L158), `OnScanStarted` (method, L136), `OnScanStopped` (method, L150), `Poll` (method, L988), `PollIngress` (method, L338), `RecordCorrectedCalibration` (method, L458), `RecordNormalize` (method, L379), `RecordPoseGauge` (method, L404), `ReleasePendingIngress` (method, L725), `Reset` (method, L918), `SaturatingAdd` (method, L757), `SetQ` (method, L745), `SetQRaw` (method, L748), `SetRgbQ` (method, L750), `SetRgbQRaw` (method, L752), `SigmaInverseController` (class, L22), `SigmaPackedQ48` (struct, L882), `SubmitIngress` (method, L250), `TrackLast` (method, L731), `TryGetFreeIngressSlot` (method, L695), `UploadExactCalibration` (method, L486), `UploadPosePrior` (method, L499)
...
`AdjacentThinStatesRequireExactSingularClosure` (method, L400), `ArrayRenderTexture` (method, L1405), `AssertCandidates` (method, L564), `AssertMatrix` (method, L1628), `AssertPublished` (method, L507), `AssertUInt4` (method, L520), `BuildCarrierPrior` (method, L1507), `BuildCpuOracle` (method, L595), `Candidate` (method, L728), `ClaimedUnresolvedEdgeDefersOnlyIncidentChanges` (method, L373), `ClearPrediction` (method, L1428), `CloseCurrentFrame` (method, L872), `ClosureSnapshot` (class, L113), `ClosureTarget` (struct, L91), `ComposePose` (method, L1638), `ConstrainedLaneCount` (method, L698), `ContactZeroDivisorState` (method, L1523), `Contains` (method, L724), `CurrentPage` (method, L577), `DepthCalibration` (method, L1451), `Destroy` (method, L1622), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L224), `Dispose` (method, L1306), `ExactRegularEdgesJoinPendingAndAnchorContinuation` (method, L342), `FrameFixture` (class, L739), `Gpu4` (method, L1619), `Intrinsics` (method, L1356), `NormalizeDepth` (method, L1385), `Packed` (method, L1536), `PageMeta` (struct, L43), `PageState` (method, L587), `PendingCandidates` (method, L559), `PendingEdgesCrossExecutionWindowsWithoutChangingPhysics` (method, L477), `PendingEvidenceSurvivesAndReusesItsExactHandle` (method, L424), `PendingProjectionIsInvariantAcrossOneTwoAndSevenWindows` (method, L460), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L271), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L1373), `ReadPendingGauge` (method, L884), `ReadSnapshot` (method, L1329), `ReductionSnapshot` (class, L79), `RgbCalibration` (method, L1482), `RgbTexture` (method, L1361), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L127), `Run` (method, L857), `RunBoundaryClosure` (method, L538), `RunExactClosure` (method, L1144), `RunPendingProjectionLayout` (method, L529), `RunPublished` (method, L1266), `RunSegmentedTargetFixture` (method, L933), `RunTargetReduction` (method, L1032), `ScalarState` (method, L1520), `SeedPending` (method, L890), `Set` (method, L1497), `SetCandidateCell` (method, L1248), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L736), `Snapshot` (class, L58), `SourceKey` (method, L710), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L279), `UInt2` (struct, L27), `UInt4` (struct, L34), `UnobservedAdjacencyMakesNoTransitionClaim` (method, L323), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L158)
