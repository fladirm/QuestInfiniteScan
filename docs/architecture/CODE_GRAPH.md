...
Source digest: `7b33d50842101d0920f3e772ba13de2e5c082161f6ca2778b9a60d43471f5830`

Scope: 113 files, 1666 symbols, 1350 functions/methods, 75 GPU kernels, 4 event links.
...
`AllocatePendingRoots` (gpu_function, L1040), `BuildDirtyEdges` (gpu_function, L1160), `BuildPendingEdges` (gpu_function, L882), `ClearFrameClosure` (gpu_function, L839), `ClearFrameClosureStorage` (gpu_function, L868), `ClearTargetReduction` (gpu_function, L392), `CompactTargetHeads` (gpu_function, L563), `FinalizePendingGauges` (gpu_function, L942), `FinalizeReducedTargets` (gpu_function, L653), `MarkTargetHeads` (gpu_function, L504), `MergeTargetStage` (gpu_function, L447), `MergeTargetTails` (gpu_function, L469), `ReduceTargetWindow` (gpu_function, L579), `RelaxPendingLabels` (gpu_function, L912), `ReserveFrameAllocation` (gpu_function, L1023), `ResolveFrameTargets` (gpu_function, L1098), `ScanPendingRootBlocks` (gpu_function, L989), `ScanPendingRootSupers` (gpu_function, L1007), `ScanPendingRoots` (gpu_function, L971), `ScanTargetHeadBlocks` (gpu_function, L533), `ScanTargetHeadSupers` (gpu_function, L549), `ScanTargetHeads` (gpu_function, L517), `SigmaFrameAddU64` (gpu_function, L365), `SigmaFrameClosureEnabled` (gpu_function, L248), `SigmaFrameCompareI64` (gpu_function, L141), `SigmaFrameCompareTarget` (gpu_function, L150), `SigmaFrameCompareU32` (gpu_function, L132), `SigmaFrameDepthBounds` (gpu_function, L294), `SigmaFrameEmptyTarget` (gpu_function, L117), `SigmaFrameOutcomeFlags` (gpu_function, L259), `SigmaFramePaddedWidth` (gpu_function, L371), `SigmaFramePendingActive` (gpu_function, L265), `SigmaFramePendingCompatible` (gpu_function, L320), `SigmaFrameReductionFullBounds` (gpu_function, L207), `SigmaFrameResolved` (gpu_function, L253), `SigmaFrameRootCost` (gpu_function, L378), `SigmaFrameSameTarget` (gpu_function, L195), `SigmaFrameSourceMaskIndependent` (gpu_function, L215), `SigmaFrameStateHasContact` (gpu_function, L286), `SigmaFrameStateLane` (gpu_function, L279), `SigmaFrameTargetActive` (gpu_function, L126), `SigmaFrameTargetLess` (gpu_function, L189), `SigmaFrameTargetTransform` (gpu_function, L234), `SortTargetBlocks` (gpu_function, L408), `AllocatePendingRoots` (gpu_kernel, L10), `BuildDirtyEdges` (gpu_kernel, L12), `BuildPendingEdges` (gpu_kernel, L3), `ClearFrameClosure` (gpu_kernel, L1), `ClearFrameClosureStorage` (gpu_kernel, L2), `ClearTargetReduction` (gpu_kernel, L13), `CompactTargetHeads` (gpu_kernel, L21), `FinalizePendingGauges` (gpu_kernel, L5), `FinalizeReducedTargets` (gpu_kernel, L23), `MarkTargetHeads` (gpu_kernel, L17), `MergeTargetStage` (gpu_kernel, L15), `MergeTargetTails` (gpu_kernel, L16), `ReduceTargetWindow` (gpu_kernel, L22), `RelaxPendingLabels` (gpu_kernel, L4), `ReserveFrameAllocation` (gpu_kernel, L9), `ResolveFrameTargets` (gpu_kernel, L11), `ScanPendingRootBlocks` (gpu_kernel, L7), `ScanPendingRootSupers` (gpu_kernel, L8), `ScanPendingRoots` (gpu_kernel, L6), `ScanTargetHeadBlocks` (gpu_kernel, L19), `ScanTargetHeadSupers` (gpu_kernel, L20), `ScanTargetHeads` (gpu_kernel, L18), `SortTargetBlocks` (gpu_kernel, L14)

### `Runtime/Resources/SigmaPrism/SigmaFrameInverse.compute`

`BuildDepthSourceCells` (gpu_function, L348), `BuildFrameProposals` (gpu_function, L299), `BuildRgbSourceCells` (gpu_function, L477), `ClearFrameState` (gpu_function, L267), `CompactResolvedTargets` (gpu_function, L1112), `EvaluateCandidateMeets` (gpu_function, L833), `SigmaFrameBootstrapCoordinate` (gpu_function, L460), `SigmaFrameBuildNovelState` (gpu_function, L780), `SigmaFrameCandidateLess` (gpu_function, L239), `SigmaFrameCellAddress` (gpu_function, L132), `SigmaFrameEmptyCandidate` (gpu_function, L203), `SigmaFrameExactEnabled` (gpu_function, L119), `SigmaFrameFullBounds` (gpu_function, L124), `SigmaFrameLoadDepthJoint` (gpu_function, L422), `SigmaFrameLoadMetric` (gpu_function, L143), `SigmaFramePixel` (gpu_function, L137), `SigmaFramePredictionCandidate` (gpu_function, L213), `SigmaFrameProjectDepth` (gpu_function, L177), `SigmaFrameReferenceWorld` (gpu_function, L153), `SigmaFrameSameCandidate` (gpu_function, L257), `SigmaFrameSourceBounds` (gpu_function, L721), `SigmaFrameSourceProvenance` (gpu_function, L752), `SigmaFrameTransformRow` (gpu_function, L766), `if` (gpu_function, L732), `if` (gpu_function, L738), `if` (gpu_function, L884), `BuildDepthSourceCells` (gpu_kernel, L3), `BuildFrameProposals` (gpu_kernel, L2), `BuildRgbSourceCells` (gpu_kernel, L4), `ClearFrameState` (gpu_kernel, L1), `CompactResolvedTargets` (gpu_kernel, L6), `EvaluateCandidateMeets` (gpu_kernel, L5)
...
`BindCarrier` (method, L981), `BindClosureDepth` (method, L698), `BindClosureKernel` (method, L571), `BindEvaluate` (method, L952), `BindExecutionWindow` (method, L1189), `BindFootprintWindow` (method, L1215), `BindFrameConstants` (method, L827), `BindProposal` (method, L863), `BindPublishKernel` (method, L642), `BindReductionCarrier` (method, L807), `BindReductionCarrier` (method, L812), `BindReductionSourceWindow` (method, L761), `BindSourceOutputs` (method, L999), `BindSourceRead` (method, L1030), `BindSourceReads` (method, L1017), `BindTargetReductionBase` (method, L713), `BindTargetWindow` (method, L783), `CameraPose` (method, L18), `CeilDiv` (method, L1152), `CreateBuffer` (method, L1125), `Dispose` (method, L558), `FindKernels` (method, L1129), `FirstSegment` (method, L1111), `FromCamera` (method, L14), `Intrinsics` (method, L1138), `Packed` (method, L1142), `RecordClosureAndPublish` (method, L482), `RecordCompactWindow` (method, L1160), `RecordCompactWindow` (method, L363), `RecordDepthSource` (method, L891), `RecordRgbSource` (method, L923), `RecordSourceAndResolve` (method, L256), `RecordTargetReduction` (method, L375), `RecordWindowChunks` (method, L1198), `RequireAlive` (method, L1222), `RequireSingleExecutionWindow` (method, L1084), `SetFrameMatrices` (method, L1048), `SigmaFrameGraph` (class, L129), `SigmaFrameInverseInput` (struct, L36), `SigmaFramePublicationTarget` (struct, L80), `SigmaRoomFrame` (class, L12), `Single` (method, L1101), `TryAcquire` (method, L246), `Window` (method, L1155)

### `Runtime/SigmaPrism/SigmaFrameResources.cs`

`AdditionalBytesFor` (method, L70), `BufferBytes` (method, L884), `ComputeExecutionWindowFootprints` (method, L698), `ComputeSegmentRecordCapacity` (method, L685), `CreateBuffer` (method, L875), `Dispose` (method, L106), `Dispose` (method, L220), `Dispose` (method, L241), `Dispose` (method, L276), `Dispose` (method, L781), `EstimateSourceBytes` (method, L670), `ExecutionWindow` (method, L723), `FrameSlot` (struct, L931), `Get` (method, L231), `GetSources` (method, L748), `GrowTo` (method, L79), `Lower` (method, L211), `NextPowerOfTwo` (method, L887), `Provenance` (method, L218), `Release` (method, L761), `RequireAlive` (method, L117), `RequireAlive` (method, L869), `RequireSlot` (method, L858), `Retain` (method, L269), `Retain` (method, L754), `Segment` (method, L62), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameExecutionWindow` (struct, L939), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L295), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L131), `SigmaOwnedFrameLease` (class, L250), `TryAcquireFrame` (method, L500), `TryEnsureCandidateCapacity` (method, L559), `TryEnsureClosureCapacity` (method, L624), `TryEnsureDirtyEdgeCapacity` (method, L618), `TryEnsurePendingGaugeCapacity` (method, L615), `TryEnsureRevisionCapacity` (method, L621), `TryGrow` (method, L844), `TryReserve` (method, L855), `UInt4` (method, L897), `Upper` (method, L214), `ValidateGeneratedAbi` (method, L900), `Validity` (method, L216), `WindowBuffer` (method, L733)
...
`ArrayRenderTexture` (method, L960), `AssertMatrix` (method, L1150), `AssertPublished` (method, L285), `BuildCarrierPrior` (method, L1062), `BuildCpuOracle` (method, L316), `Candidate` (method, L449), `ClearPrediction` (method, L983), `ComposePose` (method, L1160), `ConstrainedLaneCount` (method, L419), `Contains` (method, L445), `CurrentPage` (method, L298), `DepthCalibration` (method, L1006), `Destroy` (method, L1144), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L190), `Dispose` (method, L861), `FrameFixture` (class, L460), `Gpu4` (method, L1141), `Intrinsics` (method, L911), `NormalizeDepth` (method, L940), `Packed` (method, L1075), `PageMeta` (struct, L43), `PageState` (method, L308), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L237), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L928), `ReadSnapshot` (method, L884), `ReductionSnapshot` (class, L79), `RgbCalibration` (method, L1037), `RgbTexture` (method, L916), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L93), `Run` (method, L578), `RunPublished` (method, L821), `RunSegmentedTargetFixture` (method, L592), `RunTargetReduction` (method, L691), `Set` (method, L1052), `SetCandidateCell` (method, L803), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L457), `Snapshot` (class, L58), `SourceKey` (method, L431), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L245), `UInt2` (struct, L27), `UInt4` (struct, L34), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L124)
