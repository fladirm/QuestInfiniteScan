...
Source digest: `29a9f392a74d587c49f9d9cb7149ff643734164955b21b10a56ea89f542c8db0`

Scope: 107 files, 1569 symbols, 1288 functions/methods, 60 GPU kernels, 5 event links.
...
- `SigmaRenderer.PredictionReady` → `OnPredictionReady` ([Runtime/SigmaPrism/SigmaInverseController.cs:203](../../Runtime/SigmaPrism/SigmaInverseController.cs#L203))
...
`BuildGaugeDemand` (gpu_function, L795), `ClearProofTransaction` (gpu_function, L554), `ReduceProofPage` (gpu_function, L563), `SigmaAppendSourceCandidate` (gpu_function, L318), `SigmaCandidateBound` (gpu_function, L83), `SigmaCertificateLess` (gpu_function, L93), `SigmaClearCandidate` (gpu_function, L73), `SigmaComputeCandidateMeet` (gpu_function, L186), `SigmaFullBounds` (gpu_function, L45), `SigmaGaugeDistanceToInterval` (gpu_function, L501), `SigmaGaugeMidpoint` (gpu_function, L492), `SigmaGaugeSharedPairCoversTriple` (gpu_function, L511), `SigmaGaugeSourceLane` (gpu_function, L453), `SigmaIndependentCoordinateMask` (gpu_function, L155), `SigmaLoadPriorCertificates` (gpu_function, L234), `SigmaMaskBit` (gpu_function, L58), `SigmaPopCount64` (gpu_function, L53), `SigmaProofEqualsSource` (gpu_function, L414), `SigmaRemoveCandidate` (gpu_function, L138), `SigmaSameCoalesceKey` (gpu_function, L147), `SigmaSameProofResult` (gpu_function, L216), `SigmaSetCandidateBound` (gpu_function, L88), `SigmaSetMaskBit` (gpu_function, L65), `SigmaSourceCell` (gpu_function, L269), `SigmaSwapCandidates` (gpu_function, L117), `BuildGaugeDemand` (gpu_kernel, L3), `ClearProofTransaction` (gpu_kernel, L1), `ReduceProofPage` (gpu_kernel, L2)
...
`AccumulateTopologyEvidence` (gpu_function, L680), `BuildCellCutFlags` (gpu_function, L899), `BuildSampleSupport` (gpu_function, L352), `BuildTopologyDispatchArgs` (gpu_function, L547), `BuildTransitionMeta` (gpu_function, L368), `BuildTransitionTau` (gpu_function, L474), `ClearTopologyCache` (gpu_function, L231), `ClearTopologyPage` (gpu_function, L249), `ClearTopologyWork` (gpu_function, L281), `CopyPriorTopologyPage` (gpu_function, L269), `EvaluateAssociatorCells` (gpu_function, L752), `FinalizeTransitionClasses` (gpu_function, L828), `MarkTopologyCandidates` (gpu_function, L521), `PublishTopologyPage` (gpu_function, L943), `ScanAnnihilatorCatalog` (gpu_function, L556), `SigmaAddIndependentKey` (gpu_function, L199), `SigmaEvidenceChanged` (gpu_function, L187), `SigmaEvidenceDiscontinuity` (gpu_function, L174), `SigmaEvidenceHitMask` (gpu_function, L155), `SigmaEvidenceMode` (gpu_function, L123), `SigmaLoadDownState` (gpu_function, L114), `SigmaLoadRightState` (gpu_function, L105), `SigmaLoadTargetState` (gpu_function, L96), `SigmaLoadTransitionEndpoints` (gpu_function, L290), `SigmaNeighbourTransition` (gpu_function, L882), `SigmaReadProposalEvidence` (gpu_function, L129), `SigmaTopologyCacheIndex` (gpu_function, L86), `SigmaTopologyCellIndex` (gpu_function, L91), `SigmaTopologyRecordCuts` (gpu_function, L226), `SigmaTopologyTransitionIndex` (gpu_function, L81), `if` (gpu_function, L312), `if` (gpu_function, L335), `if` (gpu_function, L393), `if` (gpu_function, L468), `if` (gpu_function, L654), `if` (gpu_function, L709), `if` (gpu_function, L715), `AccumulateTopologyEvidence` (gpu_kernel, L11), `BuildCellCutFlags` (gpu_kernel, L14), `BuildSampleSupport` (gpu_kernel, L5), `BuildTopologyDispatchArgs` (gpu_kernel, L9), `BuildTransitionMeta` (gpu_kernel, L6), `BuildTransitionTau` (gpu_kernel, L7), `ClearTopologyCache` (gpu_kernel, L1), `ClearTopologyPage` (gpu_kernel, L2), `ClearTopologyWork` (gpu_kernel, L4), `CopyPriorTopologyPage` (gpu_kernel, L3), `EvaluateAssociatorCells` (gpu_kernel, L12), `FinalizeTransitionClasses` (gpu_kernel, L13), `MarkTopologyCandidates` (gpu_kernel, L8), `PublishTopologyPage` (gpu_kernel, L15), `ScanAnnihilatorCatalog` (gpu_kernel, L10)

### `Runtime/Resources/SigmaPrism/SigmaInverse.compute`

`BuildDepthProposals` (gpu_function, L451), `ClassifyDepthFrame` (gpu_function, L336), `ClearInverseFrame` (gpu_function, L314), `CommitDepthProposals` (gpu_function, L544), `CompactActivePages` (gpu_function, L423), `EvaluateDepthMeetFixture` (gpu_function, L703), `EvaluateNullDepthMeetFixture` (gpu_function, L762), `PromoteGaugePage` (gpu_function, L623), `SigmaAppendEvidence` (gpu_function, L288), `SigmaBuildMatchedEyeCell` (gpu_function, L233), `SigmaCaptureDepthRaw` (gpu_function, L127), `SigmaCaptureRgbRaw` (gpu_function, L105), `SigmaDepthWorldPointCandidate` (gpu_function, L192), `SigmaFirstHitSectorForPixel` (gpu_function, L202), `SigmaPackPixel16` (gpu_function, L93), `SigmaPackSourceNibbles` (gpu_function, L262), `SigmaPackUnorm4x8Exact` (gpu_function, L98), `SigmaPredictionHasContact` (gpu_function, L162), `SigmaPredictionMatchesSample` (gpu_function, L217), `SigmaProjectWorldToPixel` (gpu_function, L168), `SigmaWriteProofSample` (gpu_function, L140), `BuildDepthProposals` (gpu_kernel, L4), `ClassifyDepthFrame` (gpu_kernel, L2), `ClearInverseFrame` (gpu_kernel, L1), `CommitDepthProposals` (gpu_kernel, L5), `CompactActivePages` (gpu_kernel, L3), `EvaluateDepthMeetFixture` (gpu_kernel, L7), `EvaluateNullDepthMeetFixture` (gpu_kernel, L8), `PromoteGaugePage` (gpu_kernel, L6)
...
`SigmaAccumulateIndependentKey` (gpu_function, L380), `SigmaBuildJointProposal` (gpu_function, L420), `SigmaBuildRgbCell` (gpu_function, L257), `SigmaBuildRgbMeasurement` (gpu_function, L124), `SigmaJointMeetCoordinate` (gpu_function, L358), `SigmaProjectWorldToRgb` (gpu_function, L96), `SigmaRevalidateJointCandidate` (gpu_function, L391), `SigmaRgbBuildInequality` (gpu_function, L185), `SigmaRgbCalibrationValue` (gpu_function, L38), `SigmaRgbCeilHalfMagnitude` (gpu_function, L53), `SigmaRgbContractInequality` (gpu_function, L220), `SigmaRgbEvaluateRow` (gpu_function, L162), `SigmaRgbLoad` (gpu_function, L113), `SigmaRgbOperator` (gpu_function, L48), `SigmaRgbOperatorAddress` (gpu_function, L43), `SigmaRgbQuantizedComponent` (gpu_function, L62), `SigmaRgbQuantizedDirection` (gpu_function, L72), `SigmaRgbSignedOperator` (gpu_function, L178)
...
`Abort` (method, L573), `AbortGauge` (method, L502), `BeginFrame` (method, L188), `BeginGaugePage` (method, L349), `BeginPage` (method, L209), `BindCommon` (method, L646), `BindGaugeReadOnly` (method, L325), `BindGaugeSource` (method, L413), `BindGaugeSourceReadOnly` (method, L331), `BindGaugeTarget` (method, L425), `BindInverse` (method, L249), `BindReadOnly` (method, L263), `BindReadOnly` (method, L281), `CertificateOffsetForSlot` (method, L594), `CloseFrame` (method, L584), `CreateBuffer` (method, L736), `DecodeCertificateSlot` (method, L597), `DecodeSourceSlot` (method, L634), `DescendingStack` (method, L740), `Dispose` (method, L607), `Dispose` (method, L883), `Dispose` (method, L916), `Dispose` (method, L958), `From` (method, L760), `From` (method, L784), `From` (method, L816), `High` (method, L862), `Intrinsics` (method, L855), `Low` (method, L860), `MarkDisposed` (method, L882), `MarkDisposed` (method, L915), `MarkDisposed` (method, L957), `MarkPublished` (method, L910), `MarkPublished` (method, L952), `Prepare` (method, L239), `Publish` (method, L539), `PublishGauge` (method, L469), `ReadStatus` (method, L514), `Reduce` (method, L292), `ReleaseProofSlot` (method, L659), `ReleaseRawChain` (method, L676), `ReleaseUnusedReservation` (method, L695), `RequireAlive` (method, L730), `RequireGaugePage` (method, L721), `RequirePage` (method, L712), `SigmaConstraintLedger` (class, L70), `SigmaGaugeProofLease` (class, L923), `SigmaGaugeRawClonePlan` (struct, L47), `SigmaProofFrameLease` (class, L865), `SigmaProofMutationFlags` (enum, L11), `SigmaProofPageLease` (class, L885), `SigmaProofPageStatus` (struct, L19), `SigmaRawFrameRecordGpu` (struct, L798), `SigmaRawPairingHealthGpu` (struct, L774), `SigmaRawTimestampGpu` (struct, L750), `TryReleaseFrame` (method, L704), `ValidateForPublication` (method, L529), `ValidateGaugeForPublication` (method, L440), `World` (method, L851)
...
`AbortGaugeWrites` (method, L2340), `AbortMatchedWrites` (method, L2330), `AbortPendingWrites` (method, L2350), `AddTopologyRebuild` (method, L916), `BeginCarrierInverse` (method, L404), `BeginGaugePageCommits` (method, L959), `BeginGaugeReadback` (method, L2316), `BeginInitialReadbacks` (method, L2266), `BeginInverse` (method, L257), `BeginLocalGaugeRequest` (method, L2292), `BeginLocalGaugeTransaction` (method, L2302), `BeginMatchedPageCommits` (method, L761), `BeginMatchedProofReadback` (method, L2283), `BindCommonInverseInputs` (method, L1341), `BindFrameInputs` (method, L1193), `BindFrameTextures` (method, L1315), `BindPromotion` (method, L1031), `BuildTopologyEvidenceMap` (method, L324), `CeilDiv` (method, L1783), `CompactMorton` (method, L1693), `CompareTo` (method, L1946), `CompleteGaugePromotions` (method, L671), `CompleteInFlight` (method, L342), `CompleteInitialReadback` (method, L442), `CompleteLocalGaugeRequest` (method, L545), `CompleteLocalGaugeTransaction` (method, L614), `CompleteMatchedProofs` (method, L478), `CompletePoseGauge` (method, L381), `ContinueAfterMatched` (method, L525), `ContinueWithLatentPromotions` (method, L657), `CreateArrayTexture` (method, L1750), `CreateBuffer` (method, L1779), `DestroyTexture` (method, L1794), `DetachOwnedResources` (method, L1832), `DetermineNextRevision` (method, L1707), `Dispose` (method, L2004), `Dispose` (method, L2052), `Dispose` (method, L2358), `EnsureCalibration` (method, L1380), `EnsureFlagBuffers` (method, L1405), `EnsureFrameResources` (method, L1391), `EnsurePosePartials` (method, L1155), `EnsureSegmentScratch` (method, L1429), `Equals` (method, L1951), `Equals` (method, L1952), `FillCalibration` (method, L1484), `FillRgbCalibration` (method, L1468), `FindFreeGaugeOrigin` (method, L1605), `FinishFrame` (method, L741), `From` (method, L2396), `FromRaw` (method, L1885), `GaugeImagePage` (struct, L1934), `GaugePose` (method, L1591), `GaugeRegionIsFree` (method, L1671), `GaugeTouchesResidentTransverseNeighbour` (method, L592), `GetHashCode` (method, L1954), `GlobalPageIndex` (method, L1745), `Id` (method, L1748), `InFlightFrame` (class, L2160), `InFlightPhase` (enum, L2150), `IndependenceKey` (method, L1716), `IntrinsicsVector` (method, L1601), `InverseOwnedResources` (class, L2015), `LateUpdate` (method, L234), `Matches` (method, L1999), `Mix` (method, L1736), `NextPowerOfTwo` (method, L1786), `OnCompleted` (method, L2132), `OnDestroy` (method, L1805), `OnModuleInitialize` (method, L125), `OnPredictionReady` (method, L221), `OnScanStarted` (method, L206), `OnScanStopped` (method, L212), `PendingGaugePublication` (struct, L1889), `PendingGaugeWrite` (struct, L1922), `PendingMatchedPublication` (struct, L1907), `PoseMatrix` (method, L1598), `ReadbackRetirementLatch` (class, L2085), `RebuildAffectedTopology` (method, L870), `RebuildTopologyCoordinates` (method, L895), `RecordBuildProposals` (method, L1263), `RecordClear` (method, L1165), `RecordCompactActive` (method, L1246), `RecordNormalize` (method, L1054), `RecordPoseGauge` (method, L1076), `ReplacePrediction` (method, L2257), `Request` (method, L2090), `Request` (method, L2093), `ResolveTopologyEvidence` (method, L926), `RetireWhenComplete` (method, L2114), `RetireWhenReadbacksComplete` (method, L2327), `SegmentInverseScratch` (class, L1956), `SetFrameMatrices` (method, L1533), `SetFrameMatrices` (method, L1564), `SetQ` (method, L1521), `SetQRaw` (method, L1524), `SetRgbQ` (method, L1527), `SetRgbQRaw` (method, L1530), `SigmaInverseController` (class, L23), `SigmaInverseDiagnosticSnapshot` (struct, L2368), `SigmaPackedQ48` (struct, L1875), `SignedMortonCoordinate` (method, L1685), `TryFindAdjacentGaugeOrigin` (method, L1624), `TryOffset` (method, L943), `UpdateObservedTopologyPages` (method, L838), `UploadExactCalibration` (method, L1453), `Value` (method, L2403), `ZigZagDecode` (method, L1704)
...
`AddOffset` (method, L407), `BindBuild` (method, L320), `BindCompaction` (method, L341), `BuildClipFromWorld` (method, L502), `ClearPageHalos` (method, L393), `CopyNeighbourHalo` (method, L415), `Dispose` (method, L630), `DrawSegments` (method, L443), `EnsureSegmentCaches` (method, L470), `LateUpdate` (method, L176), `Matches` (method, L624), `OnCarrierReadoutChanged` (method, L360), `OnDestroy` (method, L541), `OnModuleInitialize` (method, L122), `OnScanStarted` (method, L163), `OnScanStopped` (method, L169), `PrepareReadoutCaches` (method, L295), `RefreshChangedHalos` (method, L364), `RenderPrediction` (method, L216), `SegmentReadoutCache` (class, L570), `SetMrt` (method, L494), `SigmaRenderer` (class, L18), `TryAcquireLatest` (method, L111), `TryOffset` (method, L525), `TryRender` (method, L195), `TryRenderPoseGauge` (method, L204)
...
`AccumulateEvidencePage` (method, L370), `BindEvidence` (method, L624), `BindEvidenceView` (method, L634), `BindPageState` (method, L649), `BindTopologyNeighbours` (method, L674), `BuildGeneration` (method, L292), `BuildPage` (method, L437), `CeilDiv` (method, L806), `ClearPage` (method, L745), `CopyPrior` (method, L731), `CreateBuffer` (method, L802), `CreateSegmentCache` (method, L760), `Dispose` (method, L884), `EnsureSegmentViews` (method, L253), `FinishGaugeGeneration` (method, L339), `FullStereo` (method, L52), `GaugeRebuild` (method, L58), `Matches` (method, L879), `MergeEvidenceIdentity` (method, L599), `OnDestroy` (method, L816), `OnModuleInitialize` (method, L186), `OnScanStarted` (method, L250), `OnScanStopped` (method, L252), `PrepareGaugeGeneration` (method, L317), `Proposals` (method, L35), `Publish` (method, L96), `PublishBuiltGeneration` (method, L429), `RebuildCurrent` (method, L349), `RequireInitialized` (method, L809), `ResolveEvidenceIdentity` (method, L581), `ResolveNeighbour` (method, L700), `SetUInt` (method, L783), `SigmaTopologyBuildToken` (struct, L83), `SigmaTopologyController` (class, L135), `SigmaTopologyEvidenceView` (struct, L7), `SigmaTopologyGaugeBinding` (struct, L104), `SigmaTopologySegmentView` (struct, L63), `TopologySegmentCache` (class, L846), `TryGetCurrentTopology` (method, L717), `TryGetSegmentView` (method, L279), `TryOffset` (method, L786), `ValidateEvidenceCoordinate` (method, L571)
...
`AssertBound` (method, L470), `Bound` (method, L455), `BoundsGpu` (struct, L46), `CertificateArenaFitsTheFrozenQuestMetadataBudget` (method, L137), `CertificateGpu` (struct, L106), `CertificateOffsetsRoundTripWithoutPageOrBlockPhysics` (method, L156), `ConstraintBlockGpu` (struct, L115), `DepthCellGpu` (struct, L53), `DepthSample` (method, L409), `GaugeDemandGpu` (struct, L122), `GaugeDepthSample` (method, L429), `GpuGaugeDemandRequiresIndependentAcceptedReadoutFailure` (method, L266), `GpuLedgerOwnsFocusedTransactionKernels` (method, L172), `GpuReducerEmitsOneExactMinimalDepthCertificate` (method, L182), `IndependenceIsProvenPerSharedS16Coordinate` (method, L241), `LedgerFixture` (class, L476), `NonuniformFiniteFootprintsRemainReplayableAsRawTile` (method, L218), `Pack` (method, L461), `PackState` (method, L448), `ProofSampleGpu` (struct, L90), `RawTileGpu` (struct, L130), `RgbCellGpu` (struct, L65), `RunReducer` (method, L329), `SigmaConstraintLedgerTests` (class, L9), `UInt2` (struct, L16), `UInt4` (struct, L29), `Unpack` (method, L464), `Unpack` (method, L467)
