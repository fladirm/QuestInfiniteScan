...
Source digest: `e7245750ae43e9fab1feb62846c8cf018dd1f4c1d8babe192e08e94f68dc1c75`

Scope: 134 files, 2171 symbols, 1747 functions/methods, 113 GPU kernels, 5 event links.
...
`Attributes` (struct, L74), `PreviewSurfaceColour` (gpu_function, L166), `PreviewSurfaceVert` (gpu_function, L91), `SigmaPreviewBarycentric` (gpu_function, L60), `SigmaPreviewFallbackCorner` (gpu_function, L67), `SigmaPreviewReadoutIndex` (gpu_function, L41), `SigmaPreviewTriangleCorner` (gpu_function, L47), `Varyings` (struct, L80)
...
`AppendRange` (method, L1035), `AppendTo` (method, L344), `AppendTo` (method, L382), `AppendTo` (method, L505), `AppendTo` (method, L610), `Batch` (class, L247), `BitsToFloat` (method, L628), `BufferKind` (enum, L232), `Complete` (method, L146), `Copy` (method, L1009), `Dispose` (method, L222), `FormatForensicLogLine` (method, L887), `FormatLogLine` (method, L821), `From` (method, L705), `IsDue` (method, L45), `IsFinite` (method, L631), `ProofPhaseName` (method, L994), `Request` (method, L131), `RequestFailed` (method, L703), `RequestRange` (method, L138), `SelectNextReadoutPage` (method, L195), `Set` (method, L286), `SigmaDiagnosticTelemetry` (class, L13), `SigmaReadoutVertexTelemetry` (struct, L546), `SigmaRuntimeTelemetrySnapshot` (class, L635), `SigmaRuntimeTimingTelemetry` (struct, L359), `SigmaStageLatencyTelemetry` (struct, L328), `SigmaTransactionTelemetry` (struct, L399), `Tick` (method, L48), `WeightedLoad` (method, L1017), `Word` (method, L1027), `Word` (method, L218), `Word` (method, L541)
...
`AbsNanoseconds` (method, L1003), `Add` (method, L1198), `AdvanceAge` (method, L1180), `AdvanceAge` (method, L1288), `Begin` (method, L1267), `BuildTrackingPriorEnvelope` (method, L741), `CaptureTimingTelemetry` (method, L259), `CeilDiv` (method, L1038), `Complete` (method, L1328), `CountPendingTickets` (method, L951), `CreateArrayTexture` (method, L1052), `CreateBuffer` (method, L1048), `CreatePersistentResources` (method, L839), `DestroyTexture` (method, L1082), `Dispose` (method, L1341), `ElapsedMilliseconds` (method, L1181), `ElapsedMilliseconds` (method, L1289), `EnsureCalibration` (method, L811), `EnsureFrameResources` (method, L1291), `EnsurePosePartials` (method, L1316), `FillCalibration` (method, L886), `FillRgbCalibration` (method, L922), `FindKernels` (method, L824), `FromRaw` (method, L1162), `IndependenceKey` (method, L1013), `IngressSlot` (class, L1219), `IntrinsicsVector` (method, L1010), `LatchCompletionFault` (method, L521), `LateUpdate` (method, L205), `LatencyTracker` (class, L1186), `MaxRigRotationResidual` (method, L798), `MaxRigTranslationResidual` (method, L785), `Mix` (method, L1033), `NextPowerOfTwo` (method, L1041), `NextRevision` (method, L986), `OnDestroy` (method, L1093), `OnModuleInitialize` (method, L113), `OnPredictionReady` (method, L197), `OnScanStarted` (method, L172), `OnScanStopped` (method, L188), `Poll` (method, L1183), `Poll` (method, L1285), `PollCanonical` (method, L479), `PollDerived` (method, L500), `PollIngress` (method, L449), `PollInitialization` (method, L428), `PoseMatrix` (method, L1008), `RecordClassification` (method, L557), `RecordCorrectedCalibration` (method, L681), `RecordGraphInitialization` (method, L275), `RecordNormalize` (method, L532), `RecordPoseGauge` (method, L627), `ReleasePendingIngress` (method, L967), `Reset` (method, L1210), `SaturatingAdd` (method, L1006), `SetQ` (method, L994), `SetQRaw` (method, L997), `SetRgbQ` (method, L999), `SetRgbQRaw` (method, L1001), `SigmaInverseController` (class, L22), `SigmaPackedQ48` (struct, L1153), `Submission` (class, L1165), `SubmitCanonicalAndDerived` (method, L378), `SubmitIngress` (method, L295), `TrackLast` (method, L973), `TryGetFreeIngressSlot` (method, L938), `UpdatePeak` (method, L979), `UploadExactCalibration` (method, L708), `UploadPosePrior` (method, L721)
...
`BindBuild` (method, L823), `BindCancelHistoricalRevalidation` (method, L683), `BindCompaction` (method, L848), `BindFinalizeHistoricalRevalidation` (method, L657), `BindHaloResolve` (method, L873), `BindHistoricalDrawArguments` (method, L600), `BindPrepareHistoricalRevalidation` (method, L561), `BindRebuildHistoricalAssociation` (method, L614), `BindStreamingManifest` (method, L187), `BuildClipFromWorld` (method, L963), `CreateColor` (method, L1210), `DestroyMaterial` (method, L1138), `DestroyTexture` (method, L1236), `Dispose` (method, L1201), `Dispose` (method, L1316), `DrawSegments` (method, L892), `EnsureHistoricalRevalidationPageSnapshot` (method, L699), `EnsureHistoricalRevalidationTargets` (method, L446), `EnsureSegmentCaches` (method, L931), `HistoricalRevalidationTargets` (class, L1148), `LateUpdate` (method, L352), `Matches` (method, L1310), `OnDestroy` (method, L1056), `OnModuleInitialize` (method, L253), `OnScanStarted` (method, L339), `OnScanStopped` (method, L345), `PrepareReadoutCaches` (method, L798), `RecordHistoricalRevalidation` (method, L474), `RenderDirectCarrierPreview` (method, L991), `RenderPrediction` (method, L722), `ResolveWorldFromReadout` (method, L1035), `SegmentReadoutCache` (class, L1248), `SetMrt` (method, L1193), `SetMrt` (method, L955), `SetRevalidationBuffer` (method, L715), `SigmaRenderer` (class, L19), `TryAcquireLatest` (method, L242), `TryGetStreamingReadout` (method, L540), `TryGetStreamingReadoutDiagnostics` (method, L213), `TryRecordPoseGaugePrediction` (method, L400), `TryRender` (method, L373), `TryRenderPoseGauge` (method, L382), `UnbindStreamingManifest` (method, L203)
...
`AssertProofEqual` (method, L983), `Bind` (method, L1027), `Bounds` (method, L1003), `BoundsEqual` (method, L969), `BoundsGpu` (struct, L41), `BuildPartitionedProofEvidence` (method, L870), `CloseProof` (method, L922), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L491), `MeetCertificates` (method, L928), `NullPromotionLiftUsesCompleteMeetAndExactMass` (method, L214), `PageMetadataGpu` (struct, L17), `ProofCertificate` (method, L910), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L676), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L702), `ProofSampleGpu` (struct, L48), `Q48` (method, L1014), `ReadCompute` (method, L1033), `ReadScript` (method, L1040), `ReplayWindows` (method, L941), `SigmaStreamingContractTests` (class, L12), `Signed` (method, L1024), `StreamingRepairContractUsesProductionBindingsAndClosure` (method, L145), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L54), `TransactionTelemetryDecodesExecutionGeneration` (method, L451), `U4` (method, L998), `UInt2Gpu` (struct, L34)
