...
Source digest: `2db58fbb9c89e20528ca427e9d0a867daf3de42414b96a2a8ae55b9bc980697e`

Scope: 144 files, 2410 symbols, 1913 functions/methods, 137 GPU kernels, 5 event links.
...
`BindCarrier` (method, L720), `BindClosureDepth` (method, L549), `BindClosureKernel` (method, L422), `BindEvaluate` (method, L702), `BindFootprintWindow` (method, L881), `BindFrameConstants` (method, L564), `BindProposal` (method, L600), `BindPublishKernel` (method, L493), `BindSourceOutputs` (method, L738), `BindSourceRead` (method, L771), `BindSourceReads` (method, L758), `CeilDiv` (method, L878), `CreateBuffer` (method, L848), `Dispose` (method, L409), `FindKernels` (method, L852), `Intrinsics` (method, L864), `Packed` (method, L868), `PoseMatrix` (method, L861), `RecordClosureAndPublish` (method, L333), `RecordDepthSource` (method, L628), `RecordRgbSource` (method, L666), `RecordSourceAndResolve` (method, L215), `RequireAlive` (method, L888), `RequireSingleExecutionWindow` (method, L821), `SetFrameMatrices` (method, L789), `SigmaFrameGraph` (class, L105), `SigmaFrameInverseInput` (struct, L12), `SigmaFramePublicationTarget` (struct, L56), `Single` (method, L838), `TryAcquire` (method, L205)
...
`ArrayRenderTexture` (method, L622), `AssertPublished` (method, L192), `BuildCpuOracle` (method, L223), `Candidate` (method, L356), `ClearPrediction` (method, L644), `ConstrainedLaneCount` (method, L326), `Contains` (method, L352), `CurrentPage` (method, L205), `DepthCalibration` (method, L667), `Destroy` (method, L743), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L147), `Dispose` (method, L521), `FrameFixture` (class, L367), `Intrinsics` (method, L574), `NormalizeDepth` (method, L602), `PageMeta` (struct, L43), `PageState` (method, L215), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L590), `ReadSnapshot` (method, L544), `RgbCalibration` (method, L698), `RgbTexture` (method, L579), `Run` (method, L467), `RunPublished` (method, L481), `Set` (method, L713), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L364), `Snapshot` (class, L58), `SourceKey` (method, L338), `UInt2` (struct, L27), `UInt4` (struct, L34), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L81)
