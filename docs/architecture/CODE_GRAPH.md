...
Source digest: `b1608a8309f0562ef215853731f87cfac8690a07c00cb50b707127aad0b487e3`

Scope: 81 files, 1186 symbols, 909 functions/methods, 50 GPU kernels, 17 event links.
...
- `PrismFilmSpawner.FilmsMutated` → `OnFilmsMutated` ([Runtime/Prism/Geometry/PrismMeshletBuilder.cs:98](../../Runtime/Prism/Geometry/PrismMeshletBuilder.cs#L98))
...
`Bind` (method, L141), `OnDestroy` (method, L108), `OnFilmsMutated` (method, L117), `PrismMeshletBuilder` (class, L14), `StartBuilding` (method, L62), `StopBuilding` (method, L101)
...
`BoundaryCubic` (gpu_function, L242), `BoundaryHashEntry` (struct, L70), `BoundaryHashKey` (gpu_function, L231), `BuildAdaptiveFilmMeshlets` (gpu_function, L387), `BuildMeshDispatchArguments` (gpu_function, L380), `ChooseSubdivision` (gpu_function, L351), `ClearMeshletBuild` (gpu_function, L369), `ClosestBoundaryPoint` (gpu_function, L251), `ContactBoundaryHeader` (struct, L48), `ContactFilmHeader` (struct, L5), `ContactMeshletVertex` (struct, L33), `DisplacementCell` (struct, L96), `DisplacementPageHeader` (struct, L79), `FinalizeMeshletDrawArguments` (gpu_function, L458), `Height` (gpu_function, L298), `LoadDisplacementCell` (gpu_function, L148), `LoadDisplacementChild` (gpu_function, L155), `Reserve` (gpu_function, L331), `ResolveDisplacementPage` (gpu_function, L162), `SampleDisplacement` (gpu_function, L203), `SurfaceNormal` (gpu_function, L306), `BuildAdaptiveFilmMeshlets` (gpu_kernel, L3), `BuildMeshDispatchArguments` (gpu_kernel, L2), `ClearMeshletBuild` (gpu_kernel, L1), `FinalizeMeshletDrawArguments` (gpu_kernel, L4)
