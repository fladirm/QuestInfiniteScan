...
Source digest: `dd9daf55c26063047ef4d44b0d60324f35b722ff1445f0c8a881a1320adec6dd`

Scope: 110 files, 1896 symbols, 1540 functions/methods, 77 GPU kernels, 5 event links.
...
`AuthorityBoundaryAndExecutableIrAreFrozen` (method, L24), `Buffer` (method, L670), `CertificateMinimizerIsExactBoundedAndCouplingAware` (method, L331), `DirectionalActionCarriesIntervalsAndStopsAtFirstHit` (method, L268), `ExactZeroDivisorAndOneLsbResidualDoNotAlias` (method, L491), `Factor` (method, L641), `FreshAdmissionIsGeneratedFromShadowPreimageNotProposedState` (method, L424), `GaugeSplitTransportCollapseAndNormalizationAreConstructive` (method, L361), `GeneratedHlslMatchesCpuTablesIrAndDirectionalAction` (method, L516), `GeneratedReverseDescriptorsRetainZeroBranchesAndSceneDisjunction` (method, L295), `Join` (method, L638), `Permutations` (method, L647), `Permute` (method, L655), `QuerySupportSummaryMatchesIndependentExhaustiveEvaluation` (method, L234), `ShadowKernelDefaultAndExactFactorClassesFailClosed` (method, L180), `SigmaMerkabaProgramTests` (class, L12), `SignedXorAssociatorDiffractionMetricAndHolonomyAreExact` (method, L112), `UInt4` (struct, L15)

### `Tests/Editor/SigmaMerkabaSemanticOracle.cs`

`AddOutward` (method, L1265), `AggregateFactorClasses` (method, L1382), `CanOmit` (method, L393), `ComputeFingerprint` (method, L543), `ComputeRawInformationNormSquare` (method, L1368), `ComputeTransferFingerprint` (method, L154), `Contains` (method, L539), `ContractJoint` (method, L1173), `ContractNativeQuery` (method, L1106), `DeriveIdentityPreservingTransport` (method, L1432), `DivideOutward` (method, L1298), `DotPoint` (method, L1340), `EmptyOptical` (method, L1352), `Equals` (method, L472), `Equals` (method, L480), `Equals` (method, L498), `Equals` (method, L500), `Equals` (method, L517), `Equals` (method, L519), `Equals` (method, L612), `Equals` (method, L617), `Equals` (method, L660), `Equals` (method, L668), `EvaluateAndReduce` (method, L994), `EvaluateAndReduceEyePair` (method, L1004), `EvaluateMerkabaShadow` (method, L787), `EvaluateNativeQuery` (method, L964), `EvaluateNativeQuery` (method, L969), `EvaluateNativeRelation` (method, L1208), `EvaluateNativeRelation` (method, L1213), `FindAnnihilator` (method, L1400), `FreshStateSatisfiesQuery` (method, L945), `GetHashCode` (method, L482), `GetHashCode` (method, L502), `GetHashCode` (method, L521), `GetHashCode` (method, L619), `GetHashCode` (method, L670), `Hull` (method, L1324), `IsExactIdentityFreshOpticalLaw` (method, L929), `MultiplyOutward` (method, L1277), `Negate` (method, L1424), `NormalizeFactor` (method, L1355), `Overlaps` (method, L1333), `Point` (method, L1350), `ProvenStrictlyBefore` (method, L1336), `ReduceNativeQuery` (method, L1021), `ReduceNativeQuery` (method, L1026), `RelationPermitsClosure` (method, L1393), `RequireForwardExpression` (method, L1444), `RequireIntrinsicRelationExpression` (method, L1474), `RequireReverseExpression` (method, L1460), `SameGaugeCell` (method, L1439), `SelectNativeQuerySupport` (method, L778), `SigmaMerkabaSemanticOracle` (class, L767), `SigmaNativeCoherentQueryContext` (struct, L233), `SigmaNativeContractBranch` (struct, L697), `SigmaNativeContractResult` (class, L740), `SigmaNativeContribution` (struct, L404), `SigmaNativeDebugRequest` (enum, L17), `SigmaNativeDeltaWitness` (struct, L504), `SigmaNativeEyePairQuery` (class, L253), `SigmaNativeEyePairShadow` (struct, L485), `SigmaNativeFreshObservationBranch` (struct, L293), `SigmaNativeNearSingularLaw` (struct, L523), `SigmaNativeOracleCell` (struct, L328), `SigmaNativeOracleQuery` (class, L168), `SigmaNativeOracleResolution` (enum, L10), `SigmaNativePhotometricChannelLaw` (class, L45), `SigmaNativePhotometricLaw` (class, L90), `SigmaNativePhotometricSegment` (struct, L23), `SigmaNativePreimageCandidate` (struct, L673), `SigmaNativeQuerySupportSummary` (struct, L370), `SigmaNativeRelationFactor` (struct, L586), `SigmaNativeRelationInput` (struct, L553), `SigmaNativeRelationWitness` (struct, L622), `SigmaNativeSceneShadow` (struct, L434), `SubtractOutward` (method, L1271), `SumOutward` (method, L1320), `SummarizeCell` (method, L769), `TryApply` (method, L121), `TryBuildFreshShadowBranch` (method, L851), `TryPullBackFreshQuery` (method, L872), `TryResolveFreshBaseAdmission` (method, L805), `TrySignedAxisRow` (method, L902)

### `Tests/Editor/SigmaNativeOracleTests.cs`

`AssertFreshGpuMatchesCpu` (method, L1294), `AssertGpuRelationsMatchCpu` (method, L1637), `AssertGpuShadowEqual` (method, L2417), `AssertGpuShadowMatchesCpu` (method, L2437), `Axis` (method, L2240), `BuildPhotometricQuery` (method, L2157), `Candidate` (method, L2032), `Cell` (method, L2051), `CpuCandidate` (method, L2038), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L337), `EmptyOptical` (method, L2245), `EntryPointIndex` (method, L2413), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L1745), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L390), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L586), `Factor` (method, L2249), `FreshBaseAdmissionStartsAtCoherentObservationAndMatchesVulkan` (method, L210), `FreshObservation` (method, L2069), `FreshQuery` (method, L2113), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L459), `GetHashCode` (method, L39), `GpuFreshAdmission` (class, L72), `GpuShadow` (class, L41), `HashS16` (method, L2359), `Kernels` (method, L626), `Law` (method, L2189), `LeftQuery` (method, L2131), `LoadShader` (method, L2454), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L620), `Pack` (method, L2381), `PackFreshMeasurements` (method, L2125), `PackGaugeCoordinate` (method, L2270), `PackGaugeMetadata` (method, L2278), `PackInterval` (method, L2310), `PackKeys` (method, L2262), `PackPhotometricLaw` (method, L2318), `PackRelationPlan` (method, L2296), `PackRows` (method, L2374), `PackStates` (method, L2378), `PackU256` (method, L2387), `PiecewiseLaw` (method, L2211), `Point` (method, L2243), `Query` (method, L2143), `Raw` (method, L2247), `ReduceWindows` (method, L2000), `RelationFor` (method, L2046), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L146), `RightQuery` (method, L2137), `RunGpuContractOverflow` (method, L1309), `RunGpuEyePair` (method, L1771), `RunGpuFreshAdmission` (method, L1093), `RunGpuQuery` (method, L1763), `RunGpuQuerySet` (method, L1778), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L548), `State` (method, L2055), `StateRaw` (method, L2058), `Summary` (method, L2253), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L2407), `UnpackKey` (method, L2410), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L808), `VulkanExportDebugAndEyePairExecuteDistinctGeneratedSemantics` (method, L877), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L760), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L666), `VulkanReducerHandlesMoreThan64AndSignalsBoundedColdContinuation` (method, L960), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L1009), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L99)
...
`SigmaCertificateFactor` (struct, L2100), `SigmaDefaultBackingKind` (enum, L2012), `SigmaDirectionalActionWitness` (struct, L2082), `SigmaExactFactorClass` (enum, L2005), `SigmaFrameUInt2Gpu` (struct, L3564), `SigmaFrameUInt4Gpu` (struct, L3571), `SigmaFreshAdmissionStatus` (enum, L2019), `SigmaFreshBaseAdmission` (struct, L2167), `SigmaFreshShadowBranch` (struct, L2146), `SigmaGaugeCell` (struct, L2130), `SigmaGeneratedAlgebra` (class, L1765), `SigmaGeneratedFrame` (class, L3582), `SigmaGeneratedMerkabaProgram` (class, L2185), `SigmaMerkabaEntryPoint` (struct, L2068), `SigmaMerkabaExpression` (struct, L2048), `SigmaMerkabaIrNode` (struct, L2025), `SigmaMerkabaIrOpcode` (enum, L1973), `SigmaMerkabaRelationClass` (enum, L1987), `SigmaMerkabaReverseRule` (enum, L1982), `SigmaMerkabaValueKind` (enum, L1977), `SigmaMinimizedFactor` (struct, L2122), `SigmaNativeQueryClaim` (enum, L1998), `action_expression` (function, L455), `add_expression` (function, L328), `add_node` (function, L311), `associator_expression` (function, L358), `basis_product` (function, L130), `build_descriptor` (function, L1534), `build_executable_merkaba_ir` (function, L262), `build_merkaba_descriptor` (function, L1239), `certificate_minimizer_proof` (function, L888), `check_or_write` (function, L3643), `chunks` (function, L1736), `collapse_once` (function, L959), `conjugate_sign` (function, L147), `cs_array` (function, L1741), `default_representation_proof` (function, L801), `diffraction_expression` (function, L374), `diffraction_matrix` (function, L192), `dyads` (function, L155), `evaluate_actual_associator` (function, L670), `file_sha256` (function, L180), `fingerprint_words` (function, L1825), `forward` (function, L1110), `frame_abi_descriptor` (function, L3490), `fresh_admission_expression` (function, L497), `fresh_base_admission_proof` (function, L1055), `fresh_boundary_relation` (function, L1123), `gauge_expression` (function, L486), `gauge_transport_proof` (function, L946), `hadamard_sign` (function, L151), `information_metric` (function, L243), `input_s16` (function, L349), `interpret_forward` (function, L822), `interval_add` (function, L590), `interval_mul` (function, L585), `interval_sub` (function, L593), `MerkabaDirectionalActionParity` (gpu_kernel, L3284), `MerkabaFreshAdmissionParity` (gpu_kernel, L3285), `MerkabaMatrixAndIrParity` (gpu_kernel, L3283), `MerkabaProgramParity` (gpu_kernel, L3282), `lift` (function, L1097), `link_factor_expression` (function, L380), `main` (function, L3656), `matrix_multiply` (function, L235), `merkaba_shadow_numerator` (function, L207), `minimize` (function, L898), `multiply_dyads` (function, L163), `multiply_s16` (function, L657), `nearest_even` (function, L1061), `normalize` (function, L974), `normalized_associator_expression` (function, L398), `optical_expression` (function, L468), `packed_i64` (function, L2928), `plaquette_expression` (function, L412), `qmul` (function, L1072), `query_support_exhaustive_proof` (function, L741), `read_json` (function, L184), `render_authority_manifest` (function, L3416), `render_cs` (function, L1750), `render_frame_cs` (function, L3515), `render_frame_hlsl` (function, L3598), `render_hlsl` (function, L1868), `render_hlsl_layout` (function, L1829), `render_merkaba_cs` (function, L1925), `render_merkaba_fixture` (function, L3277), `render_merkaba_hlsl` (function, L2916), `reverse_complete_tree_proof` (function, L578), `reverse_expression` (function, L444), `reverse_mul` (function, L596), `select_tangent` (function, L1078), `sha256` (function, L175), `shadow_expression` (function, L428), `signed_morton` (function, L213), `split` (function, L954), `transpose` (function, L231), `uint_array` (function, L3475), `upper_snake` (function, L3479), `validate_descriptor` (function, L1710), `zig_zag` (function, L217)
