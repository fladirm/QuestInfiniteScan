...
Source digest: `54642c59fbd6108fc7fcd824f17a50b788f3663c288d9a1a50d17def5556a628`

Scope: 107 files, 1595 symbols, 1296 functions/methods, 73 GPU kernels, 4 event links.
...
`ArrayRenderTexture` (method, L1636), `AssertCandidates` (method, L708), `AssertMatrix` (method, L1870), `AssertPublished` (method, L626), `AssertUInt4` (method, L664), `BuildCarrierPrior` (method, L1738), `BuildCpuOracle` (method, L739), `Candidate` (method, L872), `ClaimedFoldMatchesFullIntrinsicS16Oracle` (method, L514), `ClaimedUnresolvedEdgeDefersOnlyIncidentChanges` (method, L458), `ClearPrediction` (method, L1659), `CloseCurrentFrame` (method, L1016), `ClosureSnapshot` (class, L123), `ClosureTarget` (struct, L96), `ComposePose` (method, L1880), `ConstrainedLaneCount` (method, L842), `ContactZeroDivisorState` (method, L1754), `Contains` (method, L868), `CurrentPage` (method, L721), `DepthCalibration` (method, L1682), `Destroy` (method, L1864), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L234), `Dispose` (method, L1537), `ExactRegularEdgesJoinPendingAndAnchorContinuation` (method, L428), `FrameFixture` (class, L883), `GeometryRelationCell` (method, L1767), `Gpu4` (method, L1861), `Intrinsics` (method, L1587), `NormalizeDepth` (method, L1616), `Packed` (method, L1778), `PageMeta` (struct, L44), `PageState` (method, L731), `PendingCandidates` (method, L703), `PendingEdgesCrossExecutionWindowsWithoutChangingPhysics` (method, L596), `PendingEvidenceSurvivesAndReusesItsExactHandle` (method, L543), `PendingProjectionIsInvariantAcrossOneTwoAndSevenWindows` (method, L579), `Production320FrameLargeBindingRecordsOnlyLegalDispatches` (method, L289), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L281), `ProfilingDisabledPreservesProductionDispatchContract` (method, L298), `PublicationSnapshot` (class, L70), `RawDepthTexture` (method, L1604), `ReadPendingGauge` (method, L1028), `ReadSnapshot` (method, L1560), `RecordProductionGraphOnly` (method, L1176), `ReductionSnapshot` (class, L84), `RgbCalibration` (method, L1713), `RgbTexture` (method, L1592), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L137), `Run` (method, L1001), `RunBoundaryClosure` (method, L682), `RunExactClosure` (method, L1312), `RunPendingProjectionLayout` (method, L673), `RunPublished` (method, L1449), `RunSegmentedTargetFixture` (method, L1077), `RunTargetReduction` (method, L1200), `ScalarState` (method, L1751), `SeedPending` (method, L1034), `SeparatedExactCellsRemainDistinctWithoutPhysicalClaim` (method, L488), `Set` (method, L1728), `SetCandidateCell` (method, L1431), `SigmaFrameInverseTests` (class, L12), `Signed` (method, L880), `Snapshot` (class, L59), `SourceKey` (method, L854), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L345), `UInt2` (struct, L28), `UInt4` (struct, L35), `UnobservedAdjacencyMakesNoTransitionClaim` (method, L409), `VisibleAtRoot` (method, L1516), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L168)
