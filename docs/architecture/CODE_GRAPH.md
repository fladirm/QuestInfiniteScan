...
Source digest: `38bc48848ab78ecc5ed8a0635a35ab7f9aa7e532668e626fdbcb89177584579e`

Scope: 103 files, 1989 symbols, 1666 functions/methods, 37 GPU kernels, 5 event links.
...
`ContractNativeQuery` (gpu_function, L1866), `SigmaN4ChartAssignmentOrbit` (gpu_function, L1017), `SigmaN4ChartDirection` (gpu_function, L1046), `SigmaN4ChartFrameDeterminant` (gpu_function, L1040), `SigmaN4ChartOrbitRepresentative` (gpu_function, L1026), `SigmaN4ContractBoundaryCandidate` (gpu_function, L856), `SigmaN4ContractStoreNoStitch` (gpu_function, L840), `SigmaN4ResolveAdjacentFrame` (gpu_function, L1057), `SigmaN4TileBoundaryHeader` (gpu_function, L1002), `SigmaN4TileBoundaryIndex` (gpu_function, L980), `SigmaN4TileBuildComponents` (gpu_function, L1366), `SigmaN4TileCertificate` (gpu_function, L1133), `SigmaN4TileCertificateReduce` (gpu_function, L1146), `SigmaN4TileChartAssigned` (gpu_function, L1430), `SigmaN4TileChartEqual` (gpu_function, L1480), `SigmaN4TileChartFrame` (gpu_function, L1432), `SigmaN4TileChartHasDistinctOverlap` (gpu_function, L1485), `SigmaN4TileChartProposal` (gpu_function, L1433), `SigmaN4TileClose` (gpu_function, L1774), `SigmaN4TileComponentAddress` (gpu_function, L931), `SigmaN4TileD4Equivalent` (gpu_function, L1614), `SigmaN4TileFinalizeComponents` (gpu_function, L1636), `SigmaN4TileFindRoot` (gpu_function, L1356), `SigmaN4TileFootprintAddress` (gpu_function, L919), `SigmaN4TileFootprintValid` (gpu_function, L947), `SigmaN4TileGlobalFootprint` (gpu_function, L938), `SigmaN4TileMeetSupports` (gpu_function, L1188), `SigmaN4TileNeighbour` (gpu_function, L1085), `SigmaN4TilePackChart` (gpu_function, L1424), `SigmaN4TileResolvedEdge` (gpu_function, L1010), `SigmaN4TileSolveOrbit` (gpu_function, L1512), `SigmaN4TileSortSupports` (gpu_function, L1102), `SigmaN4TileStoreCertificate` (gpu_function, L1140), `SigmaN4TileStructuralCertificateEqual` (gpu_function, L1158), `SigmaN4TileSupportAddress` (gpu_function, L924), `SigmaN4TileSupportKey` (gpu_function, L965), `SigmaNativeFreshEntryValid` (gpu_function, L211), `SigmaNativeFreshEvidenceAddress` (gpu_function, L182), `SigmaNativeFreshFinalize` (gpu_function, L1788), `SigmaNativeFreshLiftFootprint` (gpu_function, L831), `SigmaNativeFreshLiftLegacyBranch` (gpu_function, L823), `SigmaNativeFreshLiftSource` (gpu_function, L292), `SigmaNativeFreshLiftWeight` (gpu_function, L256), `SigmaNativeFreshLoad2` (gpu_function, L191), `SigmaNativeFreshLoad4` (gpu_function, L199), `SigmaNativeFreshModeMask` (gpu_function, L246), `SigmaNativeFreshPermutationAxis` (gpu_function, L219), `SigmaNativeFreshPermutationMode` (gpu_function, L228), `SigmaNativeFreshQ48Equal` (gpu_function, L206), `SigmaNativeFreshReduceAnd` (gpu_function, L262), `SigmaNativeFreshReduceOr` (gpu_function, L277), `SigmaNativeFreshTeamAxisAddress` (gpu_function, L172), `SigmaNativeFreshTeamEyeAddress` (gpu_function, L177), `SigmaNativeFreshTeamLaneAddress` (gpu_function, L162), `SigmaNativeFreshTeamLeafAddress` (gpu_function, L167), `if` (gpu_function, L359), `if` (gpu_function, L742), `if` (gpu_function, L750), `if` (gpu_function, L767), `ContractNativeQuery` (gpu_kernel, L4)

### `Runtime/Resources/SigmaPrism/SigmaNativeFrame.compute`

`BuildNativeObservation` (gpu_function, L761), `CloseAndPublishNativeRevision` (gpu_function, L5741), `PrepareNativeCanonicalRuns` (gpu_function, L5097), `PrepareNativeCanonicalSeed` (gpu_function, L4996), `PrepareNativeCanonicalSelect` (gpu_function, L5114), `PrepareNativeComponentOrder` (gpu_function, L5197), `PrepareNativePage` (gpu_function, L5642), `PrepareNativeRefinementPlan` (gpu_function, L5272), `PrepareNativeRefinementProof` (gpu_function, L5168), `PrepareNativeRefinementScan` (gpu_function, L5230), `PrepareNativeRevision` (gpu_function, L5285), `ScatterNativeState` (gpu_function, L5687), `SigmaN4PublishAcceptFirstImage` (gpu_function, L2896), `SigmaN4PublishActiveSupport` (gpu_function, L3491), `SigmaN4PublishActiveSupportAddress` (gpu_function, L1041), `SigmaN4PublishActiveSupportListOffset` (gpu_function, L1034), `SigmaN4PublishAffineCompose` (gpu_function, L863), `SigmaN4PublishAppendRefinementChild` (gpu_function, L3418), `SigmaN4PublishAppendRelocation` (gpu_function, L3507), `SigmaN4PublishApplyParentCertificateMeet` (gpu_function, L1216), `SigmaN4PublishApplyRefinementCertificateMeets` (gpu_function, L1647), `SigmaN4PublishBeginWideStage` (gpu_function, L4557), `SigmaN4PublishBoundaryIndex` (gpu_function, L1940), `SigmaN4PublishBuildAnchors` (gpu_function, L2345), `SigmaN4PublishBuildCandidate` (gpu_function, L2666), `SigmaN4PublishBuildComponentOrder` (gpu_function, L3110), `SigmaN4PublishBuildDelta` (gpu_function, L3312), `SigmaN4PublishBuildRefinementDelta` (gpu_function, L3350), `SigmaN4PublishBuildRefinementGroups` (gpu_function, L1223), `SigmaN4PublishBuildRefinementTargetPlan` (gpu_function, L3795), `SigmaN4PublishCacheSelectedCoordinates` (gpu_function, L2948), `SigmaN4PublishCanonicalRunCount` (gpu_function, L4588), `SigmaN4PublishCanonicalRunLowerBound` (gpu_function, L4866), `SigmaN4PublishCanonicalRunSize` (gpu_function, L4580), `SigmaN4PublishCertificateEqual` (gpu_function, L1068), `SigmaN4PublishChart` (gpu_function, L1019), `SigmaN4PublishChartCore` (gpu_function, L932), `SigmaN4PublishChildLowerBound` (gpu_function, L3748), `SigmaN4PublishChildOrderLoad` (gpu_function, L3565), `SigmaN4PublishChildOrderStore` (gpu_function, L3573), `SigmaN4PublishChildRadixDigit` (gpu_function, L3639), `SigmaN4PublishCollectEdges` (gpu_function, L2101), `SigmaN4PublishCollectParallelEdges` (gpu_function, L2199), `SigmaN4PublishCompareBoundary` (gpu_function, L1969), `SigmaN4PublishCompareCanonicalEntries` (gpu_function, L4783), `SigmaN4PublishCompareCell` (gpu_function, L1827), `SigmaN4PublishCompareComponents` (gpu_function, L2298), `SigmaN4PublishCompareCoordinateKey` (gpu_function, L1785), `SigmaN4PublishCompareD4Images` (gpu_function, L4707), `SigmaN4PublishCompareEdgeStreams` (gpu_function, L2137), `SigmaN4PublishCompareEncodedEdge` (gpu_function, L2063), `SigmaN4PublishCompareParallelD4PairAt` (gpu_function, L2267), `SigmaN4PublishCompareParallelEncodedEdge` (gpu_function, L2186), `SigmaN4PublishCompareReceipt128` (gpu_function, L1818), `SigmaN4PublishCompareRefinementCandidates` (gpu_function, L4199), `SigmaN4PublishCompareSelectedCell` (gpu_function, L1907), `SigmaN4PublishCompareSelectedCoordinateKey` (gpu_function, L1861), `SigmaN4PublishCompleteRefinementTargetPlan` (gpu_function, L3846), `SigmaN4PublishComponentAddress` (gpu_function, L817), `SigmaN4PublishCoordinate` (gpu_function, L1717), `SigmaN4PublishCurrentEqual` (gpu_function, L3386), `SigmaN4PublishD4Compose` (gpu_function, L842), `SigmaN4PublishD4PairImages` (gpu_function, L2252), `SigmaN4PublishD4PairIndex` (gpu_function, L4649), `SigmaN4PublishD4PairReceipt` (gpu_function, L4669), `SigmaN4PublishD4Vector` (gpu_function, L835), `SigmaN4PublishDeltaLane` (gpu_function, L5675), `SigmaN4PublishEdgeTargetRank` (gpu_function, L2037), `SigmaN4PublishFindRoot` (gpu_function, L881), `SigmaN4PublishFinishParallelCanonical` (gpu_function, L4889), `SigmaN4PublishFinishRefinementBlockScan` (gpu_function, L4350), `SigmaN4PublishFlushWideStage` (gpu_function, L4567), `SigmaN4PublishFootprintValid` (gpu_function, L900), `SigmaN4PublishFreshBlockAddress` (gpu_function, L3586), `SigmaN4PublishFreshCount` (gpu_function, L3045), `SigmaN4PublishFreshInclusive` (gpu_function, L4418), `SigmaN4PublishFreshPrefixAddress` (gpu_function, L3578), `SigmaN4PublishFreshWidth` (gpu_function, L3077), `SigmaN4PublishGaugeEqual` (gpu_function, L3633), `SigmaN4PublishImageAddress` (gpu_function, L823), `SigmaN4PublishInitializeD4Pairs` (gpu_function, L4658), `SigmaN4PublishLoadGlobalTransform` (gpu_function, L873), `SigmaN4PublishLoadParallelImage` (gpu_function, L4594), `SigmaN4PublishLoadStageState` (gpu_function, L4537), `SigmaN4PublishLogicalCapacity` (gpu_function, L3549), `SigmaN4PublishMapOldTarget` (gpu_function, L4462), `SigmaN4PublishMapRefinementChild` (gpu_function, L4486), `SigmaN4PublishMaterializeSelected` (gpu_function, L4962), `SigmaN4PublishMeetParentCertificateCore` (gpu_function, L1132), `SigmaN4PublishMinD4PairReceipt` (gpu_function, L4681), `SigmaN4PublishNeighbour` (gpu_function, L1956), `SigmaN4PublishNextPowerOfTwo` (gpu_function, L2981), `SigmaN4PublishPackedActiveIndex` (gpu_function, L1093), `SigmaN4PublishPackedChild` (gpu_function, L1098), `SigmaN4PublishParallelChildBound` (gpu_function, L4449), `SigmaN4PublishParallelEdgeTargetRank` (gpu_function, L2163), `SigmaN4PublishParallelRank` (gpu_function, L4636), `SigmaN4PublishPlanAddress` (gpu_function, L829), `SigmaN4PublishPrepareCandidateImage` (gpu_function, L2888), `SigmaN4PublishPrepareRefinementCandidates` (gpu_function, L4110), `SigmaN4PublishRadixDigit` (gpu_function, L2559), `SigmaN4PublishRadixNibble64` (gpu_function, L2552), `SigmaN4PublishRadixSort` (gpu_function, L2581), `SigmaN4PublishRefinedInclusive` (gpu_function, L4411), `SigmaN4PublishRefinementChildKey` (gpu_function, L3613), `SigmaN4PublishRefinementRepresentative` (gpu_function, L1046), `SigmaN4PublishRefinementRunLowerBound` (gpu_function, L4426), `SigmaN4PublishResolvedOutgoingEdge` (gpu_function, L2076), `SigmaN4PublishScanRefinementBlock` (gpu_function, L4285), `SigmaN4PublishSelectCandidate` (gpu_function, L2707), `SigmaN4PublishSelectParallelD4` (gpu_function, L4936), `SigmaN4PublishSelectedCoordinate` (gpu_function, L1744), `SigmaN4PublishSigned64` (gpu_function, L1698), `SigmaN4PublishSignedOrderKey` (gpu_function, L1083), `SigmaN4PublishSignedOrderValue` (gpu_function, L1088), `SigmaN4PublishSortCanonicalRun` (gpu_function, L4807), `SigmaN4PublishSortComponents` (gpu_function, L2988), `SigmaN4PublishSortRefinementChildren` (gpu_function, L3656), `SigmaN4PublishSortRefinementRun` (gpu_function, L4227), `SigmaN4PublishSourceLogical` (gpu_function, L3592), `SigmaN4PublishSourceLowerBound` (gpu_function, L3768), `SigmaN4PublishStateEqual` (gpu_function, L1056), `SigmaN4PublishStaticExclusion` (gpu_function, L1026), `SigmaN4PublishStoreParallelImage` (gpu_function, L4720), `SigmaN4PublishStoreParallelRank` (gpu_function, L4607), `SigmaN4PublishStoreStageState` (gpu_function, L4547), `SigmaN4PublishStructuralCertificateCompatible` (gpu_function, L1103), `SigmaN4PublishSupportLocator` (gpu_function, L919), `SigmaN4PublishTargetTempAddress` (gpu_function, L3559), `SigmaN4PublishTargetWorkAddress` (gpu_function, L3554), `SigmaN4PublishTileComponentAddress` (gpu_function, L810), `SigmaN4PublishTileFootprintAddress` (gpu_function, L804), `SigmaN4PublishTileHeaderAddress` (gpu_function, L798), `SigmaN4PublishTransformedCoordinate` (gpu_function, L1703), `SigmaN4PublishValidateParentCertificateMeet` (gpu_function, L1209), `SigmaN4PublishVisibleSlot` (gpu_function, L3295), `SigmaNativeBuildFullFrameFootprints` (gpu_function, L519), `SigmaNativeCompletionAddress` (gpu_function, L197), `SigmaNativeCurrentPrediction` (gpu_function, L435), `SigmaNativeDepthRayCenter` (gpu_function, L234), `SigmaNativeDepthRayDx` (gpu_function, L240), `SigmaNativeDepthRayDy` (gpu_function, L246), `SigmaNativeDepthSlopeBounds` (gpu_function, L252), `SigmaNativeFootprintEvidenceAddress` (gpu_function, L492), `SigmaNativeManifestationBoundaryEnvelope` (gpu_function, L321), `SigmaNativeObservationProvenance` (gpu_function, L504), `SigmaNativeOpticalBoundsFromSamples` (gpu_function, L398), `SigmaNativeProjectRgb` (gpu_function, L372), `SigmaNativeProjectionDepthBounds` (gpu_function, L286), `SigmaNativeQ48FromFloat` (gpu_function, L224), `SigmaNativeRgbCalibrationValue` (gpu_function, L229), `SigmaNativeRgbLoad` (gpu_function, L392), `SigmaNativeRoomRayComponent` (gpu_function, L270), `SigmaNativeSampleBoundaryRay` (gpu_function, L258), `SigmaNativeStoreFootprintEvidence` (gpu_function, L497), `SigmaNativeWriteCompletion4` (gpu_function, L202), `SigmaNativeWriteCompletionFrame` (gpu_function, L209), `if` (gpu_function, L1176), `if` (gpu_function, L1183), `if` (gpu_function, L1634), `if` (gpu_function, L4733), `if` (gpu_function, L4740), `if` (gpu_function, L4747), `if` (gpu_function, L4754), `if` (gpu_function, L4761), `if` (gpu_function, L4768), `if` (gpu_function, L5600), `if` (gpu_function, L5611), `BuildNativeObservation` (gpu_kernel, L4), `CloseAndPublishNativeRevision` (gpu_kernel, L15), `PrepareNativeCanonicalRuns` (gpu_kernel, L6), `PrepareNativeCanonicalSeed` (gpu_kernel, L5), `PrepareNativeCanonicalSelect` (gpu_kernel, L7), `PrepareNativeComponentOrder` (gpu_kernel, L9), `PrepareNativePage` (gpu_kernel, L13), `PrepareNativeRefinementPlan` (gpu_kernel, L11), `PrepareNativeRefinementProof` (gpu_kernel, L8), `PrepareNativeRefinementScan` (gpu_kernel, L10), `PrepareNativeRevision` (gpu_kernel, L12), `ScatterNativeState` (gpu_kernel, L14)
...
`EvaluateNativeRelation` (gpu_function, L1339), `SigmaN4Affine` (gpu_function, L796), `SigmaN4AffineCompose` (gpu_function, L854), `SigmaN4AffineEqual` (gpu_function, L873), `SigmaN4AffineIdentity` (gpu_function, L802), `SigmaN4AffineInverse` (gpu_function, L864), `SigmaN4BoundaryFactor` (gpu_function, L178), `SigmaN4BoundaryReceiptAddress` (gpu_function, L124), `SigmaN4ChartAssignmentOrbit` (gpu_function, L879), `SigmaN4ChartDirection` (gpu_function, L908), `SigmaN4ChartFrameDeterminant` (gpu_function, L902), `SigmaN4ChartOrbitRepresentative` (gpu_function, L888), `SigmaN4ClassifyBoundaryFactors` (gpu_function, L214), `SigmaN4CountBoundaryResult` (gpu_function, L142), `SigmaN4CrossBoundaryCount` (gpu_function, L992), `SigmaN4D4Compose` (gpu_function, L814), `SigmaN4D4Inverse` (gpu_function, L835), `SigmaN4D4Vector` (gpu_function, L807), `SigmaN4DecodeBoundary` (gpu_function, L153), `SigmaN4DecodeCrossBoundary` (gpu_function, L998), `SigmaN4DirectRightToLeft` (gpu_function, L951), `SigmaN4EvaluateCompactedBoundary` (gpu_function, L540), `SigmaN4EvaluateImplicitBoundary` (gpu_function, L297), `SigmaN4FindGlobalRoot` (gpu_function, L1048), `SigmaN4FindTileSupport` (gpu_function, L574), `SigmaN4FootprintAddress` (gpu_function, L119), `SigmaN4GlobalCertificateCompatible` (gpu_function, L625), `SigmaN4GlobalCertificateReduce` (gpu_function, L611), `SigmaN4GlobalGeometryClose` (gpu_function, L1082), `SigmaN4GlobalNode` (gpu_function, L977), `SigmaN4GlobalParentAddress` (gpu_function, L785), `SigmaN4GlobalRootLink` (gpu_function, L1067), `SigmaN4GlobalTransformAddress` (gpu_function, L790), `SigmaN4LoadChartState` (gpu_function, L943), `SigmaN4LoadGlobalMeta` (gpu_function, L76), `SigmaN4LoadGlobalState` (gpu_function, L87), `SigmaN4LoadGlobalTransform` (gpu_function, L1034), `SigmaN4ReduceActiveSupport` (gpu_function, L641), `SigmaN4ResolveAdjacentFrame` (gpu_function, L917), `SigmaN4SignedU128Add` (gpu_function, L184), `SigmaN4StoreBoundaryReceipt` (gpu_function, L130), `SigmaN4StoreGlobalMeta` (gpu_function, L81), `SigmaN4StoreGlobalState` (gpu_function, L92), `SigmaN4StoreGlobalTransform` (gpu_function, L1041), `SigmaN4TileComponentAddress` (gpu_function, L778), `SigmaN4TileFootprintAddress` (gpu_function, L772), `SigmaN4TileHeaderAddress` (gpu_function, L562), `SigmaN4TileSupportAddress` (gpu_function, L567), `EvaluateNativeRelation` (gpu_kernel, L3)
...
`BindPublication` (method, L2985), `BuildLocalityCertificate` (method, L2805), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L181), `CanonicalSeedPreservesGlobalCloseUnresolvedReceipt` (method, L694), `CertificateDifference` (method, L3257), `CertifiedConstraintRecord` (method, L3168), `CompactedBoundaryOrderIsExecutionOnlyAcrossAllResults` (method, L589), `Compare` (method, L4002), `CompletionClassificationRejectsWrongNonzeroGpuRevision` (method, L2224), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L2198), `ConstraintRecord` (method, L3138), `Count` (method, L2931), `CutEUsesDirectedWitnessWhenD4CellStreamsTie` (method, L2547), `DirectionModeMask` (method, L3238), `DispatchCutE` (method, L2940), `Equals` (method, L3990), `Equals` (method, L3993), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1943), `FaultedDispositionStillUsesItsFaultReceipt` (method, L2280), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1721), `FindGaugeSample` (method, L3708), `Flatten` (method, L3752), `Flatten` (method, L3763), `From` (method, L3984), `FullFrameLinearDispatchGridIsQuestLegalAndBijective` (method, L100), `GaugeKey` (struct, L3963), `GaugeKeyComparer` (class, L3998), `GetHashCode` (method, L3995), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L2017), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L141), `LoadShader` (method, L2703), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L2051), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L2118), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1985), `Packed` (method, L3776), `PackedInterval` (method, L3782), `PageMeta` (struct, L4055), `PersistAndReload` (method, L3226), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1831), `PrepareRefinementScratch` (method, L3557), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L376), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L1182), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L733), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1504), `PublishedCertificateDeltaCountIsNotACompletionFault` (method, L2244), `Q2` (method, L3833), `Q4` (method, L3249), `ReadAssetSource` (method, L3851), `ReadCertificate` (method, L3740), `ReadPageMeta` (method, L3700), `ReadState` (method, L3730), `RefinementAtFullPageBoundarySpillsIntoNextLogicalPage` (method, L2427), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L2337), `RefinementMultiplicityAndParentMeetArePermutationInvariant` (method, L2379), `RefinementSnapshot` (class, L3917), `RefinementStep` (struct, L3902), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L2164), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L2302), `RunRefinementSequence` (method, L3269), `RunStaticExclusion` (method, L2839), `ScatterConsumesMutationCountInsteadOfResidentWorldExtent` (method, L1610), `SeedBoundaryWorklist` (method, L3809), `SeedSingleFootprintClosedCutE` (method, L2716), `SetEqualCertificates` (method, L3115), `SetValidNextCertificate` (method, L3098), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L4015), `StateWithLane0` (method, L2832), `StaticExclusionSnapshot` (class, L3939), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1811), `ToRaw` (method, L3976), `ToString` (method, L3996), `U4` (method, L3839), `UInt2` (struct, L4039), `UInt2Buffer` (method, L3845), `UInt4` (struct, L4046), `UInt4Buffer` (method, L3848), `UIntBuffer` (method, L3842), `WriteEnvelope` (method, L3798), `WriteRepresentationCell` (method, L3661), `WriteState` (method, L3790), `ZeroArrayRenderTexture` (method, L3858), `ZeroRenderTexture` (method, L3883)
