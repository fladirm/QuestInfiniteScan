...
Source digest: `49b77d5899d1108b3e2df55cdb239ad6017b5294e124d01195496e196120efa0`

Scope: 103 files, 1682 symbols, 1368 functions/methods, 30 GPU kernels, 5 event links.
...
`AuthorityBoundaryAndExecutableIrAreFrozen` (method, L24), `Buffer` (method, L1267), `CertificateMinimizerIsExactBoundedAndCouplingAware` (method, L755), `ConstructiveCaptureBoundaryBuildsCalibratedEightLeafPair` (method, L428), `ConstructiveModalStitchingUsesAbstractWitnessesAndD4ChartGauge` (method, L142), `DirectionalActionCarriesIntervalsAndStopsAtFirstHit` (method, L692), `ExactZeroDivisorAndOneLsbResidualDoNotAlias` (method, L928), `Factor` (method, L1238), `FreshAdmissionIsGeneratedFromShadowPreimageNotProposedState` (method, L861), `GaugeLess` (method, L1208), `GaugeSplitTransportCollapseAndNormalizationAreConstructive` (method, L785), `GeneratedHlslMatchesCpuTablesIrAndDirectionalAction` (method, L953), `GeneratedReverseDescriptorsRetainZeroBranchesAndSceneDisjunction` (method, L719), `Join` (method, L1205), `Permutations` (method, L1244), `Permute` (method, L1252), `QuerySupportSummaryMatchesIndependentExhaustiveEvaluation` (method, L658), `ShadowKernelDefaultAndExactFactorClassesFailClosed` (method, L604), `SigmaMerkabaProgramTests` (class, L12), `SignedMorton` (method, L1218), `SignedXorAssociatorDiffractionMetricAndHolonomyAreExact` (method, L536), `UInt4` (struct, L15)
...
`SigmaAssembledSensorEye` (struct, L2914), `SigmaBoundaryNativeInput` (struct, L2766), `SigmaCertificateFactor` (struct, L2392), `SigmaChartD4Transform` (struct, L2438), `SigmaComponentNormalForm` (class, L3827), `SigmaDefaultBackingKind` (enum, L2304), `SigmaDirectionalActionWitness` (struct, L2374), `SigmaExactFactorClass` (enum, L2297), `SigmaFootprintSupportDisposition` (enum, L2468), `SigmaFrameUInt2Gpu` (struct, L6108), `SigmaFrameUInt4Gpu` (struct, L6115), `SigmaFreshAdmissionStatus` (enum, L2311), `SigmaFreshBaseAdmission` (struct, L2966), `SigmaFreshFootprintSample` (class, L2559), `SigmaFreshShadowBranch` (struct, L2945), `SigmaGaugeCell` (struct, L2422), `SigmaGeneratedAlgebra` (class, L2055), `SigmaGeneratedFrame` (class, L6126), `SigmaGeneratedMerkabaProgram` (class, L2984), `SigmaImplicitBoundaryRef` (struct, L2530), `SigmaInstrumentEyeBoundary` (class, L2842), `SigmaInstrumentFootprint` (struct, L2812), `SigmaInstrumentLeafKind` (enum, L2797), `SigmaInstrumentOpticalTransfer` (enum, L2805), `SigmaMerkabaEntryPoint` (struct, L2360), `SigmaMerkabaExpression` (struct, L2340), `SigmaMerkabaIrNode` (struct, L2317), `SigmaMerkabaIrOpcode` (enum, L2265), `SigmaMerkabaRelationClass` (enum, L2279), `SigmaMerkabaReverseRule` (enum, L2274), `SigmaMerkabaValueKind` (enum, L2269), `SigmaMinimizedFactor` (struct, L2414), `SigmaNativeBoundarySector` (enum, L2486), `SigmaNativeQueryClaim` (enum, L2290), `SigmaResolvedStitch` (struct, L2692), `SigmaSampleBoundarySide` (enum, L2461), `SigmaStitchBoundaryEnvelope` (struct, L2511), `SigmaStitchContactBranch` (struct, L2493), `SigmaStitchLocality` (struct, L2735), `SigmaStitchNativeContext` (struct, L2590), `SigmaStitchPattern` (struct, L2778), `SigmaStitchRelationReceipt` (struct, L2607), `SigmaStitchResolution` (enum, L2476), `SigmaStitchWitnessSet` (class, L2709), `action_expression` (function, L481), `add_expression` (function, L354), `add_node` (function, L337), `associator_expression` (function, L384), `basis_product` (function, L154), `build_descriptor` (function, L1824), `build_executable_merkaba_ir` (function, L286), `build_merkaba_descriptor` (function, L1463), `certificate_minimizer_proof` (function, L941), `check_or_write` (function, L6296), `chunks` (function, L2026), `collapse_once` (function, L1012), `conjugate_sign` (function, L171), `constructive_stitch_authority_proof` (function, L1292), `cs_array` (function, L2031), `default_representation_proof` (function, L854), `diffraction_expression` (function, L400), `diffraction_matrix` (function, L216), `dyads` (function, L179), `evaluate_actual_associator` (function, L723), `file_sha256` (function, L204), `fingerprint_words` (function, L2115), `forward` (function, L1163), `frame_abi_descriptor` (function, L5992), `fresh_admission_expression` (function, L523), `fresh_base_admission_proof` (function, L1108), `fresh_boundary_relation` (function, L1176), `fresh_support_set_expression` (function, L548), `gauge_expression` (function, L512), `gauge_transport_proof` (function, L999), `hadamard_sign` (function, L175), `information_metric` (function, L267), `input_s16` (function, L375), `interpret_forward` (function, L875), `interval_add` (function, L643), `interval_mul` (function, L638), `interval_sub` (function, L646), `MerkabaDirectionalActionParity` (gpu_kernel, L5574), `MerkabaFreshAdmissionParity` (gpu_kernel, L5575), `MerkabaGaugeParity` (gpu_kernel, L5577), `MerkabaInstrumentBoundaryParity` (gpu_kernel, L5576), `MerkabaMatrixAndIrParity` (gpu_kernel, L5573), `MerkabaProgramParity` (gpu_kernel, L5572), `MerkabaStitchSetParity` (gpu_kernel, L5578), `lift` (function, L1150), `link_factor_expression` (function, L406), `main` (function, L6309), `matrix_multiply` (function, L259), `merkaba_shadow_numerator` (function, L231), `minimize` (function, L951), `multiply_dyads` (function, L187), `multiply_s16` (function, L710), `nearest_even` (function, L1114), `normalize` (function, L1027), `normalized_associator_expression` (function, L424), `optical_expression` (function, L494), `packed_i64` (function, L4863), `plaquette_expression` (function, L438), `qmul` (function, L1125), `query_support_exhaustive_proof` (function, L794), `read_json` (function, L208), `render_authority_manifest` (function, L5906), `render_cs` (function, L2040), `render_frame_cs` (function, L6047), `render_frame_hlsl` (function, L6240), `render_hlsl` (function, L2158), `render_hlsl_layout` (function, L2119), `render_merkaba_cs` (function, L2215), `render_merkaba_fixture` (function, L5567), `render_merkaba_hlsl` (function, L4846), `reverse_complete_tree_proof` (function, L631), `reverse_expression` (function, L470), `reverse_mul` (function, L649), `select_tangent` (function, L1131), `sha256` (function, L199), `shadow_expression` (function, L454), `signed_morton` (function, L237), `split` (function, L1007), `transpose` (function, L255), `uint_array` (function, L5977), `upper_snake` (function, L5981), `validate_descriptor` (function, L2000), `zig_zag` (function, L241)
