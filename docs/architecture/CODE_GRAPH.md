...
Source digest: `6c13801e6778c14dddb104bddea067ee5812e3574931732ea2cef5ee1f45fdcb`

Scope: 113 files, 1608 symbols, 1306 functions/methods, 64 GPU kernels, 5 event links.
...
`AbsNanoseconds` (method, L749), `Add` (method, L900), `AdvanceAge` (method, L985), `Begin` (method, L961), `BuildTrackingPriorEnvelope` (method, L519), `CaptureTimingTelemetry` (method, L218), `CeilDiv` (method, L780), `Complete` (method, L1017), `CountPendingTickets` (method, L708), `CreateArrayTexture` (method, L786), `CreateBuffer` (method, L783), `CreatePersistentResources` (method, L614), `DestroyTexture` (method, L816), `Dispose` (method, L1032), `ElapsedMilliseconds` (method, L986), `EnsureCalibration` (method, L589), `EnsureDirectGraph` (method, L232), `EnsureFrameResources` (method, L988), `EnsurePosePartials` (method, L1005), `FillCalibration` (method, L638), `FillRgbCalibration` (method, L674), `FindKernels` (method, L602), `FromRaw` (method, L885), `IndependenceKey` (method, L756), `IngressSlot` (class, L921), `LatchCompletionFault` (method, L369), `LateUpdate` (method, L166), `LatencyTracker` (class, L888), `MaxRigRotationResidual` (method, L576), `MaxRigTranslationResidual` (method, L563), `Mix` (method, L775), `NextRevision` (method, L732), `OnDestroy` (method, L827), `OnModuleInitialize` (method, L101), `OnPredictionReady` (method, L158), `OnScanStarted` (method, L136), `OnScanStopped` (method, L150), `Poll` (method, L982), `PollIngress` (method, L339), `PoseMatrix` (method, L754), `RecordCorrectedCalibration` (method, L459), `RecordNormalize` (method, L380), `RecordPoseGauge` (method, L405), `ReleasePendingIngress` (method, L720), `Reset` (method, L912), `SaturatingAdd` (method, L752), `SetQ` (method, L740), `SetQRaw` (method, L743), `SetRgbQ` (method, L745), `SetRgbQRaw` (method, L747), `SigmaInverseController` (class, L22), `SigmaPackedQ48` (struct, L876), `SubmitIngress` (method, L250), `TrackLast` (method, L726), `TryGetFreeIngressSlot` (method, L690), `UploadExactCalibration` (method, L486), `UploadPosePrior` (method, L499)
...
`BindBuild` (method, L401), `BindCompaction` (method, L422), `BindHaloResolve` (method, L445), `BuildClipFromWorld` (method, L531), `DestroyMaterial` (method, L643), `Dispose` (method, L721), `DrawSegments` (method, L460), `EnsureSegmentCaches` (method, L499), `LateUpdate` (method, L214), `Matches` (method, L715), `OnDestroy` (method, L596), `OnModuleInitialize` (method, L151), `OnScanStarted` (method, L201), `OnScanStopped` (method, L207), `PrepareReadoutCaches` (method, L380), `RenderDirectCarrierPreview` (method, L557), `RenderPrediction` (method, L305), `SegmentReadoutCache` (class, L653), `SetMrt` (method, L523), `SigmaRenderer` (class, L19), `TryAcquireLatest` (method, L140), `TryGetReadoutDiagnostics` (method, L112), `TryRecordPoseGaugePrediction` (method, L256), `TryRender` (method, L235), `TryRenderPoseGauge` (method, L244)
