...
Source digest: `d7341b0234c40ae8efc7f43212e394135321c687da909256f478a8a9c61de371`

Scope: 192 files, 2678 symbols, 2118 functions/methods, 123 GPU kernels, 30 event links.
...
- `PrismFilmUpdater.UpdateCompleted` → `OnFilmUpdateCompleted` ([Runtime/Prism/Geometry/PrismBoundaryGraph.cs:142](../../Runtime/Prism/Geometry/PrismBoundaryGraph.cs#L142))
- `PrismBoundaryGraph.BoundariesUpdated` → `OnBoundariesUpdated` ([Runtime/Prism/Geometry/PrismDisplacementTopology.cs:295](../../Runtime/Prism/Geometry/PrismDisplacementTopology.cs#L295))
...
`AllocateFrameBuffers` (method, L287), `BindFrame` (method, L241), `BindPersistent` (method, L303), `CeilDiv` (method, L354), `ConfigureFrame` (method, L225), `DispatchBoundaries` (method, L192), `DisposeFrameBuffers` (method, L333), `Intrinsics` (method, L347), `OnDestroy` (method, L180), `OnFilmUpdateCompleted` (method, L189), `PoseMatrix` (method, L351), `PrismBoundaryGraph` (class, L15), `RebuildCanonicalIndex` (method, L149), `SetChunkFrame` (method, L101), `StartTracking` (method, L104), `StopTracking` (method, L172)

### `Runtime/Prism/Geometry/PrismDisplacementTopology.cs`

`AllocateTransientBuffers` (method, L419), `BindPersistent` (method, L477), `BindTopology` (method, L602), `CeilDiv` (method, L796), `ConfigureFrame` (method, L377), `DispatchDisplacement` (method, L319), `DisposeTransientBuffers` (method, L753), `NextPowerOfTwo` (method, L799), `OnBoundariesUpdated` (method, L316), `OnDestroy` (method, L308), `PoseMatrix` (method, L793), `PrismDisplacementTopology` (class, L15), `RunTopologyAdaptation` (method, L716), `SetChunkFrame` (method, L215), `StartUpdating` (method, L218), `StopUpdating` (method, L300)
...
`AccumulateBoundaryAbsence` (gpu_function, L669), `AccumulateBoundaryEvents` (gpu_function, L566), `AtomicAddScaled` (gpu_function, L257), `BoundaryHashEntry` (struct, L84), `BuildBoundarySolveArguments` (gpu_function, L706), `ClearBoundaryFrame` (gpu_function, L558), `ClearLoadedBoundaryHash` (gpu_function, L519), `ConeEvent` (struct, L9), `ContactBoundaryHeader` (struct, L62), `ContactFilmHeader` (struct, L32), `Cubic` (gpu_function, L232), `DistanceToCurve` (gpu_function, L239), `FindAdjacentFilm` (gpu_function, L473), `FindBoundary` (gpu_function, L278), `HashKey` (gpu_function, L149), `Height` (gpu_function, L196), `InitializeBoundaryState` (gpu_function, L497), `LoadDepthRay` (gpu_function, L160), `LoadRgb` (gpu_function, L166), `Luminance` (gpu_function, L173), `MarkDirty` (gpu_function, L265), `PointToUv` (gpu_function, L224), `RefineUvWithRgb` (gpu_function, L398), `RehashLoadedBoundaries` (gpu_function, L525), `ResolveBoundary` (gpu_function, L300), `SobelMagnitude` (gpu_function, L178), `SolveDirtyBoundaries` (gpu_function, L713), `SurfaceNormal` (gpu_function, L211), `SurfacePoint` (gpu_function, L203), `ViewBin` (gpu_function, L387), `AccumulateBoundaryAbsence` (gpu_kernel, L6), `AccumulateBoundaryEvents` (gpu_kernel, L5), `BuildBoundarySolveArguments` (gpu_kernel, L7), `ClearBoundaryFrame` (gpu_kernel, L4), `ClearLoadedBoundaryHash` (gpu_kernel, L2), `InitializeBoundaryState` (gpu_kernel, L1), `RehashLoadedBoundaries` (gpu_kernel, L3), `SolveDirtyBoundaries` (gpu_kernel, L8)
...
`AddTransformedInformation` (gpu_function, L1004), `BootstrapCoverage` (gpu_function, L218), `BoundaryDerivative3` (gpu_function, L651), `BoundaryHashEntry` (struct, L63), `BoundaryHashKey` (gpu_function, L393), `BoundaryPoint3` (gpu_function, L644), `BoundaryUv` (gpu_function, L624), `BoundaryUvDerivative` (gpu_function, L633), `BuildFilmMergeHash` (gpu_function, L874), `BuildMergeArguments` (gpu_function, L1291), `BuildTopologyAdaptArguments` (gpu_function, L545), `CellForPage` (gpu_function, L249), `ChildBasisTransform` (gpu_function, L313), `ClearFilmMergeHash` (gpu_function, L859), `ClearTopologyAdaptFrame` (gpu_function, L402), `ClearTopologyBoundaryHash` (gpu_function, L806), `ContactBoundaryHeader` (struct, L54), `ContactFilmHeader` (struct, L14), `ContactTopologyEvidence` (struct, L46), `DisplacementCell` (struct, L38), `DisplacementPageHeader` (struct, L29), `FilmCell` (gpu_function, L854), `FilmCellHash` (gpu_function, L845), `FilmMergeHashEntry` (struct, L83), `GeneralBasisTransform` (gpu_function, L975), `Height` (gpu_function, L211), `IncludeFilmBounds` (gpu_function, L958), `InitializeMergedDisplacement` (gpu_function, L1339), `InitializeSplitDisplacement` (gpu_function, L567), `IsMicroCell` (gpu_function, L228), `LoadCell` (gpu_function, L230), `LoadChild` (gpu_function, L237), `LoadG` (gpu_function, L185), `LoadH` (gpu_function, L174), `LockFilm` (gpu_function, L947), `MergeCompatible` (gpu_function, L905), `MergeCompatibleFilms` (gpu_function, L1096), `PageHeaderIndex` (gpu_function, L244), `QuadrantSupport` (gpu_function, L290), `RehashTopologyBoundaries` (gpu_function, L812), `ResetFilmMergeWave` (gpu_function, L866), `ResolveLeaf` (gpu_function, L255), `SolveSix` (gpu_function, L1055), `SourceDisplacement` (gpu_function, L1299), `SplitContactFilms` (gpu_function, L410), `StoreInformation` (gpu_function, L196), `TopologyMergeRecord` (struct, L76), `TopologySplitRecord` (struct, L68), `TransferSplitBoundaries` (gpu_function, L744), `TransformChildInformation` (gpu_function, L329), `TransformUvToChild` (gpu_function, L617), `UpperIndex` (gpu_function, L169), `UvQuadrant` (gpu_function, L659), `WriteSplitBoundary` (gpu_function, L664), `if` (gpu_function, L1317), `BuildFilmMergeHash` (gpu_kernel, L10), `BuildMergeArguments` (gpu_kernel, L12), `BuildTopologyAdaptArguments` (gpu_kernel, L3), `ClearFilmMergeHash` (gpu_kernel, L9), `ClearTopologyAdaptFrame` (gpu_kernel, L1), `ClearTopologyBoundaryHash` (gpu_kernel, L6), `InitializeMergedDisplacement` (gpu_kernel, L13), `InitializeSplitDisplacement` (gpu_kernel, L4), `MergeCompatibleFilms` (gpu_kernel, L11), `RehashTopologyBoundaries` (gpu_kernel, L7), `ResetFilmMergeWave` (gpu_kernel, L8), `SplitContactFilms` (gpu_kernel, L2), `TransferSplitBoundaries` (gpu_kernel, L5)
...
`DefaultSparseBuffersRemainBelowStorageBindingLimit` (method, L34), `FilmFlagsKeepOneSidedDetailAndRetiredParentsDistinct` (method, L113), `PressureAccumulatorAbiKeepsAllElevenMoments` (method, L104), `PrismTopologyContractTests` (class, L10), `RequiredQ311ComputeKernelsImport` (method, L69), `TopologyGpuAbiMatchesDeclaredStrides` (method, L15)
