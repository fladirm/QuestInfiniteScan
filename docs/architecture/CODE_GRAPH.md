...
Source digest: `c02f520d43078b35c2ce649297bd86e6a0351c0a0c0bd23543661d305ce7dc29`
...
`AddMeshletBuildGroupOffsets` (gpu_function, L1209), `BootstrapCoverage` (gpu_function, L453), `BootstrapCoverageCell` (gpu_function, L443), `BoundaryCubic` (gpu_function, L525), `BoundaryHashEntry` (struct, L128), `BoundaryHashKey` (gpu_function, L514), `BoundarySignedDistance` (gpu_function, L599), `BuildAdaptiveFilmMeshlets` (gpu_function, L1432), `BuildFilmCount` (gpu_function, L288), `BuildFilmIndex` (gpu_function, L294), `BuildMeshDispatchArguments` (gpu_function, L944), `BuildSurfaceVertex` (gpu_function, L1340), `CellTouchesPersistentBoundary` (gpu_function, L585), `ChooseSubdivision` (gpu_function, L872), `ClassifyMaterialTriangle` (gpu_function, L694), `ClearMeshletBuild` (gpu_function, L925), `ClipTriangle` (gpu_function, L1370), `ClosestBoundaryPoint` (gpu_function, L534), `ClosestManifoldLinkPoint` (gpu_function, L773), `CommitDirtyMeshletBuild` (gpu_function, L1002), `CommitFullMeshletRepack` (gpu_function, L1275), `ContactBoundaryHeader` (struct, L83), `ContactFilmHeader` (struct, L17), `ContactMeshletDescriptor` (struct, L64), `ContactMeshletVertex` (struct, L47), `CountMeshletBuildPlans` (gpu_function, L1042), `DisplacementCell` (struct, L154), `DisplacementMetrics` (gpu_function, L363), `DisplacementPageHeader` (struct, L137), `EmitClippedPolygon` (gpu_function, L1397), `FilmMembership` (struct, L105), `FilmMeshletRange` (struct, L188), `FilmSlotState` (struct, L197), `FinalizeDirtyMeshletFilms` (gpu_function, L1296), `FinalizeMeshletDrawArguments` (gpu_function, L1732), `Height` (gpu_function, L721), `LoadDisplacementCell` (gpu_function, L300), `LoadDisplacementChild` (gpu_function, L312), `ManifoldLink` (struct, L112), `ManifoldLinkIncidence` (struct, L121), `MeshletBuildPlan` (struct, L168), `NonDegenerateCutScalar` (gpu_function, L673), `PrepareDirtyMeshletBuild` (gpu_function, L961), `PrepareFullMeshletRepack` (gpu_function, L1023), `RecoverPreviousMeshletGeneration` (gpu_function, L1705), `Reserve` (gpu_function, L852), `ReservedIndexCount` (gpu_function, L918), `ReservedSubdivision` (gpu_function, L904), `ReservedVertexCount` (gpu_function, L910), `ResolveDisplacementPage` (gpu_function, L322), `SampleDisplacement` (gpu_function, L415), `ScanMeshletBuildGroups` (gpu_function, L1187), `ScanMeshletBuildPlans` (gpu_function, L1151), `StableLinkSampleId` (gpu_function, L763), `StableSurfaceSampleId` (gpu_function, L1329), `SurfaceCoverage` (gpu_function, L469), `SurfaceNormal` (gpu_function, L729), `SurfacePosition` (gpu_function, L754), `TriangleBoundaryCut` (gpu_function, L681), `TriangleMask` (gpu_function, L666), `ValidateDirtyMeshletBuild` (gpu_function, L975), `ValidateMeshletBuild` (gpu_function, L1224), `AddMeshletBuildGroupOffsets` (gpu_kernel, L6), `BuildAdaptiveFilmMeshlets` (gpu_kernel, L8), `BuildMeshDispatchArguments` (gpu_kernel, L2), `ClearMeshletBuild` (gpu_kernel, L1), `CommitDirtyMeshletBuild` (gpu_kernel, L14), `CommitFullMeshletRepack` (gpu_kernel, L16), `CountMeshletBuildPlans` (gpu_kernel, L3), `FinalizeDirtyMeshletFilms` (gpu_kernel, L13), `FinalizeMeshletDrawArguments` (gpu_kernel, L10), `PrepareDirtyMeshletBuild` (gpu_kernel, L11), `PrepareFullMeshletRepack` (gpu_kernel, L15), `RecoverPreviousMeshletGeneration` (gpu_kernel, L9), `ScanMeshletBuildGroups` (gpu_kernel, L5), `ScanMeshletBuildPlans` (gpu_kernel, L4), `ValidateDirtyMeshletBuild` (gpu_kernel, L12), `ValidateMeshletBuild` (gpu_kernel, L7)
