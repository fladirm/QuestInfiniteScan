...
Source digest: `f69c3ed2b31b4a8c8d04cace85499b90e223ca5fcf850cc7d1d00b3fc46b7867`

Scope: 103 files, 1795 symbols, 1481 functions/methods, 30 GPU kernels, 5 event links.
...
`SigmaMerkabaAssembleInstrumentTangent` (gpu_function, L413), `SigmaMerkabaAssociatorCoefficient` (gpu_function, L303), `SigmaMerkabaBasisSign` (gpu_function, L298), `SigmaMerkabaBoundaryEnvelopesContact` (gpu_function, L733), `SigmaMerkabaBuildDirectionalAction` (gpu_function, L682), `SigmaMerkabaBuildInstrumentRowPermutation` (gpu_function, L376), `SigmaMerkabaCanOmitQueryRegion` (gpu_function, L711), `SigmaMerkabaClassifyPointNativeStitchPair` (gpu_function, L787), `SigmaMerkabaClassifyZeroDivisor` (gpu_function, L723), `SigmaMerkabaDecodeDefaultLane` (gpu_function, L717), `SigmaMerkabaEvaluateFreshBoundaryRelation` (gpu_function, L498), `SigmaMerkabaEvaluateNativeStitchLink` (gpu_function, L756), `SigmaMerkabaEvaluateShadow` (gpu_function, L327), `SigmaMerkabaFinalizeNativeStitchSet` (gpu_function, L813), `SigmaMerkabaGaugeLess` (gpu_function, L658), `SigmaMerkabaGaugeMortonLess` (gpu_function, L644), `SigmaMerkabaGaugeSignedMorton` (gpu_function, L629), `SigmaMerkabaGaugeSpread16` (gpu_function, L620), `SigmaMerkabaGaugeZigZag` (gpu_function, L601), `SigmaMerkabaInstrumentCompareSwap` (gpu_function, L359), `SigmaMerkabaIsZEmpty` (gpu_function, L577), `SigmaMerkabaLiftShadow` (gpu_function, L343), `SigmaMerkabaNativeBoundarySectorAddress` (gpu_function, L748), `SigmaMerkabaPlaquetteHolonomy` (gpu_function, L314), `SigmaMerkabaResolveFreshBranch` (gpu_function, L538), `SigmaMerkabaSectorChartCandidateDirection` (gpu_function, L881), `SigmaMerkabaSelectFreshTangent` (gpu_function, L455), `SigmaMerkabaShadowNumerator` (gpu_function, L322), `SigmaMerkabaSignTransport` (gpu_function, L309), `SigmaMerkabaSplitDyadicGauge` (gpu_function, L586), `SigmaMerkabaTransformChartCellLower` (gpu_function, L894), `if` (gpu_function, L483)
...
`ContractNativeQuery` (gpu_function, L1634), `SigmaN4ChartAssignmentOrbit` (gpu_function, L846), `SigmaN4ChartDirection` (gpu_function, L875), `SigmaN4ChartFrameDeterminant` (gpu_function, L869), `SigmaN4ChartOrbitRepresentative` (gpu_function, L855), `SigmaN4ResolveAdjacentFrame` (gpu_function, L886), `SigmaN4TileBoundaryHeader` (gpu_function, L831), `SigmaN4TileBoundaryIndex` (gpu_function, L809), `SigmaN4TileBuildComponents` (gpu_function, L1194), `SigmaN4TileCertificate` (gpu_function, L962), `SigmaN4TileCertificateReduce` (gpu_function, L975), `SigmaN4TileChartAssigned` (gpu_function, L1258), `SigmaN4TileChartEqual` (gpu_function, L1300), `SigmaN4TileChartFrame` (gpu_function, L1260), `SigmaN4TileChartProposal` (gpu_function, L1261), `SigmaN4TileClose` (gpu_function, L1542), `SigmaN4TileComponentAddress` (gpu_function, L760), `SigmaN4TileD4Equivalent` (gpu_function, L1373), `SigmaN4TileFinalizeComponents` (gpu_function, L1404), `SigmaN4TileFindRoot` (gpu_function, L1184), `SigmaN4TileFootprintAddress` (gpu_function, L748), `SigmaN4TileFootprintValid` (gpu_function, L776), `SigmaN4TileGlobalFootprint` (gpu_function, L767), `SigmaN4TileMeetSupports` (gpu_function, L1016), `SigmaN4TileNeighbour` (gpu_function, L914), `SigmaN4TilePackChart` (gpu_function, L1252), `SigmaN4TileResolvedEdge` (gpu_function, L839), `SigmaN4TileSolveOrbit` (gpu_function, L1305), `SigmaN4TileSortSupports` (gpu_function, L931), `SigmaN4TileStoreCertificate` (gpu_function, L969), `SigmaN4TileStructuralCertificateEqual` (gpu_function, L986), `SigmaN4TileSupportAddress` (gpu_function, L753), `SigmaN4TileSupportKey` (gpu_function, L794), `SigmaNativeFreshEntryValid` (gpu_function, L166), `SigmaNativeFreshEvidenceAddress` (gpu_function, L137), `SigmaNativeFreshFinalize` (gpu_function, L1556), `SigmaNativeFreshLiftFootprint` (gpu_function, L737), `SigmaNativeFreshLiftLegacyBranch` (gpu_function, L730), `SigmaNativeFreshLiftSource` (gpu_function, L244), `SigmaNativeFreshLiftWeight` (gpu_function, L210), `SigmaNativeFreshLoad2` (gpu_function, L146), `SigmaNativeFreshLoad4` (gpu_function, L154), `SigmaNativeFreshModeMask` (gpu_function, L200), `SigmaNativeFreshPermutationAxis` (gpu_function, L174), `SigmaNativeFreshPermutationMode` (gpu_function, L182), `SigmaNativeFreshQ48Equal` (gpu_function, L161), `SigmaNativeFreshReduceAnd` (gpu_function, L216), `SigmaNativeFreshReduceOr` (gpu_function, L230), `if` (gpu_function, L304), `if` (gpu_function, L667), `if` (gpu_function, L674), `if` (gpu_function, L691), `ContractNativeQuery` (gpu_kernel, L4)
...
`EvaluateNativeRelation` (gpu_function, L1176), `SigmaN4Affine` (gpu_function, L647), `SigmaN4AffineCompose` (gpu_function, L705), `SigmaN4AffineEqual` (gpu_function, L724), `SigmaN4AffineIdentity` (gpu_function, L653), `SigmaN4AffineInverse` (gpu_function, L715), `SigmaN4BoundaryFactor` (gpu_function, L150), `SigmaN4BoundaryReceiptAddress` (gpu_function, L107), `SigmaN4ChartAssignmentOrbit` (gpu_function, L730), `SigmaN4ChartDirection` (gpu_function, L759), `SigmaN4ChartFrameDeterminant` (gpu_function, L753), `SigmaN4ChartOrbitRepresentative` (gpu_function, L739), `SigmaN4ClassifyBoundaryFactors` (gpu_function, L186), `SigmaN4CrossBoundaryCount` (gpu_function, L843), `SigmaN4D4Compose` (gpu_function, L665), `SigmaN4D4Inverse` (gpu_function, L686), `SigmaN4D4Vector` (gpu_function, L658), `SigmaN4DecodeBoundary` (gpu_function, L125), `SigmaN4DecodeCrossBoundary` (gpu_function, L849), `SigmaN4DirectRightToLeft` (gpu_function, L802), `SigmaN4EvaluateImplicitBoundary` (gpu_function, L269), `SigmaN4FindGlobalRoot` (gpu_function, L899), `SigmaN4FindTileSupport` (gpu_function, L436), `SigmaN4FootprintAddress` (gpu_function, L102), `SigmaN4GlobalCertificateCompatible` (gpu_function, L482), `SigmaN4GlobalCertificateReduce` (gpu_function, L469), `SigmaN4GlobalGeometryClose` (gpu_function, L933), `SigmaN4GlobalNode` (gpu_function, L828), `SigmaN4GlobalParentAddress` (gpu_function, L636), `SigmaN4GlobalRootLink` (gpu_function, L918), `SigmaN4GlobalTransformAddress` (gpu_function, L641), `SigmaN4LoadChartState` (gpu_function, L794), `SigmaN4LoadGlobalMeta` (gpu_function, L80), `SigmaN4LoadGlobalState` (gpu_function, L91), `SigmaN4LoadGlobalTransform` (gpu_function, L885), `SigmaN4ReduceActiveSupport` (gpu_function, L496), `SigmaN4ResolveAdjacentFrame` (gpu_function, L768), `SigmaN4SignedU128Add` (gpu_function, L156), `SigmaN4StoreBoundaryReceipt` (gpu_function, L113), `SigmaN4StoreGlobalMeta` (gpu_function, L85), `SigmaN4StoreGlobalState` (gpu_function, L96), `SigmaN4StoreGlobalTransform` (gpu_function, L892), `SigmaN4TileComponentAddress` (gpu_function, L629), `SigmaN4TileFootprintAddress` (gpu_function, L623), `SigmaN4TileHeaderAddress` (gpu_function, L423), `SigmaN4TileSupportAddress` (gpu_function, L429), `EvaluateNativeRelation` (gpu_kernel, L3)
...
`BindContract` (method, L416), `BindFrameKernels` (method, L234), `BindRelation` (method, L503), `CameraPose` (method, L14), `Dispose` (method, L227), `Dispose` (method, L85), `FromCamera` (method, L10), `Intrinsics` (method, L578), `OpticalTransfer` (method, L582), `RecordNativeCloseCommit` (method, L169), `Release` (method, L225), `SigmaNativeFrameGraph` (class, L101), `SigmaNativeFrameInput` (struct, L27), `SigmaNativeFrameLease` (class, L70), `SigmaRoomFrame` (class, L8), `TryAcquire` (method, L155)
...
`AuthorityBoundaryAndExecutableIrAreFrozen` (method, L24), `Buffer` (method, L1302), `CertificateMinimizerIsExactBoundedAndCouplingAware` (method, L790), `ConstructiveCaptureBoundaryBuildsCalibratedEightLeafPair` (method, L463), `ConstructiveModalStitchingUsesAbstractWitnessesAndD4ChartGauge` (method, L142), `DirectionalActionCarriesIntervalsAndStopsAtFirstHit` (method, L727), `ExactZeroDivisorAndOneLsbResidualDoNotAlias` (method, L963), `Factor` (method, L1273), `FreshAdmissionIsGeneratedFromShadowPreimageNotProposedState` (method, L896), `GaugeLess` (method, L1243), `GaugeSplitTransportCollapseAndNormalizationAreConstructive` (method, L820), `GeneratedHlslMatchesCpuTablesIrAndDirectionalAction` (method, L988), `GeneratedReverseDescriptorsRetainZeroBranchesAndSceneDisjunction` (method, L754), `Join` (method, L1240), `Permutations` (method, L1279), `Permute` (method, L1287), `QuerySupportSummaryMatchesIndependentExhaustiveEvaluation` (method, L693), `ShadowKernelDefaultAndExactFactorClassesFailClosed` (method, L639), `SigmaMerkabaProgramTests` (class, L12), `SignedMorton` (method, L1253), `SignedXorAssociatorDiffractionMetricAndHolonomyAreExact` (method, L571), `UInt4` (struct, L15)
...
`BindPublication` (method, L1917), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L136), `CertificateDifference` (method, L2128), `CertifiedConstraintRecord` (method, L2039), `Compare` (method, L2668), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L1665), `ConstraintRecord` (method, L2009), `Count` (method, L1908), `DirectionModeMask` (method, L2109), `Equals` (method, L2656), `Equals` (method, L2659), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1410), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1123), `FindGaugeSample` (method, L2413), `Flatten` (method, L2457), `Flatten` (method, L2468), `From` (method, L2650), `GaugeKey` (struct, L2629), `GaugeKeyComparer` (class, L2664), `GetHashCode` (method, L2661), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L1484), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L93), `LoadShader` (method, L1763), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L1518), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L1585), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1452), `Packed` (method, L2481), `PageMeta` (struct, L2721), `PersistAndReload` (method, L2097), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1263), `PrepareRefinementScratch` (method, L2294), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L276), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L769), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L436), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1008), `Q2` (method, L2506), `Q4` (method, L2120), `ReadCertificate` (method, L2445), `ReadPageMeta` (method, L2405), `ReadState` (method, L2435), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L1723), `RefinementSnapshot` (class, L2583), `RefinementStep` (struct, L2568), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L1631), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L1688), `RunRefinementSequence` (method, L2140), `RunStaticExclusion` (method, L1776), `SetEqualCertificates` (method, L1986), `SetValidNextCertificate` (method, L1969), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L2681), `StaticExclusionSnapshot` (class, L2605), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1236), `ToRaw` (method, L2642), `ToString` (method, L2662), `U4` (method, L2512), `UInt2` (struct, L2705), `UInt2Buffer` (method, L2518), `UInt4` (struct, L2712), `UInt4Buffer` (method, L2521), `UIntBuffer` (method, L2515), `WriteEnvelope` (method, L2495), `WriteRepresentationCell` (method, L2366), `WriteState` (method, L2487), `ZeroArrayRenderTexture` (method, L2524), `ZeroRenderTexture` (method, L2549)

### `Tests/Editor/SigmaNativeOracleTests.cs`

`AssertFreshGpuMatchesCpu` (method, L2023), `AssertGpuRelationsMatchCpu` (method, L2354), `AssertGpuShadowEqual` (method, L3182), `AssertGpuShadowMatchesCpu` (method, L3202), `Axis` (method, L3001), `BuildPhotometricQuery` (method, L2918), `Candidate` (method, L2749), `Cell` (method, L2768), `CpuCandidate` (method, L2755), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L353), `EmptyOptical` (method, L3006), `EntryPointIndex` (method, L3174), `EntryPointIndex` (method, L3178), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L2462), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L480), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L676), `Factor` (method, L3010), `FreshBaseAdmissionStartsAtCoherentObservationAndMatchesVulkan` (method, L210), `FreshContractMarksOnlyExactStereoPreHitForStaticExclusion` (method, L406), `FreshObservation` (method, L2786), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L549), `GetHashCode` (method, L39), `GpuFreshAdmission` (class, L72), `GpuShadow` (class, L41), `HashS16` (method, L3120), `Kernels` (method, L736), `Law` (method, L2950), `LeftQuery` (method, L2892), `LoadShader` (method, L3219), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L718), `Pack` (method, L3142), `PackGaugeCoordinate` (method, L3031), `PackGaugeMetadata` (method, L3039), `PackInstrumentCodes` (method, L2885), `PackInterval` (method, L3071), `PackKeys` (method, L3023), `PackPhotometricLaw` (method, L3079), `PackRelationPlan` (method, L3057), `PackRows` (method, L3135), `PackStates` (method, L3139), `PackU256` (method, L3148), `PiecewiseLaw` (method, L2972), `Point` (method, L3004), `Query` (method, L2904), `Raw` (method, L3008), `ReduceWindows` (method, L2717), `RelationFor` (method, L2763), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L146), `RightQuery` (method, L2898), `RunGpuContractOverflow` (method, L2038), `RunGpuEyePair` (method, L2488), `RunGpuFreshAdmission` (method, L1820), `RunGpuQuery` (method, L2480), `RunGpuQuerySet` (method, L2495), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L638), `State` (method, L2772), `StateRaw` (method, L2775), `Summary` (method, L3014), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L3168), `UnpackKey` (method, L3171), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L1535), `VulkanConstructiveStitchSetMatchesGeneratedCpuAuthority` (method, L794), `VulkanExportDebugAndEyePairExecuteDistinctGeneratedSemantics` (method, L1604), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L1487), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L1392), `VulkanReducerHandlesMoreThan64AndSignalsBoundedColdContinuation` (method, L1687), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L1736), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L99)
...
`SigmaAssembledSensorEye` (struct, L2963), `SigmaBoundaryNativeInput` (struct, L2815), `SigmaCertificateFactor` (struct, L2441), `SigmaChartD4Transform` (struct, L2487), `SigmaComponentNormalForm` (class, L3904), `SigmaDefaultBackingKind` (enum, L2353), `SigmaDirectionalActionWitness` (struct, L2423), `SigmaExactFactorClass` (enum, L2346), `SigmaFootprintSupportDisposition` (enum, L2517), `SigmaFrameUInt2Gpu` (struct, L6365), `SigmaFrameUInt4Gpu` (struct, L6372), `SigmaFreshAdmissionStatus` (enum, L2360), `SigmaFreshBaseAdmission` (struct, L3015), `SigmaFreshFootprintSample` (class, L2608), `SigmaFreshShadowBranch` (struct, L2994), `SigmaGaugeCell` (struct, L2471), `SigmaGeneratedAlgebra` (class, L2104), `SigmaGeneratedFrame` (class, L6383), `SigmaGeneratedMerkabaProgram` (class, L3033), `SigmaImplicitBoundaryRef` (struct, L2579), `SigmaInstrumentEyeBoundary` (class, L2891), `SigmaInstrumentFootprint` (struct, L2861), `SigmaInstrumentLeafKind` (enum, L2846), `SigmaInstrumentOpticalTransfer` (enum, L2854), `SigmaMerkabaEntryPoint` (struct, L2409), `SigmaMerkabaExpression` (struct, L2389), `SigmaMerkabaIrNode` (struct, L2366), `SigmaMerkabaIrOpcode` (enum, L2314), `SigmaMerkabaRelationClass` (enum, L2328), `SigmaMerkabaReverseRule` (enum, L2323), `SigmaMerkabaValueKind` (enum, L2318), `SigmaMinimizedFactor` (struct, L2463), `SigmaNativeBoundarySector` (enum, L2535), `SigmaNativeQueryClaim` (enum, L2339), `SigmaResolvedStitch` (struct, L2741), `SigmaSampleBoundarySide` (enum, L2510), `SigmaStitchBoundaryEnvelope` (struct, L2560), `SigmaStitchContactBranch` (struct, L2542), `SigmaStitchLocality` (struct, L2784), `SigmaStitchNativeContext` (struct, L2639), `SigmaStitchPattern` (struct, L2827), `SigmaStitchRelationReceipt` (struct, L2656), `SigmaStitchResolution` (enum, L2525), `SigmaStitchWitnessSet` (class, L2758), `action_expression` (function, L481), `add_expression` (function, L354), `add_node` (function, L337), `assignment_orbit` (function, L1430), `associator_expression` (function, L384), `basis_product` (function, L154), `build_descriptor` (function, L1873), `build_executable_merkaba_ir` (function, L286), `build_merkaba_descriptor` (function, L1507), `certificate_minimizer_proof` (function, L941), `check_or_write` (function, L6553), `chunks` (function, L2075), `collapse_once` (function, L1012), `conjugate_sign` (function, L171), `constructive_stitch_authority_proof` (function, L1292), `cs_array` (function, L2080), `default_representation_proof` (function, L854), `diffraction_expression` (function, L400), `diffraction_matrix` (function, L216), `dyads` (function, L179), `evaluate_actual_associator` (function, L723), `file_sha256` (function, L204), `fingerprint_words` (function, L2164), `forward` (function, L1163), `frame_abi_descriptor` (function, L6249), `fresh_admission_expression` (function, L523), `fresh_base_admission_proof` (function, L1108), `fresh_boundary_relation` (function, L1176), `fresh_support_set_expression` (function, L548), `gauge_expression` (function, L512), `gauge_transport_proof` (function, L999), `hadamard_sign` (function, L175), `information_metric` (function, L267), `input_s16` (function, L375), `interpret_forward` (function, L875), `interval_add` (function, L643), `interval_mul` (function, L638), `interval_sub` (function, L646), `MerkabaDirectionalActionParity` (gpu_kernel, L5831), `MerkabaFreshAdmissionParity` (gpu_kernel, L5832), `MerkabaGaugeParity` (gpu_kernel, L5834), `MerkabaInstrumentBoundaryParity` (gpu_kernel, L5833), `MerkabaMatrixAndIrParity` (gpu_kernel, L5830), `MerkabaProgramParity` (gpu_kernel, L5829), `MerkabaStitchSetParity` (gpu_kernel, L5835), `lift` (function, L1150), `link_factor_expression` (function, L406), `main` (function, L6566), `matrix_multiply` (function, L259), `merkaba_shadow_numerator` (function, L231), `minimize` (function, L951), `multiply_dyads` (function, L187), `multiply_s16` (function, L710), `nearest_even` (function, L1114), `normalize` (function, L1027), `normalized_associator_expression` (function, L424), `optical_expression` (function, L494), `packed_i64` (function, L5099), `plaquette_expression` (function, L438), `qmul` (function, L1125), `query_support_exhaustive_proof` (function, L794), `read_json` (function, L208), `render_authority_manifest` (function, L6163), `render_cs` (function, L2089), `render_frame_cs` (function, L6304), `render_frame_hlsl` (function, L6497), `render_hlsl` (function, L2207), `render_hlsl_layout` (function, L2168), `render_merkaba_cs` (function, L2264), `render_merkaba_fixture` (function, L5824), `render_merkaba_hlsl` (function, L5079), `reverse_complete_tree_proof` (function, L631), `reverse_expression` (function, L470), `reverse_mul` (function, L649), `select_tangent` (function, L1131), `sha256` (function, L199), `shadow_expression` (function, L454), `signed_morton` (function, L237), `split` (function, L1007), `transform_direction` (function, L1423), `transpose` (function, L255), `uint_array` (function, L6234), `upper_snake` (function, L6238), `validate_descriptor` (function, L2049), `zig_zag` (function, L241)
