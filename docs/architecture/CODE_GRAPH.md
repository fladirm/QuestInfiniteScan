...
Source digest: `8283fc3439e4a5113b8fb65eee83f56f21bbac6e728be0e897dbd329205a26b3`

Scope: 103 files, 1673 symbols, 1368 functions/methods, 30 GPU kernels, 5 event links.
...
`AuthorityBoundaryAndExecutableIrAreFrozen` (method, L24), `Buffer` (method, L1049), `CertificateMinimizerIsExactBoundedAndCouplingAware` (method, L555), `ConstructiveCaptureBoundaryBuildsCalibratedEightLeafPair` (method, L228), `ConstructiveModalStitchingBuildsOnlyExactContactAndNormalizesComponents` (method, L126), `DirectionalActionCarriesIntervalsAndStopsAtFirstHit` (method, L492), `ExactZeroDivisorAndOneLsbResidualDoNotAlias` (method, L728), `Factor` (method, L1020), `FreshAdmissionIsGeneratedFromShadowPreimageNotProposedState` (method, L661), `GaugeLess` (method, L990), `GaugeSplitTransportCollapseAndNormalizationAreConstructive` (method, L585), `GeneratedHlslMatchesCpuTablesIrAndDirectionalAction` (method, L753), `GeneratedReverseDescriptorsRetainZeroBranchesAndSceneDisjunction` (method, L519), `Join` (method, L987), `Permutations` (method, L1026), `Permute` (method, L1034), `QuerySupportSummaryMatchesIndependentExhaustiveEvaluation` (method, L458), `ShadowKernelDefaultAndExactFactorClassesFailClosed` (method, L404), `SigmaMerkabaProgramTests` (class, L12), `SignedMorton` (method, L1000), `SignedXorAssociatorDiffractionMetricAndHolonomyAreExact` (method, L336), `UInt4` (struct, L15)
...
`SigmaAssembledSensorEye` (struct, L2536), `SigmaCertificateFactor` (struct, L2255), `SigmaDefaultBackingKind` (enum, L2167), `SigmaDirectionalActionWitness` (struct, L2237), `SigmaExactFactorClass` (enum, L2160), `SigmaFrameUInt2Gpu` (struct, L4901), `SigmaFrameUInt4Gpu` (struct, L4908), `SigmaFreshAdmissionStatus` (enum, L2174), `SigmaFreshBaseAdmission` (struct, L2588), `SigmaFreshShadowBranch` (struct, L2567), `SigmaGaugeCell` (struct, L2285), `SigmaGeneratedAlgebra` (class, L1920), `SigmaGeneratedFrame` (class, L4919), `SigmaGeneratedMerkabaProgram` (class, L2606), `SigmaInstrumentEyeBoundary` (class, L2464), `SigmaInstrumentFootprint` (struct, L2434), `SigmaInstrumentLeafKind` (enum, L2419), `SigmaInstrumentOpticalTransfer` (enum, L2427), `SigmaMerkabaEntryPoint` (struct, L2223), `SigmaMerkabaExpression` (struct, L2203), `SigmaMerkabaIrNode` (struct, L2180), `SigmaMerkabaIrOpcode` (enum, L2128), `SigmaMerkabaRelationClass` (enum, L2142), `SigmaMerkabaReverseRule` (enum, L2137), `SigmaMerkabaValueKind` (enum, L2132), `SigmaMinimizedFactor` (struct, L2277), `SigmaNativeQueryClaim` (enum, L2153), `SigmaResolvedStitch` (struct, L2350), `SigmaStitchBoundaryEnvelope` (struct, L2316), `SigmaStitchContactCandidate` (struct, L2332), `SigmaStitchLocality` (struct, L2371), `SigmaStitchLoopConstraint` (struct, L2388), `SigmaStitchPattern` (struct, L2402), `SigmaStitchPort` (enum, L2301), `SigmaStitchResolution` (enum, L2309), `action_expression` (function, L482), `add_expression` (function, L355), `add_node` (function, L338), `associator_expression` (function, L385), `basis_product` (function, L154), `build_descriptor` (function, L1689), `build_executable_merkaba_ir` (function, L286), `build_merkaba_descriptor` (function, L1353), `certificate_minimizer_proof` (function, L951), `check_or_write` (function, L5089), `chunks` (function, L1891), `collapse_once` (function, L1022), `conjugate_sign` (function, L171), `constructive_stitch_authority_proof` (function, L1302), `cs_array` (function, L1896), `default_representation_proof` (function, L864), `diffraction_expression` (function, L401), `diffraction_matrix` (function, L216), `dyads` (function, L179), `evaluate_actual_associator` (function, L733), `file_sha256` (function, L204), `fingerprint_words` (function, L1980), `forward` (function, L1173), `frame_abi_descriptor` (function, L4785), `fresh_admission_expression` (function, L524), `fresh_base_admission_proof` (function, L1118), `fresh_boundary_relation` (function, L1186), `fresh_support_set_expression` (function, L549), `gauge_expression` (function, L513), `gauge_transport_proof` (function, L1009), `hadamard_sign` (function, L175), `information_metric` (function, L267), `input_s16` (function, L376), `interpret_forward` (function, L885), `interval_add` (function, L653), `interval_mul` (function, L648), `interval_sub` (function, L656), `MerkabaDirectionalActionParity` (gpu_kernel, L4446), `MerkabaFreshAdmissionParity` (gpu_kernel, L4447), `MerkabaGaugeParity` (gpu_kernel, L4449), `MerkabaInstrumentBoundaryParity` (gpu_kernel, L4448), `MerkabaMatrixAndIrParity` (gpu_kernel, L4445), `MerkabaProgramParity` (gpu_kernel, L4444), `MerkabaStitchPrimitiveParity` (gpu_kernel, L4450), `lift` (function, L1160), `link_factor_expression` (function, L407), `main` (function, L5102), `matrix_multiply` (function, L259), `merkaba_shadow_numerator` (function, L231), `minimize` (function, L961), `multiply_dyads` (function, L187), `multiply_s16` (function, L720), `nearest_even` (function, L1124), `normalize` (function, L1037), `normalized_associator_expression` (function, L425), `optical_expression` (function, L495), `packed_i64` (function, L3833), `plaquette_expression` (function, L439), `qmul` (function, L1135), `query_support_exhaustive_proof` (function, L804), `read_json` (function, L208), `render_authority_manifest` (function, L4699), `render_cs` (function, L1905), `render_frame_cs` (function, L4840), `render_frame_hlsl` (function, L5033), `render_hlsl` (function, L2023), `render_hlsl_layout` (function, L1984), `render_merkaba_cs` (function, L2080), `render_merkaba_fixture` (function, L4439), `render_merkaba_hlsl` (function, L3820), `reverse_complete_tree_proof` (function, L641), `reverse_expression` (function, L471), `reverse_mul` (function, L659), `select_tangent` (function, L1141), `sha256` (function, L199), `shadow_expression` (function, L455), `signed_morton` (function, L237), `split` (function, L1017), `transpose` (function, L255), `uint_array` (function, L4770), `upper_snake` (function, L4774), `validate_descriptor` (function, L1865), `zig_zag` (function, L241)
