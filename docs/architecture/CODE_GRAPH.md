...
Source digest: `54f5a146e0643ffe77dd7000b3c1b9c430e161f1c279dc65f12f3523c88c50f9`

Scope: 95 files, 1483 symbols, 1136 functions/methods, 87 GPU kernels, 22 event links.
...
- `PrismFilmSpawner.FilmsMutated` → `OnFilmsMutated` ([Runtime/Prism/Geometry/PrismMeshletBuilder.cs:100](../../Runtime/Prism/Geometry/PrismMeshletBuilder.cs#L100))
...
`ContactDisplacementPool` (class, L117), `ContactTopologyEvidenceGpu` (struct, L59), `DisplacementCellGpu` (struct, L39), `DisplacementPageFlags` (enum, L9), `DisplacementPageHeaderGpu` (struct, L19), `Dispose` (method, L166), `FilmMergeHashEntryGpu` (struct, L100), `TopologyMergeRecordGpu` (struct, L85), `TopologySplitRecordGpu` (struct, L74)

### `Runtime/Prism/Geometry/ContactFilmPool.cs`

`ContactFilmFlags` (enum, L9), `ContactFilmHeaderGpu` (struct, L24), `ContactFilmPool` (class, L62), `Dispose` (method, L86)

### `Runtime/Prism/Geometry/ContactMeshletBuffers.cs`

`Allocate` (method, L278), `ContactMeshletBuffers` (class, L206), `ContactMeshletDescriptorGpu` (struct, L29), `ContactMeshletGenerationBuffers` (class, L66), `ContactMeshletVertexGpu` (struct, L9), `ContactMeshletViewBuffers` (class, L160), `ContactMeshletViewLodGpu` (struct, L51), `CreateViewBuffers` (method, L253), `Dispose` (method, L135), `Dispose` (method, L188), `Dispose` (method, L272), `DisposeGenerations` (method, L292), `EnsureCapacity` (method, L232), `MarkPublishedRead` (method, L269), `MarkRead` (method, L129), `Publish` (method, L259), `SetChunkTransform` (method, L256), `TryBeginBuild` (method, L247)
...
`AllocateTransientBuffers` (method, L367), `BindPersistent` (method, L415), `BindTopology` (method, L474), `CeilDiv` (method, L633), `ConfigureFrame` (method, L335), `DispatchDisplacement` (method, L279), `DisposeTransientBuffers` (method, L592), `NextPowerOfTwo` (method, L636), `OnBoundariesUpdated` (method, L276), `OnDestroy` (method, L268), `PoseMatrix` (method, L630), `PrismDisplacementTopology` (class, L15), `RunTopologyAdaptation` (method, L555), `SetChunkFrame` (method, L177), `StartUpdating` (method, L180), `StopUpdating` (method, L260)
...
`Bind` (method, L165), `BuildCurrent` (method, L130), `LateUpdate` (method, L118), `OnDestroy` (method, L113), `OnFilmsMutated` (method, L124), `PrismMeshletBuilder` (class, L15), `StartBuilding` (method, L67), `StopBuilding` (method, L105), `TryBuild` (method, L136)
...
`BoundaryCubic` (gpu_function, L137), `BoundaryDistance` (gpu_function, L146), `BoundaryHashEntry` (struct, L47), `BoundaryHashKey` (gpu_function, L126), `BuildClassDispatchArguments` (gpu_function, L361), `ClassifyConeEvents` (gpu_function, L222), `ClearClassCounters` (gpu_function, L212), `ConeEvent` (struct, L59), `ContactBoundaryHeader` (struct, L25), `HasCanonicalBoundary` (gpu_function, L164), `LoadRay` (gpu_function, L108), `LoadRayDx` (gpu_function, L114), `LoadRayDy` (gpu_function, L120), `PublishEvent` (gpu_function, L202), `BuildClassDispatchArguments` (gpu_kernel, L3), `ClassifyConeEvents` (gpu_kernel, L2), `ClearClassCounters` (gpu_kernel, L1)
...
`AccumulateBoundaryAbsence` (gpu_function, L666), `AccumulateBoundaryEvents` (gpu_function, L563), `AtomicAddScaled` (gpu_function, L254), `BoundaryHashEntry` (struct, L84), `BuildBoundarySolveArguments` (gpu_function, L703), `ClearBoundaryFrame` (gpu_function, L555), `ClearLoadedBoundaryHash` (gpu_function, L516), `ConeEvent` (struct, L9), `ContactBoundaryHeader` (struct, L62), `ContactFilmHeader` (struct, L32), `Cubic` (gpu_function, L229), `DistanceToCurve` (gpu_function, L236), `FindAdjacentFilm` (gpu_function, L470), `FindBoundary` (gpu_function, L275), `HashKey` (gpu_function, L146), `Height` (gpu_function, L193), `InitializeBoundaryState` (gpu_function, L494), `LoadDepthRay` (gpu_function, L157), `LoadRgb` (gpu_function, L163), `Luminance` (gpu_function, L170), `MarkDirty` (gpu_function, L262), `PointToUv` (gpu_function, L221), `RefineUvWithRgb` (gpu_function, L395), `RehashLoadedBoundaries` (gpu_function, L522), `ResolveBoundary` (gpu_function, L297), `SobelMagnitude` (gpu_function, L175), `SolveDirtyBoundaries` (gpu_function, L710), `SurfaceNormal` (gpu_function, L208), `SurfacePoint` (gpu_function, L200), `ViewBin` (gpu_function, L384), `AccumulateBoundaryAbsence` (gpu_kernel, L6), `AccumulateBoundaryEvents` (gpu_kernel, L5), `BuildBoundarySolveArguments` (gpu_kernel, L7), `ClearBoundaryFrame` (gpu_kernel, L4), `ClearLoadedBoundaryHash` (gpu_kernel, L2), `InitializeBoundaryState` (gpu_kernel, L1), `RehashLoadedBoundaries` (gpu_kernel, L3), `SolveDirtyBoundaries` (gpu_kernel, L8)

### `Runtime/Resources/Prism/ContactFilmPreview.shader`

`ContactMeshletVertex` (struct, L28), `Frag` (gpu_function, L64), `Varyings` (struct, L42), `Vert` (gpu_function, L50)

### `Runtime/Resources/Prism/ContactFilmSpawn.compute`

`BuildSpawnTileDispatchArguments` (gpu_function, L211), `ClearSpawnTileState` (gpu_function, L163), `CompactSpawnTiles` (gpu_function, L176), `Compatible` (gpu_function, L135), `ConeEvent` (struct, L8), `ContactFilmHeader` (struct, L31), `IsSpawnCandidate` (gpu_function, L115), `LoadRay` (gpu_function, L98), `SafeNormalize` (gpu_function, L104), `SolveSymmetric3x3` (gpu_function, L146), `SpawnContactFilms` (gpu_function, L218), `BuildSpawnTileDispatchArguments` (gpu_kernel, L3), `ClearSpawnTileState` (gpu_kernel, L1), `CompactSpawnTiles` (gpu_kernel, L2), `SpawnContactFilms` (gpu_kernel, L4)

### `Runtime/Resources/Prism/ContactFilmUpdate.compute`

`AccumulateBehindEvidence` (gpu_function, L369), `AccumulateMatchedFilms` (gpu_function, L224), `AccumulatePhotometricPressure` (gpu_function, L449), `AtomicAddScaled` (gpu_function, L193), `BuildFilmSolveArguments` (gpu_function, L524), `CholeskySolve` (gpu_function, L531), `ClearFilmUpdateFrame` (gpu_function, L217), `ConeEvent` (struct, L11), `ContactFilmHeader` (struct, L34), `FreeSpaceViewBit` (gpu_function, L118), `InformationG` (gpu_function, L164), `InformationH` (gpu_function, L141), `InitializeFilmUpdateState` (gpu_function, L200), `LoadRay` (gpu_function, L112), `PhotometricPressure` (struct, L64), `SetInformationG` (gpu_function, L175), `SetInformationH` (gpu_function, L152), `SolveDirtyFilms` (gpu_function, L574), `UpperIndex` (gpu_function, L135), `if` (gpu_function, L715), `AccumulateBehindEvidence` (gpu_kernel, L4), `AccumulateMatchedFilms` (gpu_kernel, L3), `AccumulatePhotometricPressure` (gpu_kernel, L5), `BuildFilmSolveArguments` (gpu_kernel, L6), `ClearFilmUpdateFrame` (gpu_kernel, L2), `InitializeFilmUpdateState` (gpu_kernel, L1), `SolveDirtyFilms` (gpu_kernel, L7)
...
`AccumulateDisplacement` (gpu_function, L579), `AccumulateFreeSpaceCoverage` (gpu_function, L682), `AccumulateOccluderFreeSpaceCoverage` (gpu_function, L721), `AllocateBasePages` (gpu_function, L373), `AllocateBasePagesBehind` (gpu_function, L422), `AllocateBasePagesOccluder` (gpu_function, L472), `AllocateMicrotiles` (gpu_function, L883), `AtomicAddScaled` (gpu_function, L199), `BootstrapSupport` (gpu_function, L217), `BuildDisplacementArguments` (gpu_function, L521), `CellForPage` (gpu_function, L262), `ClearDisplacementFrame` (gpu_function, L360), `ConeEvent` (struct, L15), `ContactFilmHeader` (struct, L38), `ContactTopologyEvidence` (struct, L99), `DisplacementCell` (struct, L85), `DisplacementPageHeader` (struct, L68), `EmptyCell` (gpu_function, L207), `FreeSpaceViewBit` (gpu_function, L179), `Height` (gpu_function, L192), `InitializeBasePages` (gpu_function, L538), `InitializeDisplacementState` (gpu_function, L342), `InitializeMicroPages` (gpu_function, L973), `IsMicroCell` (gpu_function, L215), `LoadCell` (gpu_function, L225), `LoadChild` (gpu_function, L242), `LoadRay` (gpu_function, L173), `MarkCellDirty` (gpu_function, L316), `MarkTopologyDirty` (gpu_function, L331), `PageHeaderIndex` (gpu_function, L257), `ResolveBaseCell` (gpu_function, L269), `ResolveLeaf` (gpu_function, L288), `SolveDirtyDisplacement` (gpu_function, L759), `SolveTopologyEvidence` (gpu_function, L1015), `StoreCell` (gpu_function, L234), `StoreChild` (gpu_function, L249), `if` (gpu_function, L824), `AccumulateDisplacement` (gpu_kernel, L8), `AccumulateFreeSpaceCoverage` (gpu_kernel, L9), `AccumulateOccluderFreeSpaceCoverage` (gpu_kernel, L10), `AllocateBasePages` (gpu_kernel, L3), `AllocateBasePagesBehind` (gpu_kernel, L4), `AllocateBasePagesOccluder` (gpu_kernel, L5), `AllocateMicrotiles` (gpu_kernel, L12), `BuildDisplacementArguments` (gpu_kernel, L6), `ClearDisplacementFrame` (gpu_kernel, L1), `InitializeBasePages` (gpu_kernel, L7), `InitializeDisplacementState` (gpu_kernel, L2), `InitializeMicroPages` (gpu_kernel, L13), `SolveDirtyDisplacement` (gpu_kernel, L11), `SolveTopologyEvidence` (gpu_kernel, L14)
...
`BootstrapCoverage` (gpu_function, L328), `BootstrapCoverageCell` (gpu_function, L318), `BoundaryCubic` (gpu_function, L409), `BoundaryHashEntry` (struct, L91), `BoundaryHashKey` (gpu_function, L398), `BuildAdaptiveFilmMeshlets` (gpu_function, L605), `BuildMeshDispatchArguments` (gpu_function, L584), `CellTouchesPersistentBoundary` (gpu_function, L469), `ChooseSubdivision` (gpu_function, L536), `ClearMeshletBuild` (gpu_function, L568), `ClosestBoundaryPoint` (gpu_function, L418), `ContactBoundaryHeader` (struct, L69), `ContactFilmHeader` (struct, L5), `ContactMeshletDescriptor` (struct, L50), `ContactMeshletVertex` (struct, L35), `DisplacementCell` (struct, L117), `DisplacementMetrics` (gpu_function, L238), `DisplacementPageHeader` (struct, L100), `FinalizeMeshletDrawArguments` (gpu_function, L809), `Height` (gpu_function, L483), `LoadDisplacementCell` (gpu_function, L175), `LoadDisplacementChild` (gpu_function, L187), `Reserve` (gpu_function, L516), `ResolveDisplacementPage` (gpu_function, L197), `SampleDisplacement` (gpu_function, L290), `SurfaceCoverage` (gpu_function, L344), `SurfaceNormal` (gpu_function, L491), `TriangleHasObservedSupport` (gpu_function, L389), `if` (gpu_function, L681), `if` (gpu_function, L686), `BuildAdaptiveFilmMeshlets` (gpu_kernel, L3), `BuildMeshDispatchArguments` (gpu_kernel, L2), `ClearMeshletBuild` (gpu_kernel, L1), `FinalizeMeshletDrawArguments` (gpu_kernel, L4)
...
`AddTransformedInformation` (gpu_function, L990), `BootstrapCoverage` (gpu_function, L205), `BoundaryDerivative3` (gpu_function, L637), `BoundaryHashEntry` (struct, L63), `BoundaryHashKey` (gpu_function, L379), `BoundaryPoint3` (gpu_function, L630), `BoundaryUv` (gpu_function, L610), `BoundaryUvDerivative` (gpu_function, L619), `BuildFilmMergeHash` (gpu_function, L860), `BuildMergeArguments` (gpu_function, L1276), `BuildTopologyAdaptArguments` (gpu_function, L531), `CellForPage` (gpu_function, L236), `ChildBasisTransform` (gpu_function, L299), `ClearFilmMergeHash` (gpu_function, L845), `ClearTopologyAdaptFrame` (gpu_function, L388), `ClearTopologyBoundaryHash` (gpu_function, L792), `ContactBoundaryHeader` (struct, L54), `ContactFilmHeader` (struct, L14), `ContactTopologyEvidence` (struct, L46), `DisplacementCell` (struct, L38), `DisplacementPageHeader` (struct, L29), `FilmCell` (gpu_function, L840), `FilmCellHash` (gpu_function, L831), `FilmMergeHashEntry` (struct, L83), `GeneralBasisTransform` (gpu_function, L961), `Height` (gpu_function, L198), `IncludeFilmBounds` (gpu_function, L944), `InitializeMergedDisplacement` (gpu_function, L1324), `InitializeSplitDisplacement` (gpu_function, L553), `IsMicroCell` (gpu_function, L215), `LoadCell` (gpu_function, L217), `LoadChild` (gpu_function, L224), `LoadG` (gpu_function, L172), `LoadH` (gpu_function, L161), `LockFilm` (gpu_function, L933), `MergeCompatible` (gpu_function, L891), `MergeCompatibleFilms` (gpu_function, L1082), `PageHeaderIndex` (gpu_function, L231), `QuadrantSupport` (gpu_function, L277), `RehashTopologyBoundaries` (gpu_function, L798), `ResetFilmMergeWave` (gpu_function, L852), `ResolveLeaf` (gpu_function, L242), `SolveSix` (gpu_function, L1041), `SourceDisplacement` (gpu_function, L1284), `SplitContactFilms` (gpu_function, L396), `StoreInformation` (gpu_function, L183), `TopologyMergeRecord` (struct, L76), `TopologySplitRecord` (struct, L68), `TransferSplitBoundaries` (gpu_function, L730), `TransformChildInformation` (gpu_function, L315), `TransformUvToChild` (gpu_function, L603), `UpperIndex` (gpu_function, L156), `UvQuadrant` (gpu_function, L645), `WriteSplitBoundary` (gpu_function, L650), `if` (gpu_function, L1302), `BuildFilmMergeHash` (gpu_kernel, L10), `BuildMergeArguments` (gpu_kernel, L12), `BuildTopologyAdaptArguments` (gpu_kernel, L3), `ClearFilmMergeHash` (gpu_kernel, L9), `ClearTopologyAdaptFrame` (gpu_kernel, L1), `ClearTopologyBoundaryHash` (gpu_kernel, L6), `InitializeMergedDisplacement` (gpu_kernel, L13), `InitializeSplitDisplacement` (gpu_kernel, L4), `MergeCompatibleFilms` (gpu_kernel, L11), `RehashTopologyBoundaries` (gpu_kernel, L7), `ResetFilmMergeWave` (gpu_kernel, L8), `SplitContactFilms` (gpu_kernel, L2), `TransferSplitBoundaries` (gpu_kernel, L5)
