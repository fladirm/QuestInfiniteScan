...
Source digest: `6c45b08b9884bf43025d2d74bbbf59b77974d749c63f1d05acea885f7d199e2d`
...
`ClearIngressWork` (gpu_function, L265), `CompactIngressBundles` (gpu_function, L280), `FinalizeExtractedBundles` (gpu_function, L504), `FinalizeStreamingScheduleDiagnostics` (gpu_function, L1149), `InitializeStreamingGraph` (gpu_function, L210), `InitializeStreamingOwnership` (gpu_function, L246), `PrepareTransactionPages` (gpu_function, L1214), `ReleaseProbationAssociations` (gpu_function, L1190), `ScheduleSigmaTransactions` (gpu_function, L793), `SigmaAppendSourceHandle` (gpu_function, L577), `SigmaBundleAffectedMask` (gpu_function, L117), `SigmaBundleHasOwnedRawRange` (gpu_function, L160), `SigmaBundleKeysIndependent` (gpu_function, L535), `SigmaBundleRecordsOverlap` (gpu_function, L136), `SigmaBundleSealsAlone` (gpu_function, L526), `SigmaBundleTransactionOverlap` (gpu_function, L146), `SigmaClaimSourceSegment` (gpu_function, L542), `SigmaCompactMorton` (gpu_function, L67), `SigmaFindProbation` (gpu_function, L658), `SigmaGaugeMask64` (gpu_function, L95), `SigmaHasEarlierUnsealedOverlap` (gpu_function, L737), `SigmaOpenProbation` (gpu_function, L704), `SigmaProbationFirstHandle` (gpu_function, L641), `SigmaSameLogicalPage` (gpu_function, L131), `SigmaSealSourceStream` (gpu_function, L611), `SigmaSignedMortonLimb` (gpu_function, L78), `SigmaStreamAddTicket` (gpu_function, L86), `SigmaStreamDependencySatisfied` (gpu_function, L174), `SigmaStreamPageSlotFree` (gpu_function, L167), `SigmaStreamResetDispatch` (gpu_function, L202), `SigmaTransactionOpcode` (gpu_function, L766), `SigmaTransactionSemanticMask` (gpu_function, L124), `if` (gpu_function, L895), `ClearIngressWork` (gpu_kernel, L3), `CompactIngressBundles` (gpu_kernel, L4), `FinalizeExtractedBundles` (gpu_kernel, L5), `FinalizeStreamingScheduleDiagnostics` (gpu_kernel, L7), `InitializeStreamingGraph` (gpu_kernel, L1), `InitializeStreamingOwnership` (gpu_kernel, L2), `PrepareTransactionPages` (gpu_kernel, L9), `ReleaseProbationAssociations` (gpu_kernel, L8), `ScheduleSigmaTransactions` (gpu_kernel, L6)
...
`CoalesceProofWindow` (gpu_function, L922), `CompleteProofBlock` (gpu_function, L1605), `EmitProofCertificates` (gpu_function, L1454), `EvaluateProofRedundancyWindow` (gpu_function, L1271), `MergeProofRuns` (gpu_function, L830), `PrepareProofOrder` (gpu_function, L772), `PrepareProofRedundancy` (gpu_function, L1030), `ReduceTransactionSourceBlock` (gpu_function, L479), `RetainProofRawWindow` (gpu_function, L1536), `SigmaProofAdvanceSourceCursor` (gpu_function, L201), `SigmaProofAtomicAddDegree` (gpu_function, L156), `SigmaProofCandidateBound` (gpu_function, L100), `SigmaProofCandidateBoundAddress` (gpu_function, L90), `SigmaProofCandidateBoundRead` (gpu_function, L106), `SigmaProofCandidateLess` (gpu_function, L620), `SigmaProofDegree` (gpu_function, L132), `SigmaProofFailTransaction` (gpu_function, L1000), `SigmaProofFinishRedundancyRank` (gpu_function, L1009), `SigmaProofFullBounds` (gpu_function, L82), `SigmaProofIndependentEdge` (gpu_function, L708), `SigmaProofKept` (gpu_function, L686), `SigmaProofKeptRead` (gpu_function, L692), `SigmaProofLoadCurrentSource` (gpu_function, L179), `SigmaProofLoadPrior` (gpu_function, L302), `SigmaProofLoadReadWork` (gpu_function, L746), `SigmaProofLoadWork` (gpu_function, L720), `SigmaProofMergeCandidate` (gpu_function, L881), `SigmaProofPrefixBound` (gpu_function, L119), `SigmaProofPrefixBoundAddress` (gpu_function, L95), `SigmaProofReduceSource` (gpu_function, L341), `SigmaProofResetSweepScratch` (gpu_function, L973), `SigmaProofSameKey` (gpu_function, L657), `SigmaProofSetCandidateBound` (gpu_function, L112), `SigmaProofSetKept` (gpu_function, L698), `SigmaProofSetPrefixBound` (gpu_function, L125), `SigmaProofSetSampleBit` (gpu_function, L231), `SigmaProofSetSortedIndex` (gpu_function, L678), `SigmaProofSortedIndex` (gpu_function, L666), `SigmaProofSortedIndexRead` (gpu_function, L672), `SigmaProofSourceCell` (gpu_function, L239), `SigmaProofSourceSlot` (gpu_function, L288), `if` (gpu_function, L1246), `CoalesceProofWindow` (gpu_kernel, L4), `CompleteProofBlock` (gpu_kernel, L9), `EmitProofCertificates` (gpu_kernel, L7), `EvaluateProofRedundancyWindow` (gpu_kernel, L6), `MergeProofRuns` (gpu_kernel, L3), `PrepareProofOrder` (gpu_kernel, L2), `PrepareProofRedundancy` (gpu_kernel, L5), `ReduceTransactionSourceBlock` (gpu_kernel, L1), `RetainProofRawWindow` (gpu_kernel, L8)

### `Runtime/Resources/SigmaPrism/SigmaStreamPublication.compute`

`InitializeManifestVisibility` (gpu_function, L39), `PreparePublicationManifest` (gpu_function, L114), `PublishPublicationManifest` (gpu_function, L190), `ResolvePublishedPageCaches` (gpu_function, L215), `RetirePublishedTransaction` (gpu_function, L273), `SigmaPublicationPage` (gpu_function, L89), `SigmaPublicationPageCount` (gpu_function, L101), `SigmaPublicationReleaseAssociation` (gpu_function, L260), `SigmaPublicationRetainsRaw` (gpu_function, L248), `SigmaPublicationWork` (gpu_function, L70), `InitializeManifestVisibility` (gpu_kernel, L5), `PreparePublicationManifest` (gpu_kernel, L1), `PublishPublicationManifest` (gpu_kernel, L2), `ResolvePublishedPageCaches` (gpu_kernel, L3), `RetirePublishedTransaction` (gpu_kernel, L4)
