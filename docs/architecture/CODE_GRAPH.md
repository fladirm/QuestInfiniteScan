...
Source digest: `aba5f7c001f6cd6537b240a69baca12bcaff7479340c82cf952b16859a52bbac`

Scope: 132 files, 2096 symbols, 1683 functions/methods, 112 GPU kernels, 6 event links.
...
- `RenderPipelineManager.endCameraRendering` → `OnEndCameraRendering` ([Runtime/SigmaPrism/SigmaRenderer.cs:302](../../Runtime/SigmaPrism/SigmaRenderer.cs#L302))
...
`SigmaInverseWorkGpu` (struct, L14), `SigmaInverseWorkImageX` (gpu_function, L20), `SigmaInverseWorkImageY` (gpu_function, L25), `SigmaStreamBundleGeneration` (gpu_function, L101), `SigmaStreamBundleState` (gpu_function, L106), `SigmaStreamDispatchAddress` (gpu_function, L85), `SigmaStreamFirstIncompleteBlock` (gpu_function, L204), `SigmaStreamFirstSetBit` (gpu_function, L198), `SigmaStreamHandleValid` (gpu_function, L136), `SigmaStreamMaskIntersects` (gpu_function, L191), `SigmaStreamRawTileAddress` (gpu_function, L96), `SigmaStreamRawWordAddress` (gpu_function, L90), `SigmaStreamSetCompletedBlock` (gpu_function, L225), `SigmaStreamSetSourceHandle` (gpu_function, L150), `SigmaStreamSourceHandle` (gpu_function, L141), `SigmaStreamSourceSegmentValid` (gpu_function, L183), `SigmaStreamTicket` (gpu_function, L121), `SigmaStreamTicketEqual` (gpu_function, L131), `SigmaStreamTicketLess` (gpu_function, L126), `SigmaStreamTransactionGeneration` (gpu_function, L116), `SigmaStreamTransactionState` (gpu_function, L111), `SigmaStreamWorkAddress` (gpu_function, L80), `if` (gpu_function, L161), `if` (gpu_function, L168)

### `Runtime/Resources/SigmaPrism/SigmaInverseWorkGraph.compute`

`ClearIngressWork` (gpu_function, L264), `CompactIngressBundles` (gpu_function, L277), `FinalizeExtractedBundles` (gpu_function, L491), `FinalizeStreamingScheduleDiagnostics` (gpu_function, L1126), `InitializeStreamingGraph` (gpu_function, L211), `InitializeStreamingOwnership` (gpu_function, L245), `PrepareTransactionPages` (gpu_function, L1187), `ReleaseProbationAssociations` (gpu_function, L1163), `ScheduleSigmaTransactions` (gpu_function, L783), `SigmaAppendSourceHandle` (gpu_function, L565), `SigmaBundleAffectedMask` (gpu_function, L117), `SigmaBundleHasOwnedRawRange` (gpu_function, L161), `SigmaBundleKeysIndependent` (gpu_function, L523), `SigmaBundleRecordsOverlap` (gpu_function, L136), `SigmaBundleSealsAlone` (gpu_function, L514), `SigmaBundleTransactionOverlap` (gpu_function, L147), `SigmaClaimSourceSegment` (gpu_function, L530), `SigmaCompactMorton` (gpu_function, L67), `SigmaFindProbation` (gpu_function, L646), `SigmaGaugeMask64` (gpu_function, L95), `SigmaHasEarlierUnsealedOverlap` (gpu_function, L725), `SigmaOpenProbation` (gpu_function, L692), `SigmaProbationFirstHandle` (gpu_function, L629), `SigmaSameLogicalPage` (gpu_function, L131), `SigmaSealSourceStream` (gpu_function, L599), `SigmaSignedMortonLimb` (gpu_function, L78), `SigmaStreamAddTicket` (gpu_function, L86), `SigmaStreamDependencySatisfied` (gpu_function, L175), `SigmaStreamPageSlotFree` (gpu_function, L168), `SigmaStreamResetDispatch` (gpu_function, L203), `SigmaTransactionOpcode` (gpu_function, L754), `SigmaTransactionSemanticMask` (gpu_function, L124), `if` (gpu_function, L878), `ClearIngressWork` (gpu_kernel, L3), `CompactIngressBundles` (gpu_kernel, L4), `FinalizeExtractedBundles` (gpu_kernel, L5), `FinalizeStreamingScheduleDiagnostics` (gpu_kernel, L7), `InitializeStreamingGraph` (gpu_kernel, L1), `InitializeStreamingOwnership` (gpu_kernel, L2), `PrepareTransactionPages` (gpu_kernel, L9), `ReleaseProbationAssociations` (gpu_kernel, L8), `ScheduleSigmaTransactions` (gpu_kernel, L6)
...
`EvaluateTransactionMicrotile` (gpu_function, L1095), `EvaluateTransactionRgbLeft` (gpu_function, L870), `EvaluateTransactionRgbRight` (gpu_function, L877), `MeetTransactionMicrotile` (gpu_function, L884), `PrepareTransactionMicrotile` (gpu_function, L738), `SigmaEvalAccumulateKey` (gpu_function, L492), `SigmaEvalAdvanceTransaction` (gpu_function, L718), `SigmaEvalBuildBootstrap` (gpu_function, L352), `SigmaEvalBuildProjective` (gpu_function, L403), `SigmaEvalButterflyStage` (gpu_function, L264), `SigmaEvalFullBounds` (gpu_function, L344), `SigmaEvalHadamard` (gpu_function, L289), `SigmaEvalLoadPreparedProjective` (gpu_function, L701), `SigmaEvalMeet` (gpu_function, L502), `SigmaEvalPrepareGroup` (gpu_function, L149), `SigmaEvalReduceValidity` (gpu_function, L328), `SigmaEvalRgbEye` (gpu_function, L524), `SigmaEvalSample` (gpu_function, L121), `SigmaEvaluateTransactionRgb` (gpu_function, L813), `SigmaStreamAssociationContact` (gpu_function, L228), `SigmaStreamAssociationEye` (gpu_function, L207), `SigmaStreamAssociationMatchesTarget` (gpu_function, L242), `SigmaStreamAssociationSame` (gpu_function, L234), `SigmaStreamCombineOutcome` (gpu_function, L250), `SigmaStreamEvalAddress` (gpu_function, L110), `SigmaStreamJointAddress` (gpu_function, L103), `SigmaStreamLoadCurrentBundle` (gpu_function, L128), `SigmaStreamNullLane` (gpu_function, L92), `SigmaStreamSampleAddress` (gpu_function, L116), `if` (gpu_function, L1044), `EvaluateTransactionMicrotile` (gpu_kernel, L5), `EvaluateTransactionRgbLeft` (gpu_kernel, L2), `EvaluateTransactionRgbRight` (gpu_kernel, L3), `MeetTransactionMicrotile` (gpu_kernel, L4), `PrepareTransactionMicrotile` (gpu_kernel, L1)
...
`InitializeManifestVisibility` (gpu_function, L45), `PreparePublicationManifest` (gpu_function, L125), `PublishPublicationManifest` (gpu_function, L222), `ResolvePublishedPageCaches` (gpu_function, L246), `RetirePublishedTransaction` (gpu_function, L309), `SigmaPublicationPage` (gpu_function, L96), `SigmaPublicationPageCount` (gpu_function, L108), `SigmaPublicationReleaseAssociation` (gpu_function, L292), `SigmaPublicationRetainsRaw` (gpu_function, L280), `SigmaPublicationWork` (gpu_function, L77), `InitializeManifestVisibility` (gpu_kernel, L5), `PreparePublicationManifest` (gpu_kernel, L1), `PublishPublicationManifest` (gpu_kernel, L2), `ResolvePublishedPageCaches` (gpu_kernel, L3), `RetirePublishedTransaction` (gpu_kernel, L4)

### `Runtime/Resources/SigmaPrism/SigmaStreamRevalidation.compute`

`BuildHistoricalDrawArguments` (gpu_function, L526), `CancelHistoricalRevalidation` (gpu_function, L729), `FinalizeHistoricalRevalidation` (gpu_function, L675), `PrepareHistoricalRevalidation` (gpu_function, L297), `RebuildHistoricalAssociation` (gpu_function, L597), `SigmaRevalidationBundleCurrent` (gpu_function, L183), `SigmaRevalidationCaptureEye` (gpu_function, L564), `SigmaRevalidationClaimAssociation` (gpu_function, L260), `SigmaRevalidationClearContext` (gpu_function, L62), `SigmaRevalidationCurrentBundle` (gpu_function, L158), `SigmaRevalidationFindVisiblePage` (gpu_function, L117), `SigmaRevalidationLoadTransaction` (gpu_function, L140), `SigmaRevalidationPageVisible` (gpu_function, L92), `SigmaRevalidationPinMarker` (gpu_function, L70), `SigmaRevalidationPrepareFinalize` (gpu_function, L635), `SigmaRevalidationReclaimAssociation` (gpu_function, L207), `SigmaRevalidationReleaseSnapshotPin` (gpu_function, L75), `SigmaRevalidationSameCoordinate` (gpu_function, L108), `if` (gpu_function, L328), `if` (gpu_function, L364), `if` (gpu_function, L511), `if` (gpu_function, L519), `BuildHistoricalDrawArguments` (gpu_kernel, L2), `CancelHistoricalRevalidation` (gpu_kernel, L5), `FinalizeHistoricalRevalidation` (gpu_kernel, L4), `PrepareHistoricalRevalidation` (gpu_kernel, L1), `RebuildHistoricalAssociation` (gpu_kernel, L3)
...
`SigmaAssociationSampleGpu` (struct, L171), `SigmaPageVisibilityGpu` (struct, L189), `SigmaProbationGpu` (struct, L126), `SigmaProofCandidateGpu` (struct, L156), `SigmaProofClosureGpu` (struct, L144), `SigmaProofPrefixGpu` (struct, L164), `SigmaPublicationManifestGpu` (struct, L181), `SigmaSealedSourceBundleGpu` (struct, L115), `SigmaSourceHandleSegmentGpu` (struct, L134), `SigmaStreamDiagnosticGpu` (struct, L201), `SigmaStreamPageReferenceGpu` (struct, L87), `SigmaStreamWorkItemGpu` (struct, L195), `SigmaTransactionGpu` (struct, L93)
...
`SigmaAssociationSampleGpu` (struct, L136), `SigmaGeneratedStreaming` (class, L181), `SigmaPageVisibilityGpu` (struct, L156), `SigmaProbationGpu` (struct, L86), `SigmaProofCandidateGpu` (struct, L119), `SigmaProofClosureGpu` (struct, L106), `SigmaProofPrefixGpu` (struct, L128), `SigmaPublicationManifestGpu` (struct, L147), `SigmaSealedSourceBundleGpu` (struct, L74), `SigmaSourceHandleSegmentGpu` (struct, L95), `SigmaStreamBudgetClass` (enum, L24), `SigmaStreamDiagnosticGpu` (struct, L170), `SigmaStreamOpcode` (enum, L8), `SigmaStreamPageReferenceGpu` (struct, L44), `SigmaStreamUInt4Gpu` (struct, L35), `SigmaStreamWorkItemGpu` (struct, L163), `SigmaTransactionGpu` (struct, L51)
...
`AbsNanoseconds` (method, L947), `AdvanceAge` (method, L1116), `AdvanceAge` (method, L1187), `Begin` (method, L1167), `BuildTrackingPriorEnvelope` (method, L685), `CeilDiv` (method, L982), `Complete` (method, L1225), `CountPendingTickets` (method, L895), `CreateArrayTexture` (method, L996), `CreateBuffer` (method, L992), `CreatePersistentResources` (method, L783), `DestroyTexture` (method, L1026), `Dispose` (method, L1237), `EnsureCalibration` (method, L755), `EnsureFrameResources` (method, L1188), `EnsurePosePartials` (method, L1213), `FillCalibration` (method, L830), `FillRgbCalibration` (method, L866), `FindKernels` (method, L768), `FromRaw` (method, L1102), `GpuResident` (method, L1288), `IndependenceKey` (method, L957), `IngressSlot` (class, L1120), `IntrinsicsVector` (method, L954), `LatchCompletionFault` (method, L465), `LateUpdate` (method, L190), `MaxRigRotationResidual` (method, L742), `MaxRigTranslationResidual` (method, L729), `Mix` (method, L977), `NextPowerOfTwo` (method, L985), `NextRevision` (method, L930), `OnDestroy` (method, L1037), `OnModuleInitialize` (method, L106), `OnPredictionReady` (method, L182), `OnScanStarted` (method, L160), `OnScanStopped` (method, L173), `Poll` (method, L1117), `Poll` (method, L1184), `PollCanonical` (method, L427), `PollDerived` (method, L446), `PollIngress` (method, L399), `PollInitialization` (method, L378), `PoseMatrix` (method, L952), `RecordClassification` (method, L501), `RecordCorrectedCalibration` (method, L625), `RecordGraphInitialization` (method, L224), `RecordNormalize` (method, L476), `RecordPoseGauge` (method, L571), `ReleasePendingIngress` (method, L911), `SaturatingAdd` (method, L950), `SetQ` (method, L938), `SetQRaw` (method, L941), `SetRgbQ` (method, L943), `SetRgbQRaw` (method, L945), `SigmaInverseController` (class, L22), `SigmaInverseDiagnosticSnapshot` (struct, L1264), `SigmaPackedQ48` (struct, L1093), `Submission` (class, L1105), `SubmitCanonicalAndDerived` (method, L329), `SubmitIngress` (method, L244), `TrackLast` (method, L917), `TryGetFreeIngressSlot` (method, L882), `UpdatePeak` (method, L923), `UploadExactCalibration` (method, L652), `UploadPosePrior` (method, L665)
...
`BindBuild` (method, L787), `BindCancelHistoricalRevalidation` (method, L647), `BindCompaction` (method, L812), `BindFinalizeHistoricalRevalidation` (method, L621), `BindHaloResolve` (method, L837), `BindHistoricalDrawArguments` (method, L564), `BindPrepareHistoricalRevalidation` (method, L525), `BindRebuildHistoricalAssociation` (method, L578), `BindStreamingManifest` (method, L181), `BuildClipFromWorld` (method, L923), `CreateColor` (method, L1164), `DestroyMaterial` (method, L1092), `DestroyTexture` (method, L1190), `Dispose` (method, L1155), `Dispose` (method, L1270), `DrawSegments` (method, L856), `EnsureHistoricalRevalidationPageSnapshot` (method, L663), `EnsureHistoricalRevalidationTargets` (method, L410), `EnsureSegmentCaches` (method, L891), `HistoricalRevalidationTargets` (class, L1102), `LateUpdate` (method, L318), `Matches` (method, L1264), `OnDestroy` (method, L1010), `OnEndCameraRendering` (method, L951), `OnModuleInitialize` (method, L218), `OnScanStarted` (method, L305), `OnScanStopped` (method, L311), `PrepareReadoutCaches` (method, L762), `RecordDirectPreview` (method, L978), `RecordHistoricalRevalidation` (method, L438), `RenderPrediction` (method, L686), `SegmentReadoutCache` (class, L1202), `SetMrt` (method, L1147), `SetMrt` (method, L915), `SetRevalidationBuffer` (method, L679), `SigmaRenderer` (class, L19), `TryAcquireLatest` (method, L207), `TryGetStreamingReadout` (method, L504), `TryRecordPoseGaugePrediction` (method, L364), `TryRender` (method, L337), `TryRenderPoseGauge` (method, L346), `UnbindStreamingManifest` (method, L197)
...
`BindBundleSource` (method, L496), `BindClearIngress` (method, L374), `BindCompactIngress` (method, L383), `BindDerived` (method, L729), `BindDormant` (method, L761), `BindFinalizeBundles` (method, L424), `BindInitializeGraph` (method, L349), `BindInitializeOwnership` (method, L364), `BindInitializeVisibility` (method, L715), `BindInverse` (method, L548), `BindPreparePages` (method, L475), `BindProof` (method, L600), `BindPublication` (method, L810), `BindReleaseProbation` (method, L468), `BindSchedule` (method, L433), `BindScheduleDiagnostics` (method, L457), `BindTransition` (method, L671), `CeilDiv` (method, L930), `DispatchIndirect` (method, L853), `Intrinsics` (method, L926), `PoseMatrix` (method, L923), `RecordCanonicalQuantum` (method, L259), `RecordDerivedQuantum` (method, L338), `RecordIngress` (method, L210), `RecordInitialize` (method, L198), `RecordInverseStage` (method, L593), `RequireCommand` (method, L893), `RequireShader` (method, L885), `Set` (method, L899), `SetFrameMatrices` (method, L860), `SetInt` (method, L915), `SetTexture` (method, L907), `SetUInt` (method, L919), `SigmaStreamingGraph` (class, L12)
...
`AssertProofEqual` (method, L614), `Bind` (method, L645), `Bounds` (method, L634), `BoundsEqual` (method, L600), `BoundsGpu` (struct, L39), `BuildPartitionedProofEvidence` (method, L501), `CloseProof` (method, L553), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L137), `MeetCertificates` (method, L559), `PageMetadataGpu` (struct, L15), `ProofCertificate` (method, L541), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L307), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L333), `ReplayWindows` (method, L572), `SigmaStreamingContractTests` (class, L10), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L46), `U4` (method, L629), `UInt2Gpu` (struct, L32)
...
`SigmaAssociationSampleGpu` (struct, L724), `SigmaAssociationSampleGpu` (struct, L981), `SigmaGeneratedAlgebra` (class, L429), `SigmaGeneratedStreaming` (class, L769), `SigmaPageVisibilityGpu` (struct, L744), `SigmaPageVisibilityGpu` (struct, L999), `SigmaProbationGpu` (struct, L674), `SigmaProbationGpu` (struct, L936), `SigmaProofCandidateGpu` (struct, L707), `SigmaProofCandidateGpu` (struct, L966), `SigmaProofClosureGpu` (struct, L694), `SigmaProofClosureGpu` (struct, L954), `SigmaProofPrefixGpu` (struct, L716), `SigmaProofPrefixGpu` (struct, L974), `SigmaPublicationManifestGpu` (struct, L735), `SigmaPublicationManifestGpu` (struct, L991), `SigmaSealedSourceBundleGpu` (struct, L662), `SigmaSealedSourceBundleGpu` (struct, L925), `SigmaSourceHandleSegmentGpu` (struct, L683), `SigmaSourceHandleSegmentGpu` (struct, L944), `SigmaStreamBudgetClass` (enum, L616), `SigmaStreamDiagnosticGpu` (struct, L758), `SigmaStreamDiagnosticGpu` (struct, L1011), `SigmaStreamOpcode` (enum, L612), `SigmaStreamPageReferenceGpu` (struct, L632), `SigmaStreamPageReferenceGpu` (struct, L897), `SigmaStreamUInt4Gpu` (struct, L623), `SigmaStreamWorkItemGpu` (struct, L751), `SigmaStreamWorkItemGpu` (struct, L1005), `SigmaTransactionGpu` (struct, L639), `SigmaTransactionGpu` (struct, L903), `basis_product` (function, L51), `build_descriptor` (function, L101), `build_kernel_execution_descriptor` (function, L293), `check_or_write` (function, L1036), `chunks` (function, L400), `conjugate_sign` (function, L68), `cs_array` (function, L405), `cs_values` (function, L601), `dyads` (function, L76), `fingerprint_words` (function, L489), `hadamard_sign` (function, L72), `main` (function, L1049), `multiply_dyads` (function, L84), `render_cs` (function, L414), `render_hlsl` (function, L532), `render_hlsl_layout` (function, L493), `render_streaming_cs` (function, L593), `render_streaming_hlsl` (function, L811), `sha256` (function, L96), `uint_array` (function, L589), `validate_descriptor` (function, L267), `values` (function, L821)
