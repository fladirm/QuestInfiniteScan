...
Source digest: `79e770ea810279006aa324e41a4b3028a49af00667b7f78344c7a6f644b3a2ac`

Scope: 107 files, 1646 symbols, 1342 functions/methods, 73 GPU kernels, 5 event links.
...
- `Aggregate.TotalNanoseconds` → `nanoseconds` ([Runtime/SigmaPrism/SigmaGpuKernelTelemetry.cs:299](../../Runtime/SigmaPrism/SigmaGpuKernelTelemetry.cs#L299))
...
`Aggregate` (class, L33), `ArmNative` (method, L360), `BeginProfiledSubmission` (method, L102), `Cancel` (method, L388), `Cancel` (method, L409), `CancelNative` (method, L332), `CancelNative` (method, L362), `CancelSingleSubmission` (method, L172), `CaptureAndLogFrame` (method, L227), `CompleteProfiledSubmission` (method, L165), `ComputeLinearDispatchGrid` (method, L215), `DispatchComputeProfiled` (method, L180), `DispatchComputeProfiled` (method, L190), `EndProfiledSubmission` (method, L150), `Entry` (class, L27), `FindProfiledKernel` (method, L71), `Finish` (method, L325), `GetBeginEventIdNative` (method, L366), `GetEndEventIdNative` (method, L368), `GetRenderEventFuncNative` (method, L364), `IsAvailableNative` (method, L358), `LogResults` (method, L278), `Native` (class, L351), `Observe` (method, L254), `ReadNative` (method, L370), `RecordProfileBegin` (method, L126), `RecordProfileEnd` (method, L138), `RequestSingleSubmission` (method, L94), `Reset` (method, L58), `SetProfilingEnabledForTests` (method, L425), `SigmaGpuKernelTelemetry` (class, L14), `State` (enum, L18), `TryArm` (method, L378), `TryArm` (method, L408), `TryRead` (method, L394), `TryRead` (method, L410), `ValidateDirectDispatchDimensions` (method, L202), `Warn` (method, L342)
