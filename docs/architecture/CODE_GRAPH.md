...
Source digest: `4602208a8b1904b3e50019a9112d272dc23899816f95258782b048b17b8aa9db`

Scope: 104 files, 1536 symbols, 1259 functions/methods, 58 GPU kernels, 5 event links.
...
`AbortGaugeWrites` (method, L2145), `AbortMatchedWrites` (method, L2135), `AbortPendingWrites` (method, L2155), `AddTopologyRebuild` (method, L847), `BeginGaugePageCommits` (method, L890), `BeginGaugeReadback` (method, L2121), `BeginInverse` (method, L232), `BeginLocalGaugeRequest` (method, L2097), `BeginLocalGaugeTransaction` (method, L2107), `BeginMatchedPageCommits` (method, L692), `BeginMatchedProofReadback` (method, L2088), `BindCommonInverseInputs` (method, L1183), `BindFrameInputs` (method, L1035), `BindFrameTextures` (method, L1157), `BindPromotion` (method, L962), `BuildTopologyEvidenceMap` (method, L319), `CeilDiv` (method, L1615), `CompactMorton` (method, L1525), `CompareTo` (method, L1773), `CompleteGaugePromotions` (method, L602), `CompleteInFlight` (method, L337), `CompleteInitialReadback` (method, L373), `CompleteLocalGaugeRequest` (method, L476), `CompleteLocalGaugeTransaction` (method, L545), `CompleteMatchedProofs` (method, L409), `ContinueAfterMatched` (method, L456), `ContinueWithLatentPromotions` (method, L588), `CreateArrayTexture` (method, L1582), `CreateBuffer` (method, L1611), `DestroyTexture` (method, L1626), `DetachOwnedResources` (method, L1664), `DetermineNextRevision` (method, L1539), `Dispose` (method, L1831), `Dispose` (method, L1877), `Dispose` (method, L2163), `EnsureCalibration` (method, L1222), `EnsureFlagBuffers` (method, L1247), `EnsureFrameResources` (method, L1233), `EnsureSegmentScratch` (method, L1271), `Equals` (method, L1778), `Equals` (method, L1779), `FillCalibration` (method, L1321), `FillRgbCalibration` (method, L1305), `FindFreeGaugeOrigin` (method, L1437), `FinishFrame` (method, L672), `From` (method, L2201), `FromRaw` (method, L1712), `GaugeImagePage` (struct, L1761), `GaugeRegionIsFree` (method, L1503), `GaugeTouchesResidentTransverseNeighbour` (method, L523), `GetHashCode` (method, L1781), `GlobalPageIndex` (method, L1577), `Id` (method, L1580), `InFlightFrame` (class, L1984), `InFlightPhase` (enum, L1975), `IndependenceKey` (method, L1548), `IntrinsicsVector` (method, L1433), `InverseOwnedResources` (class, L1842), `LateUpdate` (method, L209), `Matches` (method, L1826), `Mix` (method, L1568), `NextPowerOfTwo` (method, L1618), `OnCompleted` (method, L1957), `OnDestroy` (method, L1637), `OnModuleInitialize` (method, L110), `OnPredictionReady` (method, L196), `OnScanStarted` (method, L181), `OnScanStopped` (method, L187), `PendingGaugePublication` (struct, L1716), `PendingGaugeWrite` (struct, L1749), `PendingMatchedPublication` (struct, L1734), `ReadbackRetirementLatch` (class, L1910), `RebuildAffectedTopology` (method, L801), `RebuildTopologyCoordinates` (method, L826), `RecordBuildProposals` (method, L1105), `RecordClear` (method, L1007), `RecordCompactActive` (method, L1088), `RecordNormalize` (method, L985), `Request` (method, L1915), `Request` (method, L1918), `ResolveTopologyEvidence` (method, L857), `RetireWhenComplete` (method, L1939), `RetireWhenReadbacksComplete` (method, L2132), `SegmentInverseScratch` (class, L1783), `SetFrameMatrices` (method, L1371), `SetFrameMatrices` (method, L1404), `SetQ` (method, L1359), `SetQRaw` (method, L1362), `SetRgbQ` (method, L1365), `SetRgbQRaw` (method, L1368), `SigmaInverseController` (class, L23), `SigmaInverseDiagnosticSnapshot` (struct, L2173), `SigmaPackedQ48` (struct, L1702), `SignedMortonCoordinate` (method, L1517), `TryFindAdjacentGaugeOrigin` (method, L1456), `TryOffset` (method, L874), `UpdateObservedTopologyPages` (method, L769), `UploadExactCalibration` (method, L1295), `Value` (method, L2208), `ZigZagDecode` (method, L1536)
