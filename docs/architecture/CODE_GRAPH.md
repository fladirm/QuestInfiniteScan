...
Source digest: `50af8f1334294b805a9b225ff38b4f06383f47b0c392b0140ff8465cf4a2314a`

Scope: 103 files, 1920 symbols, 1600 functions/methods, 35 GPU kernels, 5 event links.
...
`ContractNativeQuery` (gpu_function, L1691), `SigmaN4ChartAssignmentOrbit` (gpu_function, L860), `SigmaN4ChartDirection` (gpu_function, L889), `SigmaN4ChartFrameDeterminant` (gpu_function, L883), `SigmaN4ChartOrbitRepresentative` (gpu_function, L869), `SigmaN4ResolveAdjacentFrame` (gpu_function, L900), `SigmaN4TileBoundaryHeader` (gpu_function, L845), `SigmaN4TileBoundaryIndex` (gpu_function, L823), `SigmaN4TileBuildComponents` (gpu_function, L1209), `SigmaN4TileCertificate` (gpu_function, L976), `SigmaN4TileCertificateReduce` (gpu_function, L989), `SigmaN4TileChartAssigned` (gpu_function, L1273), `SigmaN4TileChartEqual` (gpu_function, L1323), `SigmaN4TileChartFrame` (gpu_function, L1275), `SigmaN4TileChartProposal` (gpu_function, L1276), `SigmaN4TileClose` (gpu_function, L1599), `SigmaN4TileComponentAddress` (gpu_function, L774), `SigmaN4TileD4Equivalent` (gpu_function, L1427), `SigmaN4TileFinalizeComponents` (gpu_function, L1461), `SigmaN4TileFindRoot` (gpu_function, L1199), `SigmaN4TileFootprintAddress` (gpu_function, L762), `SigmaN4TileFootprintValid` (gpu_function, L790), `SigmaN4TileGlobalFootprint` (gpu_function, L781), `SigmaN4TileMeetSupports` (gpu_function, L1031), `SigmaN4TileNeighbour` (gpu_function, L928), `SigmaN4TilePackChart` (gpu_function, L1267), `SigmaN4TileResolvedEdge` (gpu_function, L853), `SigmaN4TileSolveOrbit` (gpu_function, L1328), `SigmaN4TileSortSupports` (gpu_function, L945), `SigmaN4TileStoreCertificate` (gpu_function, L983), `SigmaN4TileStructuralCertificateEqual` (gpu_function, L1001), `SigmaN4TileSupportAddress` (gpu_function, L767), `SigmaN4TileSupportKey` (gpu_function, L808), `SigmaNativeFreshEntryValid` (gpu_function, L168), `SigmaNativeFreshEvidenceAddress` (gpu_function, L139), `SigmaNativeFreshFinalize` (gpu_function, L1613), `SigmaNativeFreshLiftFootprint` (gpu_function, L751), `SigmaNativeFreshLiftLegacyBranch` (gpu_function, L744), `SigmaNativeFreshLiftSource` (gpu_function, L246), `SigmaNativeFreshLiftWeight` (gpu_function, L212), `SigmaNativeFreshLoad2` (gpu_function, L148), `SigmaNativeFreshLoad4` (gpu_function, L156), `SigmaNativeFreshModeMask` (gpu_function, L202), `SigmaNativeFreshPermutationAxis` (gpu_function, L176), `SigmaNativeFreshPermutationMode` (gpu_function, L184), `SigmaNativeFreshQ48Equal` (gpu_function, L163), `SigmaNativeFreshReduceAnd` (gpu_function, L218), `SigmaNativeFreshReduceOr` (gpu_function, L232), `if` (gpu_function, L306), `if` (gpu_function, L669), `if` (gpu_function, L676), `if` (gpu_function, L693), `ContractNativeQuery` (gpu_kernel, L4)

### `Runtime/Resources/SigmaPrism/SigmaNativeFrame.compute`

`BuildNativeObservation` (gpu_function, L755), `CloseAndPublishNativeRevision` (gpu_function, L4528), `PrepareNativeCanonicalSeed` (gpu_function, L3922), `PrepareNativeCanonicalSelect` (gpu_function, L4010), `PrepareNativeComponentOrder` (gpu_function, L4048), `PrepareNativePage` (gpu_function, L4429), `PrepareNativeRefinementPlan` (gpu_function, L4060), `PrepareNativeRefinementProof` (gpu_function, L4039), `PrepareNativeRevision` (gpu_function, L4107), `ScatterNativeState` (gpu_function, L4474), `SigmaN4PublishAcceptFirstImage` (gpu_function, L2721), `SigmaN4PublishActiveSupport` (gpu_function, L3304), `SigmaN4PublishActiveSupportAddress` (gpu_function, L1005), `SigmaN4PublishActiveSupportListOffset` (gpu_function, L998), `SigmaN4PublishAffineCompose` (gpu_function, L827), `SigmaN4PublishAppendRefinementChild` (gpu_function, L3231), `SigmaN4PublishAppendRelocation` (gpu_function, L3320), `SigmaN4PublishApplyParentCertificateMeet` (gpu_function, L1180), `SigmaN4PublishApplyRefinementCertificateMeets` (gpu_function, L1611), `SigmaN4PublishBoundaryIndex` (gpu_function, L1904), `SigmaN4PublishBuildAnchors` (gpu_function, L2170), `SigmaN4PublishBuildCandidate` (gpu_function, L2491), `SigmaN4PublishBuildComponentOrder` (gpu_function, L2935), `SigmaN4PublishBuildDelta` (gpu_function, L3125), `SigmaN4PublishBuildRefinementDelta` (gpu_function, L3163), `SigmaN4PublishBuildRefinementGroups` (gpu_function, L1187), `SigmaN4PublishBuildRefinementTargetPlan` (gpu_function, L3581), `SigmaN4PublishCacheSelectedCoordinates` (gpu_function, L2773), `SigmaN4PublishCertificateEqual` (gpu_function, L1032), `SigmaN4PublishChart` (gpu_function, L983), `SigmaN4PublishChartCore` (gpu_function, L896), `SigmaN4PublishChildLowerBound` (gpu_function, L3534), `SigmaN4PublishChildRadixDigit` (gpu_function, L3425), `SigmaN4PublishCollectEdges` (gpu_function, L2065), `SigmaN4PublishCompareBoundary` (gpu_function, L1933), `SigmaN4PublishCompareCell` (gpu_function, L1791), `SigmaN4PublishCompareComponents` (gpu_function, L2123), `SigmaN4PublishCompareCoordinateKey` (gpu_function, L1749), `SigmaN4PublishCompareEdgeStreams` (gpu_function, L2101), `SigmaN4PublishCompareEncodedEdge` (gpu_function, L2027), `SigmaN4PublishCompareReceipt128` (gpu_function, L1782), `SigmaN4PublishCompareSelectedCell` (gpu_function, L1871), `SigmaN4PublishCompareSelectedCoordinateKey` (gpu_function, L1825), `SigmaN4PublishCompleteRefinementTargetPlan` (gpu_function, L3632), `SigmaN4PublishComponentAddress` (gpu_function, L781), `SigmaN4PublishCoordinate` (gpu_function, L1681), `SigmaN4PublishCurrentEqual` (gpu_function, L3199), `SigmaN4PublishD4Compose` (gpu_function, L806), `SigmaN4PublishD4Vector` (gpu_function, L799), `SigmaN4PublishDeltaLane` (gpu_function, L4462), `SigmaN4PublishEdgeTargetRank` (gpu_function, L2001), `SigmaN4PublishFindRoot` (gpu_function, L845), `SigmaN4PublishFootprintValid` (gpu_function, L864), `SigmaN4PublishFreshCount` (gpu_function, L2870), `SigmaN4PublishFreshWidth` (gpu_function, L2902), `SigmaN4PublishGaugeEqual` (gpu_function, L3419), `SigmaN4PublishImageAddress` (gpu_function, L787), `SigmaN4PublishLoadGlobalTransform` (gpu_function, L837), `SigmaN4PublishLoadStageState` (gpu_function, L3902), `SigmaN4PublishLogicalCapacity` (gpu_function, L3362), `SigmaN4PublishMeetParentCertificateCore` (gpu_function, L1096), `SigmaN4PublishNeighbour` (gpu_function, L1920), `SigmaN4PublishNextPowerOfTwo` (gpu_function, L2806), `SigmaN4PublishPackedActiveIndex` (gpu_function, L1057), `SigmaN4PublishPackedChild` (gpu_function, L1062), `SigmaN4PublishPlanAddress` (gpu_function, L793), `SigmaN4PublishPrepareCandidateImage` (gpu_function, L2713), `SigmaN4PublishRadixDigit` (gpu_function, L2384), `SigmaN4PublishRadixNibble64` (gpu_function, L2377), `SigmaN4PublishRadixSort` (gpu_function, L2406), `SigmaN4PublishRefinementChildKey` (gpu_function, L3399), `SigmaN4PublishRefinementRepresentative` (gpu_function, L1010), `SigmaN4PublishResolvedOutgoingEdge` (gpu_function, L2040), `SigmaN4PublishSelectCandidate` (gpu_function, L2532), `SigmaN4PublishSelectedCoordinate` (gpu_function, L1708), `SigmaN4PublishSigned64` (gpu_function, L1662), `SigmaN4PublishSignedOrderKey` (gpu_function, L1047), `SigmaN4PublishSignedOrderValue` (gpu_function, L1052), `SigmaN4PublishSortComponents` (gpu_function, L2813), `SigmaN4PublishSortRefinementChildren` (gpu_function, L3442), `SigmaN4PublishSourceLogical` (gpu_function, L3378), `SigmaN4PublishSourceLowerBound` (gpu_function, L3554), `SigmaN4PublishStateEqual` (gpu_function, L1020), `SigmaN4PublishStaticExclusion` (gpu_function, L990), `SigmaN4PublishStoreStageState` (gpu_function, L3912), `SigmaN4PublishStructuralCertificateCompatible` (gpu_function, L1067), `SigmaN4PublishSupportLocator` (gpu_function, L883), `SigmaN4PublishTargetTempAddress` (gpu_function, L3372), `SigmaN4PublishTargetWorkAddress` (gpu_function, L3367), `SigmaN4PublishTileComponentAddress` (gpu_function, L774), `SigmaN4PublishTileFootprintAddress` (gpu_function, L768), `SigmaN4PublishTileHeaderAddress` (gpu_function, L762), `SigmaN4PublishTransformedCoordinate` (gpu_function, L1667), `SigmaN4PublishValidateParentCertificateMeet` (gpu_function, L1173), `SigmaN4PublishVisibleSlot` (gpu_function, L3108), `SigmaNativeBuildFullFrameFootprints` (gpu_function, L513), `SigmaNativeCompletionAddress` (gpu_function, L191), `SigmaNativeCurrentPrediction` (gpu_function, L429), `SigmaNativeDepthRayCenter` (gpu_function, L228), `SigmaNativeDepthRayDx` (gpu_function, L234), `SigmaNativeDepthRayDy` (gpu_function, L240), `SigmaNativeDepthSlopeBounds` (gpu_function, L246), `SigmaNativeFootprintEvidenceAddress` (gpu_function, L486), `SigmaNativeManifestationBoundaryEnvelope` (gpu_function, L315), `SigmaNativeObservationProvenance` (gpu_function, L498), `SigmaNativeOpticalBoundsFromSamples` (gpu_function, L392), `SigmaNativeProjectRgb` (gpu_function, L366), `SigmaNativeProjectionDepthBounds` (gpu_function, L280), `SigmaNativeQ48FromFloat` (gpu_function, L218), `SigmaNativeRgbCalibrationValue` (gpu_function, L223), `SigmaNativeRgbLoad` (gpu_function, L386), `SigmaNativeRoomRayComponent` (gpu_function, L264), `SigmaNativeSampleBoundaryRay` (gpu_function, L252), `SigmaNativeStoreFootprintEvidence` (gpu_function, L491), `SigmaNativeWriteCompletion4` (gpu_function, L196), `SigmaNativeWriteCompletionFrame` (gpu_function, L203), `if` (gpu_function, L1140), `if` (gpu_function, L1147), `if` (gpu_function, L1598), `if` (gpu_function, L4387), `if` (gpu_function, L4398), `BuildNativeObservation` (gpu_kernel, L4), `CloseAndPublishNativeRevision` (gpu_kernel, L13), `PrepareNativeCanonicalSeed` (gpu_kernel, L5), `PrepareNativeCanonicalSelect` (gpu_kernel, L6), `PrepareNativeComponentOrder` (gpu_kernel, L8), `PrepareNativePage` (gpu_kernel, L11), `PrepareNativeRefinementPlan` (gpu_kernel, L9), `PrepareNativeRefinementProof` (gpu_kernel, L7), `PrepareNativeRevision` (gpu_kernel, L10), `ScatterNativeState` (gpu_kernel, L12)
...
`EvaluateNativeRelation` (gpu_function, L1285), `SigmaN4Affine` (gpu_function, L746), `SigmaN4AffineCompose` (gpu_function, L804), `SigmaN4AffineEqual` (gpu_function, L823), `SigmaN4AffineIdentity` (gpu_function, L752), `SigmaN4AffineInverse` (gpu_function, L814), `SigmaN4BoundaryFactor` (gpu_function, L164), `SigmaN4BoundaryReceiptAddress` (gpu_function, L121), `SigmaN4ChartAssignmentOrbit` (gpu_function, L829), `SigmaN4ChartDirection` (gpu_function, L858), `SigmaN4ChartFrameDeterminant` (gpu_function, L852), `SigmaN4ChartOrbitRepresentative` (gpu_function, L838), `SigmaN4ClassifyBoundaryFactors` (gpu_function, L200), `SigmaN4CrossBoundaryCount` (gpu_function, L942), `SigmaN4D4Compose` (gpu_function, L764), `SigmaN4D4Inverse` (gpu_function, L785), `SigmaN4D4Vector` (gpu_function, L757), `SigmaN4DecodeBoundary` (gpu_function, L139), `SigmaN4DecodeCrossBoundary` (gpu_function, L948), `SigmaN4DirectRightToLeft` (gpu_function, L901), `SigmaN4EvaluateImplicitBoundary` (gpu_function, L283), `SigmaN4FindGlobalRoot` (gpu_function, L998), `SigmaN4FindTileSupport` (gpu_function, L524), `SigmaN4FootprintAddress` (gpu_function, L116), `SigmaN4GlobalCertificateCompatible` (gpu_function, L575), `SigmaN4GlobalCertificateReduce` (gpu_function, L561), `SigmaN4GlobalGeometryClose` (gpu_function, L1032), `SigmaN4GlobalNode` (gpu_function, L927), `SigmaN4GlobalParentAddress` (gpu_function, L735), `SigmaN4GlobalRootLink` (gpu_function, L1017), `SigmaN4GlobalTransformAddress` (gpu_function, L740), `SigmaN4LoadChartState` (gpu_function, L893), `SigmaN4LoadGlobalMeta` (gpu_function, L75), `SigmaN4LoadGlobalState` (gpu_function, L86), `SigmaN4LoadGlobalTransform` (gpu_function, L984), `SigmaN4ReduceActiveSupport` (gpu_function, L591), `SigmaN4ResolveAdjacentFrame` (gpu_function, L867), `SigmaN4SignedU128Add` (gpu_function, L170), `SigmaN4StoreBoundaryReceipt` (gpu_function, L127), `SigmaN4StoreGlobalMeta` (gpu_function, L80), `SigmaN4StoreGlobalState` (gpu_function, L91), `SigmaN4StoreGlobalTransform` (gpu_function, L991), `SigmaN4TileComponentAddress` (gpu_function, L728), `SigmaN4TileFootprintAddress` (gpu_function, L722), `SigmaN4TileHeaderAddress` (gpu_function, L512), `SigmaN4TileSupportAddress` (gpu_function, L517), `EvaluateNativeRelation` (gpu_kernel, L3)
...
`BindContract` (method, L499), `BindFrameKernels` (method, L271), `BindRelation` (method, L586), `BuildProvenanceReceipt` (method, L679), `CameraPose` (method, L16), `Dispose` (method, L264), `Dispose` (method, L87), `FromCamera` (method, L12), `Intrinsics` (method, L667), `OpticalTransfer` (method, L671), `RecordNativeCloseCommit` (method, L192), `Release` (method, L262), `SigmaNativeFrameGraph` (class, L103), `SigmaNativeFrameInput` (struct, L29), `SigmaNativeFrameLease` (class, L72), `SigmaRoomFrame` (class, L10), `TryAcquire` (method, L178), `WriteViewReceipt` (method, L703)
...
`BindPublication` (method, L2525), `BuildLocalityCertificate` (method, L2376), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L137), `CertificateDifference` (method, L2792), `CertifiedConstraintRecord` (method, L2703), `Compare` (method, L3506), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L1850), `ConstraintRecord` (method, L2673), `Count` (method, L2502), `CutEUsesDirectedWitnessWhenD4CellStreamsTie` (method, L2118), `DirectionModeMask` (method, L2773), `DispatchCutE` (method, L2511), `Equals` (method, L3494), `Equals` (method, L3497), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1595), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1373), `FindGaugeSample` (method, L3243), `Flatten` (method, L3287), `Flatten` (method, L3298), `From` (method, L3488), `GaugeKey` (struct, L3467), `GaugeKeyComparer` (class, L3502), `GetHashCode` (method, L3499), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L1669), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L97), `LoadShader` (method, L2274), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L1703), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L1770), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1637), `Packed` (method, L3311), `PackedInterval` (method, L3317), `PageMeta` (struct, L3559), `PersistAndReload` (method, L2761), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1483), `PrepareRefinementScratch` (method, L3092), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L277), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L834), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L484), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1156), `Q2` (method, L3344), `Q4` (method, L2784), `ReadCertificate` (method, L3275), `ReadPageMeta` (method, L3235), `ReadState` (method, L3265), `RefinementAtFullPageBoundarySpillsIntoNextLogicalPage` (method, L1998), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L1908), `RefinementMultiplicityAndParentMeetArePermutationInvariant` (method, L1950), `RefinementSnapshot` (class, L3421), `RefinementStep` (struct, L3406), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L1816), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L1873), `RunRefinementSequence` (method, L2804), `RunStaticExclusion` (method, L2410), `ScatterConsumesMutationCountInsteadOfResidentWorldExtent` (method, L1262), `SeedSingleFootprintClosedCutE` (method, L2287), `SetEqualCertificates` (method, L2650), `SetValidNextCertificate` (method, L2633), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L3519), `StateWithLane0` (method, L2403), `StaticExclusionSnapshot` (class, L3443), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1463), `ToRaw` (method, L3480), `ToString` (method, L3500), `U4` (method, L3350), `UInt2` (struct, L3543), `UInt2Buffer` (method, L3356), `UInt4` (struct, L3550), `UInt4Buffer` (method, L3359), `UIntBuffer` (method, L3353), `WriteEnvelope` (method, L3333), `WriteRepresentationCell` (method, L3196), `WriteState` (method, L3325), `ZeroArrayRenderTexture` (method, L3362), `ZeroRenderTexture` (method, L3387)
