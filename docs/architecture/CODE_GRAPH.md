...
Source digest: `beae3def3f6fd60440c6d8df3cd7f60015e1de34ec7eb339517f9a780deb4e89`

Scope: 107 files, 1591 symbols, 1292 functions/methods, 73 GPU kernels, 4 event links.
...
`AdditionalBytesFor` (method, L70), `BufferBytes` (method, L1068), `ComputeExecutionWindowFootprints` (method, L802), `ComputeSegmentRecordCapacity` (method, L789), `CreateBuffer` (method, L1059), `Dispose` (method, L106), `Dispose` (method, L220), `Dispose` (method, L241), `Dispose` (method, L279), `Dispose` (method, L954), `EstimateSourceBytes` (method, L774), `ExecutionWindow` (method, L830), `FrameSlot` (struct, L1115), `Get` (method, L231), `GetRetainedEvidence` (method, L873), `GetSources` (method, L855), `GrowTo` (method, L79), `IsPublishedEvidence` (method, L883), `Lower` (method, L211), `NextPowerOfTwo` (method, L1071), `Provenance` (method, L218), `Release` (method, L931), `ReleaseRetainedEvidence` (method, L890), `RequireAlive` (method, L1053), `RequireAlive` (method, L117), `RequireSlot` (method, L1043), `Retain` (method, L272), `Retain` (method, L863), `Segment` (method, L62), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameExecutionWindow` (struct, L1123), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L298), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L131), `SigmaOwnedFrameLease` (class, L250), `TransferEvidence` (method, L269), `TransferEvidence` (method, L915), `TryAcquireFrame` (method, L557), `TryEnsureCandidateCapacity` (method, L616), `TryEnsureClosureCapacity` (method, L734), `TryEnsureDirtyEdgeCapacity` (method, L711), `TryEnsurePendingCapacity` (method, L672), `TryEnsurePublicationCapacity` (method, L717), `TryEnsureRevisionCapacity` (method, L714), `TryEnsureTargetScratchCapacity` (method, L708), `TryGrow` (method, L1029), `TryReserve` (method, L1040), `UInt4` (method, L1081), `Upper` (method, L214), `ValidateGeneratedAbi` (method, L1084), `Validity` (method, L216), `WindowBuffer` (method, L840)
...
`BeginLine` (method, L351), `CaptureAndLogFrame` (method, L182), `CountSamples` (method, L365), `DispatchComputeProfiled` (method, L73), `DispatchComputeProfiled` (method, L94), `DispatchIndirectProfiled` (method, L148), `DispatchIndirectProfiled` (method, L165), `DispatchProfiled` (method, L115), `Entry` (class, L21), `FindProfiledKernel` (method, L60), `FormatSample` (method, L354), `FullName` (method, L338), `NanosecondsToMilliseconds` (method, L378), `Register` (method, L259), `ReportRegistrationUnavailable` (method, L341), `RequireEntry` (method, L323), `Reset` (method, L46), `SigmaGpuKernelTelemetry` (class, L16), `ValidateDirectDispatchDimensions` (method, L134)
...
`ArrayRenderTexture` (method, L1568), `AssertCandidates` (method, L640), `AssertMatrix` (method, L1802), `AssertPublished` (method, L558), `AssertUInt4` (method, L596), `BuildCarrierPrior` (method, L1670), `BuildCpuOracle` (method, L671), `Candidate` (method, L804), `ClaimedFoldMatchesFullIntrinsicS16Oracle` (method, L446), `ClaimedUnresolvedEdgeDefersOnlyIncidentChanges` (method, L390), `ClearPrediction` (method, L1591), `CloseCurrentFrame` (method, L948), `ClosureSnapshot` (class, L122), `ClosureTarget` (struct, L95), `ComposePose` (method, L1812), `ConstrainedLaneCount` (method, L774), `ContactZeroDivisorState` (method, L1686), `Contains` (method, L800), `CurrentPage` (method, L653), `DepthCalibration` (method, L1614), `Destroy` (method, L1796), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L233), `Dispose` (method, L1469), `ExactRegularEdgesJoinPendingAndAnchorContinuation` (method, L360), `FrameFixture` (class, L815), `GeometryRelationCell` (method, L1699), `Gpu4` (method, L1793), `Intrinsics` (method, L1519), `NormalizeDepth` (method, L1548), `Packed` (method, L1710), `PageMeta` (struct, L43), `PageState` (method, L663), `PendingCandidates` (method, L635), `PendingEdgesCrossExecutionWindowsWithoutChangingPhysics` (method, L528), `PendingEvidenceSurvivesAndReusesItsExactHandle` (method, L475), `PendingProjectionIsInvariantAcrossOneTwoAndSevenWindows` (method, L511), `Production320FrameLargeBindingRecordsOnlyLegalDispatches` (method, L288), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L280), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L1536), `ReadPendingGauge` (method, L960), `ReadSnapshot` (method, L1492), `RecordProductionGraphOnly` (method, L1108), `ReductionSnapshot` (class, L83), `RgbCalibration` (method, L1645), `RgbTexture` (method, L1524), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L136), `Run` (method, L933), `RunBoundaryClosure` (method, L614), `RunExactClosure` (method, L1244), `RunPendingProjectionLayout` (method, L605), `RunPublished` (method, L1381), `RunSegmentedTargetFixture` (method, L1009), `RunTargetReduction` (method, L1132), `ScalarState` (method, L1683), `SeedPending` (method, L966), `SeparatedExactCellsRemainDistinctWithoutPhysicalClaim` (method, L420), `Set` (method, L1660), `SetCandidateCell` (method, L1363), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L812), `Snapshot` (class, L58), `SourceKey` (method, L786), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L297), `UInt2` (struct, L27), `UInt4` (struct, L34), `UnobservedAdjacencyMakesNoTransitionClaim` (method, L341), `VisibleAtRoot` (method, L1448), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L167)

### `Tests/Editor/SigmaFrameResourceTests.cs`

`EvidenceTransferSurvivesExactFrameSlotReuse` (method, L86), `ExecutionWindowsAndDirectDispatchesRespectVulkanDimensions` (method, L61), `FrameCompletionDispositionIsTruthfulAndFailClosed` (method, L148), `GeneratedFrameAbiHasExactManagedStrides` (method, L23), `SigmaFrameResourceTests` (class, L11), `SourceStorageIsCompleteAndSegmentRangeNeverExceedsBinding` (method, L44), `UInt4` (struct, L14), `VulkanFixtureCompilesAllRecordsWithinEightUavs` (method, L195)
