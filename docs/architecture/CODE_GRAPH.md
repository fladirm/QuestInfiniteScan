...
Source digest: `558d8dd7db2c4b025c6678e75237ba9a86d4f24a4f6a11bbc4980ea918f2f76a`

Scope: 132 files, 2077 symbols, 1668 functions/methods, 108 GPU kernels, 6 event links.
...
`MaterializePublishedTopology` (gpu_function, L114), `SigmaDerivedCellAddress` (gpu_function, L32), `SigmaDerivedLoad` (gpu_function, L84), `SigmaDerivedNeighbourRecord` (gpu_function, L71), `SigmaDerivedRecordCuts` (gpu_function, L79), `SigmaDerivedTopologyCurrent` (gpu_function, L54), `SigmaDerivedTransitionAddress` (gpu_function, L27), `SigmaDerivedUnresolvedRecord` (gpu_function, L65), `SigmaDerivedVisible` (gpu_function, L37), `MaterializePublishedTopology` (gpu_kernel, L1)
...
`EvaluateTransactionMicrotile` (gpu_function, L523), `SigmaEvalAccumulateKey` (gpu_function, L258), `SigmaEvalBuildBootstrap` (gpu_function, L298), `SigmaEvalButterflyStage` (gpu_function, L176), `SigmaEvalFullBounds` (gpu_function, L290), `SigmaEvalHadamard` (gpu_function, L201), `SigmaEvalMeet` (gpu_function, L268), `SigmaEvalReduceValidity` (gpu_function, L241), `SigmaEvalRgbEye` (gpu_function, L352), `SigmaStreamAssociationContact` (gpu_function, L154), `SigmaStreamAssociationEye` (gpu_function, L133), `SigmaStreamAssociationMatchesTarget` (gpu_function, L168), `SigmaStreamAssociationSame` (gpu_function, L160), `SigmaStreamCombineOutcome` (gpu_function, L119), `SigmaStreamJointAddress` (gpu_function, L81), `SigmaStreamLoadCurrentBundle` (gpu_function, L98), `SigmaStreamNullLane` (gpu_function, L70), `SigmaStreamRaw` (gpu_function, L93), `SigmaStreamSampleAddress` (gpu_function, L88), `if` (gpu_function, L828), `EvaluateTransactionMicrotile` (gpu_kernel, L1)

### `Runtime/Resources/SigmaPrism/SigmaStreamProof.compute`

`CoalesceProofWindow` (gpu_function, L927), `CompleteProofBlock` (gpu_function, L1604), `EmitProofCertificates` (gpu_function, L1448), `EvaluateProofRedundancyWindow` (gpu_function, L1272), `MergeProofRuns` (gpu_function, L834), `PrepareProofOrder` (gpu_function, L774), `PrepareProofRedundancy` (gpu_function, L1037), `ReduceTransactionSourceBlock` (gpu_function, L476), `RetainProofRawWindow` (gpu_function, L1534), `SigmaProofAdvanceSourceCursor` (gpu_function, L197), `SigmaProofAtomicAddDegree` (gpu_function, L152), `SigmaProofCandidateBound` (gpu_function, L96), `SigmaProofCandidateBoundAddress` (gpu_function, L86), `SigmaProofCandidateBoundRead` (gpu_function, L102), `SigmaProofCandidateLess` (gpu_function, L618), `SigmaProofDegree` (gpu_function, L128), `SigmaProofFailTransaction` (gpu_function, L1007), `SigmaProofFinishRedundancyRank` (gpu_function, L1016), `SigmaProofFullBounds` (gpu_function, L78), `SigmaProofIndependentEdge` (gpu_function, L706), `SigmaProofKept` (gpu_function, L684), `SigmaProofKeptRead` (gpu_function, L690), `SigmaProofLoadCurrentSource` (gpu_function, L175), `SigmaProofLoadPrior` (gpu_function, L298), `SigmaProofLoadReadWork` (gpu_function, L744), `SigmaProofLoadWork` (gpu_function, L718), `SigmaProofMergeCandidate` (gpu_function, L886), `SigmaProofPrefixBound` (gpu_function, L115), `SigmaProofPrefixBoundAddress` (gpu_function, L91), `SigmaProofReduceSource` (gpu_function, L337), `SigmaProofResetSweepScratch` (gpu_function, L980), `SigmaProofSameKey` (gpu_function, L655), `SigmaProofSetCandidateBound` (gpu_function, L108), `SigmaProofSetKept` (gpu_function, L696), `SigmaProofSetPrefixBound` (gpu_function, L121), `SigmaProofSetSampleBit` (gpu_function, L227), `SigmaProofSetSortedIndex` (gpu_function, L676), `SigmaProofSortedIndex` (gpu_function, L664), `SigmaProofSortedIndexRead` (gpu_function, L670), `SigmaProofSourceCell` (gpu_function, L235), `SigmaProofSourceSlot` (gpu_function, L284), `if` (gpu_function, L1247), `CoalesceProofWindow` (gpu_kernel, L4), `CompleteProofBlock` (gpu_kernel, L9), `EmitProofCertificates` (gpu_kernel, L7), `EvaluateProofRedundancyWindow` (gpu_kernel, L6), `MergeProofRuns` (gpu_kernel, L3), `PrepareProofOrder` (gpu_kernel, L2), `PrepareProofRedundancy` (gpu_kernel, L5), `ReduceTransactionSourceBlock` (gpu_kernel, L1), `RetainProofRawWindow` (gpu_kernel, L8)
...
`BuildHistoricalDrawArguments` (gpu_function, L524), `CancelHistoricalRevalidation` (gpu_function, L685), `FinalizeHistoricalRevalidation` (gpu_function, L634), `PrepareHistoricalRevalidation` (gpu_function, L293), `RebuildHistoricalAssociation` (gpu_function, L596), `SigmaRevalidationBundleCurrent` (gpu_function, L179), `SigmaRevalidationCaptureEye` (gpu_function, L563), `SigmaRevalidationClaimAssociation` (gpu_function, L256), `SigmaRevalidationClearContext` (gpu_function, L55), `SigmaRevalidationCurrentBundle` (gpu_function, L154), `SigmaRevalidationFindVisiblePage` (gpu_function, L113), `SigmaRevalidationLoadTransaction` (gpu_function, L136), `SigmaRevalidationPageVisible` (gpu_function, L88), `SigmaRevalidationPinMarker` (gpu_function, L63), `SigmaRevalidationReclaimAssociation` (gpu_function, L201), `SigmaRevalidationReleaseSnapshotPin` (gpu_function, L71), `SigmaRevalidationSameCoordinate` (gpu_function, L104), `if` (gpu_function, L324), `if` (gpu_function, L360), `if` (gpu_function, L509), `if` (gpu_function, L517), `BuildHistoricalDrawArguments` (gpu_kernel, L2), `CancelHistoricalRevalidation` (gpu_kernel, L5), `FinalizeHistoricalRevalidation` (gpu_kernel, L4), `PrepareHistoricalRevalidation` (gpu_kernel, L1), `RebuildHistoricalAssociation` (gpu_kernel, L3)
...
`SigmaCandidateCloseRecord` (gpu_function, L533), `SigmaCandidateDyadL1` (gpu_function, L299), `SigmaCandidateEndpointLane` (gpu_function, L210), `SigmaCandidateEndpointStatus` (gpu_function, L258), `SigmaCandidateI64Equal` (gpu_function, L70), `SigmaCandidateIncrementI64` (gpu_function, L75), `SigmaCandidateLoadCell` (gpu_function, L517), `SigmaCandidateLoadWork` (gpu_function, L142), `SigmaCandidateNullLane` (gpu_function, L131), `SigmaCandidateOutsideSlot` (gpu_function, L204), `SigmaCandidatePageReference` (gpu_function, L102), `SigmaCandidatePageVisible` (gpu_function, L85), `SigmaCandidateRecordAddress` (gpu_function, L60), `SigmaCandidateResolveNeighbours` (gpu_function, L162), `SigmaCandidateSampleAddress` (gpu_function, L65), `SigmaCandidateTauL1` (gpu_function, L323), `SigmaCandidateTransactionPage` (gpu_function, L111), `SigmaCandidateTransitionLane` (gpu_function, L277), `ValidateCandidateAssociatorChunk` (gpu_function, L570), `ValidateCandidateTransitionChunk` (gpu_function, L334), `if` (gpu_function, L475), `ValidateCandidateAssociatorChunk` (gpu_kernel, L2), `ValidateCandidateTransitionChunk` (gpu_kernel, L1)
