...
Source digest: `a193537b10b5c75b1e29e3a908926807a11a4a0c82d36202da1b2288fcd8aef5`

Scope: 107 files, 1592 symbols, 1293 functions/methods, 73 GPU kernels, 4 event links.
...
`BeginLine` (method, L366), `CaptureAndLogFrame` (method, L197), `ComputeLinearDispatchGrid` (method, L148), `CountSamples` (method, L380), `DispatchComputeProfiled` (method, L73), `DispatchComputeProfiled` (method, L94), `DispatchIndirectProfiled` (method, L163), `DispatchIndirectProfiled` (method, L180), `DispatchProfiled` (method, L115), `Entry` (class, L21), `FindProfiledKernel` (method, L60), `FormatSample` (method, L369), `FullName` (method, L353), `NanosecondsToMilliseconds` (method, L393), `Register` (method, L274), `ReportRegistrationUnavailable` (method, L356), `RequireEntry` (method, L338), `Reset` (method, L46), `SigmaGpuKernelTelemetry` (class, L16), `ValidateDirectDispatchDimensions` (method, L134)
...
`ArrayRenderTexture` (method, L1588), `AssertCandidates` (method, L660), `AssertMatrix` (method, L1822), `AssertPublished` (method, L578), `AssertUInt4` (method, L616), `BuildCarrierPrior` (method, L1690), `BuildCpuOracle` (method, L691), `Candidate` (method, L824), `ClaimedFoldMatchesFullIntrinsicS16Oracle` (method, L466), `ClaimedUnresolvedEdgeDefersOnlyIncidentChanges` (method, L410), `ClearPrediction` (method, L1611), `CloseCurrentFrame` (method, L968), `ClosureSnapshot` (class, L122), `ClosureTarget` (struct, L95), `ComposePose` (method, L1832), `ConstrainedLaneCount` (method, L794), `ContactZeroDivisorState` (method, L1706), `Contains` (method, L820), `CurrentPage` (method, L673), `DepthCalibration` (method, L1634), `Destroy` (method, L1816), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L233), `Dispose` (method, L1489), `ExactRegularEdgesJoinPendingAndAnchorContinuation` (method, L380), `FrameFixture` (class, L835), `GeometryRelationCell` (method, L1719), `Gpu4` (method, L1813), `Intrinsics` (method, L1539), `NormalizeDepth` (method, L1568), `Packed` (method, L1730), `PageMeta` (struct, L43), `PageState` (method, L683), `PendingCandidates` (method, L655), `PendingEdgesCrossExecutionWindowsWithoutChangingPhysics` (method, L548), `PendingEvidenceSurvivesAndReusesItsExactHandle` (method, L495), `PendingProjectionIsInvariantAcrossOneTwoAndSevenWindows` (method, L531), `Production320FrameLargeBindingRecordsOnlyLegalDispatches` (method, L288), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L280), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L1556), `ReadPendingGauge` (method, L980), `ReadSnapshot` (method, L1512), `RecordProductionGraphOnly` (method, L1128), `ReductionSnapshot` (class, L83), `RgbCalibration` (method, L1665), `RgbTexture` (method, L1544), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L136), `Run` (method, L953), `RunBoundaryClosure` (method, L634), `RunExactClosure` (method, L1264), `RunPendingProjectionLayout` (method, L625), `RunPublished` (method, L1401), `RunSegmentedTargetFixture` (method, L1029), `RunTargetReduction` (method, L1152), `ScalarState` (method, L1703), `SeedPending` (method, L986), `SeparatedExactCellsRemainDistinctWithoutPhysicalClaim` (method, L440), `Set` (method, L1680), `SetCandidateCell` (method, L1383), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L832), `Snapshot` (class, L58), `SourceKey` (method, L806), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L297), `UInt2` (struct, L27), `UInt4` (struct, L34), `UnobservedAdjacencyMakesNoTransitionClaim` (method, L361), `VisibleAtRoot` (method, L1468), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L167)
