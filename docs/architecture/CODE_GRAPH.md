...
Source digest: `3f7eca7759d3636a667108d01b54be3a4ad9fd609250635e3768b6fca0f039cd`

Scope: 76 files, 1048 symbols, 819 functions/methods, 28 GPU kernels, 16 event links.
...
- `TextureRefinement.StatusChanged` → `statusHandler` ([Runtime/Core/RoomScanner.cs:1070](../../Runtime/Core/RoomScanner.cs#L1070))
- `TextureRefinement.StatusChanged` → `hqStatusHandler` ([Runtime/Core/RoomScanner.cs:1206](../../Runtime/Core/RoomScanner.cs#L1206))
- `RoomUnderstanding.AnchorsChanged` → `OnMrukAnchorsChanged` ([Runtime/Core/RoomScanner.cs:1526](../../Runtime/Core/RoomScanner.cs#L1526))
...
- `PrismFilmSpawner.FilmsMutated` → `OnFilmsMutated` ([Runtime/Prism/Geometry/PrismMeshletBuilder.cs:83](../../Runtime/Prism/Geometry/PrismMeshletBuilder.cs#L83))
...
`AddExclusionZone` (method, L1035), `ApplyEnhancedMesh` (method, L1415), `ApplyHQTexture` (method, L1542), `ApplyRefinedAtlas` (method, L1436), `ApplyRefinedTexture` (method, L1484), `ApplyRenderMode` (method, L1897), `Awake` (method, L339), `BuildCoverage` (method, L1734), `BuildProgress` (method, L1760), `CacheComponents` (method, L388), `ClearAllDataAsync` (method, L820), `ClearScan` (method, L803), `CompleteRoomStartup` (method, L433), `CreateScanAnchorAsync` (method, L717), `CycleRenderMode` (method, L890), `DeleteActiveArtifact` (method, L1980), `DeleteEnhancedMesh` (method, L2022), `DeserializeRefinedMesh` (method, L1381), `EnsureRefinedMesh` (method, L1623), `EnsureRefinedRenderer` (method, L1640), `EnsureUnwrappedAsync` (method, L1554), `ExportPointCloudAsync` (method, L1007), `FreezeInView` (method, L941), `GetActiveCameraProvider` (method, L2099), `IsModeAvailable` (method, L922), `LoadDownloadedSplat` (method, L2054), `LoadPackageAsync` (method, L987), `LoadRefinedOnlyAsync` (method, L998), `OnDisable` (method, L440), `OnMrukAnchorsChanged` (method, L1536), `OnRoomAnchorReady` (method, L379), `PopulateSceneObjectRegistry` (method, L1513), `ProvideColorFrame` (method, L1831), `ReconstructUnwrapFromResult` (method, L1599), `ReleaseScanResources` (method, L780), `RemoveExclusionZone` (method, L1044), `RoomScanner` (class, L94), `RunServerTrainingAsync` (method, L2065), `SaveScanAsync` (method, L968), `ScanCoverage` (struct, L52), `ScanPhase` (enum, L37), `ScanProgress` (struct, L77), `ScanRenderMode` (enum, L16), `SerializeRefinedMesh` (method, L1354), `SetCameraProvider` (method, L1027), `SetRefinedWorldFromLocal` (method, L1666), `SetRenderMode` (method, L878), `SetSafeShaderDefaults` (method, L1819), `SetSceneObjectRegistry` (method, L1503), `SetupHeadExclusion` (method, L1714), `Start` (method, L347), `StartHQRefinement` (method, L1182), `StartMeshEnhancement` (method, L1291), `StartScanningAsync` (method, L546), `StartServerTraining` (method, L1012), `StartTextureRefinement` (method, L1058), `StopScanning` (method, L735), `SubscribeToAnchorsChanged` (method, L1522), `ToggleDebugMenu` (method, L1019), `ToggleScanning` (method, L765), `TryGetCameraIntrinsics` (method, L1678), `UnfreezeInView` (method, L954), `UnsubscribeFromAnchorsChanged` (method, L1529), `Update` (method, L450), `UpdatePlateauDetection` (method, L1786)
...
`Bind` (method, L126), `OnDestroy` (method, L93), `OnFilmsMutated` (method, L102), `PrismMeshletBuilder` (class, L14), `StartBuilding` (method, L51), `StopBuilding` (method, L86)
...
`BoundaryCubic` (gpu_function, L113), `BoundaryHashEntry` (struct, L70), `BoundaryHashKey` (gpu_function, L102), `BuildAdaptiveFilmMeshlets` (gpu_function, L242), `BuildMeshDispatchArguments` (gpu_function, L235), `ChooseSubdivision` (gpu_function, L208), `ClearMeshletBuild` (gpu_function, L224), `ClosestBoundaryPoint` (gpu_function, L122), `ContactBoundaryHeader` (struct, L48), `ContactFilmHeader` (struct, L5), `ContactMeshletVertex` (struct, L33), `FinalizeMeshletDrawArguments` (gpu_function, L313), `Height` (gpu_function, L169), `Reserve` (gpu_function, L188), `SurfaceNormal` (gpu_function, L176), `BuildAdaptiveFilmMeshlets` (gpu_kernel, L3), `BuildMeshDispatchArguments` (gpu_kernel, L2), `ClearMeshletBuild` (gpu_kernel, L1), `FinalizeMeshletDrawArguments` (gpu_kernel, L4)
