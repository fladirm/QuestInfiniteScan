...
Source digest: `06f933972f5e8f98339ed323c286fa2b600f25170f3bd933d899cb7610a15a1f`
...
`CoalesceProofWindow` (gpu_function, L994), `CompleteProofBlock` (gpu_function, L1671), `EmitProofCertificates` (gpu_function, L1515), `EvaluateProofRedundancyWindow` (gpu_function, L1339), `MergeProofRuns` (gpu_function, L901), `PrepareProofOrder` (gpu_function, L841), `PrepareProofRedundancy` (gpu_function, L1104), `ReduceTransactionSourceBlock` (gpu_function, L558), `RetainProofRawWindow` (gpu_function, L1601), `SigmaProofAdvanceSourceCursor` (gpu_function, L204), `SigmaProofAtomicAddDegree` (gpu_function, L159), `SigmaProofCandidateBound` (gpu_function, L103), `SigmaProofCandidateBoundAddress` (gpu_function, L93), `SigmaProofCandidateBoundRead` (gpu_function, L109), `SigmaProofCandidateLess` (gpu_function, L685), `SigmaProofDegree` (gpu_function, L135), `SigmaProofFailTransaction` (gpu_function, L1074), `SigmaProofFinishRedundancyRank` (gpu_function, L1083), `SigmaProofFullBounds` (gpu_function, L85), `SigmaProofIndependentEdge` (gpu_function, L773), `SigmaProofKept` (gpu_function, L751), `SigmaProofKeptRead` (gpu_function, L757), `SigmaProofLoadCurrentSource` (gpu_function, L182), `SigmaProofLoadPrior` (gpu_function, L305), `SigmaProofLoadReadWork` (gpu_function, L811), `SigmaProofLoadWork` (gpu_function, L785), `SigmaProofMergeCandidate` (gpu_function, L953), `SigmaProofPrefixBound` (gpu_function, L122), `SigmaProofPrefixBoundAddress` (gpu_function, L98), `SigmaProofPrepareReduceGroup` (gpu_function, L512), `SigmaProofReduceSource` (gpu_function, L344), `SigmaProofResetSweepScratch` (gpu_function, L1047), `SigmaProofSameKey` (gpu_function, L722), `SigmaProofSetCandidateBound` (gpu_function, L115), `SigmaProofSetKept` (gpu_function, L763), `SigmaProofSetPrefixBound` (gpu_function, L128), `SigmaProofSetSampleBit` (gpu_function, L234), `SigmaProofSetSortedIndex` (gpu_function, L743), `SigmaProofSortedIndex` (gpu_function, L731), `SigmaProofSortedIndexRead` (gpu_function, L737), `SigmaProofSourceCell` (gpu_function, L242), `SigmaProofSourceSlot` (gpu_function, L291), `if` (gpu_function, L1314), `CoalesceProofWindow` (gpu_kernel, L4), `CompleteProofBlock` (gpu_kernel, L9), `EmitProofCertificates` (gpu_kernel, L7), `EvaluateProofRedundancyWindow` (gpu_kernel, L6), `MergeProofRuns` (gpu_kernel, L3), `PrepareProofOrder` (gpu_kernel, L2), `PrepareProofRedundancy` (gpu_kernel, L5), `ReduceTransactionSourceBlock` (gpu_kernel, L1), `RetainProofRawWindow` (gpu_kernel, L8)
