...
Source digest: `c946faf7de22a55942fe219c0ad56b25e3a5da5880f324b899fc37a6a8f30986`

Scope: 103 files, 1987 symbols, 1664 functions/methods, 37 GPU kernels, 5 event links.
...
`BindPublication` (method, L2927), `BuildLocalityCertificate` (method, L2747), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L181), `CanonicalSeedPreservesGlobalCloseUnresolvedReceipt` (method, L694), `CertificateDifference` (method, L3199), `CertifiedConstraintRecord` (method, L3110), `CompactedBoundaryOrderIsExecutionOnlyAcrossAllResults` (method, L589), `Compare` (method, L3944), `CompletionClassificationRejectsWrongNonzeroGpuRevision` (method, L2224), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L2198), `ConstraintRecord` (method, L3080), `Count` (method, L2873), `CutEUsesDirectedWitnessWhenD4CellStreamsTie` (method, L2489), `DirectionModeMask` (method, L3180), `DispatchCutE` (method, L2882), `Equals` (method, L3932), `Equals` (method, L3935), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1943), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1721), `FindGaugeSample` (method, L3650), `Flatten` (method, L3694), `Flatten` (method, L3705), `From` (method, L3926), `FullFrameLinearDispatchGridIsQuestLegalAndBijective` (method, L100), `GaugeKey` (struct, L3905), `GaugeKeyComparer` (class, L3940), `GetHashCode` (method, L3937), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L2017), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L141), `LoadShader` (method, L2645), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L2051), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L2118), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1985), `Packed` (method, L3718), `PackedInterval` (method, L3724), `PageMeta` (struct, L3997), `PersistAndReload` (method, L3168), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1831), `PrepareRefinementScratch` (method, L3499), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L376), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L1182), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L733), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1504), `Q2` (method, L3775), `Q4` (method, L3191), `ReadAssetSource` (method, L3793), `ReadCertificate` (method, L3682), `ReadPageMeta` (method, L3642), `ReadState` (method, L3672), `RefinementAtFullPageBoundarySpillsIntoNextLogicalPage` (method, L2369), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L2279), `RefinementMultiplicityAndParentMeetArePermutationInvariant` (method, L2321), `RefinementSnapshot` (class, L3859), `RefinementStep` (struct, L3844), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L2164), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L2244), `RunRefinementSequence` (method, L3211), `RunStaticExclusion` (method, L2781), `ScatterConsumesMutationCountInsteadOfResidentWorldExtent` (method, L1610), `SeedBoundaryWorklist` (method, L3751), `SeedSingleFootprintClosedCutE` (method, L2658), `SetEqualCertificates` (method, L3057), `SetValidNextCertificate` (method, L3040), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L3957), `StateWithLane0` (method, L2774), `StaticExclusionSnapshot` (class, L3881), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1811), `ToRaw` (method, L3918), `ToString` (method, L3938), `U4` (method, L3781), `UInt2` (struct, L3981), `UInt2Buffer` (method, L3787), `UInt4` (struct, L3988), `UInt4Buffer` (method, L3790), `UIntBuffer` (method, L3784), `WriteEnvelope` (method, L3740), `WriteRepresentationCell` (method, L3603), `WriteState` (method, L3732), `ZeroArrayRenderTexture` (method, L3800), `ZeroRenderTexture` (method, L3825)
