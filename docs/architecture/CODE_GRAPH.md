...
Source digest: `df0cb10bf0bcf881cc3d6dd72eb675cac9b1f5718983d50cf0db3185a74a5ff0`

Scope: 139 files, 2266 symbols, 1804 functions/methods, 113 GPU kernels, 5 event links.
...
`SigmaDirtyEdgeGpu` (struct, L81), `SigmaFrameCandidateGpu` (struct, L58), `SigmaFrameDeltaGpu` (struct, L75), `SigmaFrameOutcomeGpu` (struct, L64), `SigmaFrameRevisionGpu` (struct, L87), `SigmaOwnedFrameGpu` (struct, L51), `SigmaPendingGaugeGpu` (struct, L69)
...
`SigmaDirtyEdgeGpu` (struct, L124), `SigmaFrameCandidateGpu` (struct, L97), `SigmaFrameClaimKind` (enum, L45), `SigmaFrameDeltaGpu` (struct, L117), `SigmaFrameOutcomeFlags` (enum, L77), `SigmaFrameOutcomeGpu` (struct, L104), `SigmaFrameProposalKind` (enum, L31), `SigmaFrameRevisionGpu` (struct, L131), `SigmaFrameRevisionState` (enum, L69), `SigmaFrameSource` (enum, L23), `SigmaFrameTargetKind` (enum, L39), `SigmaFrameUInt2Gpu` (struct, L9), `SigmaFrameUInt4Gpu` (struct, L16), `SigmaGeneratedFrame` (class, L137), `SigmaOwnedFrameGpu` (struct, L90), `SigmaOwnedFrameState` (enum, L52), `SigmaPendingGaugeGpu` (struct, L110), `SigmaPendingGaugeState` (enum, L61)
...
`AdditionalBytesFor` (method, L62), `BufferBytes` (method, L622), `ComputeSegmentRecordCapacity` (method, L504), `CreateBuffer` (method, L613), `Dispose` (method, L211), `Dispose` (method, L232), `Dispose` (method, L267), `Dispose` (method, L550), `Dispose` (method, L98), `EstimateSourceBytes` (method, L489), `FrameSlot` (struct, L659), `Get` (method, L222), `GetSources` (method, L517), `GrowTo` (method, L71), `Lower` (method, L202), `Provenance` (method, L209), `Release` (method, L530), `RequireAlive` (method, L109), `RequireAlive` (method, L607), `RequireSlot` (method, L596), `Retain` (method, L260), `Retain` (method, L523), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L286), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L121), `SigmaOwnedFrameLease` (class, L241), `TryAcquireFrame` (method, L398), `TryEnsureCandidateCapacity` (method, L457), `TryEnsureDirtyEdgeCapacity` (method, L483), `TryEnsurePendingGaugeCapacity` (method, L480), `TryEnsureRevisionCapacity` (method, L486), `TryGrow` (method, L582), `TryReserve` (method, L593), `UInt4` (method, L625), `Upper` (method, L205), `ValidateGeneratedAbi` (method, L628), `Validity` (method, L207)
...
`SigmaAssociationSampleGpu` (struct, L798), `SigmaAssociationSampleGpu` (struct, L1090), `SigmaFrameUInt2Gpu` (struct, L1221), `SigmaFrameUInt4Gpu` (struct, L1228), `SigmaGeneratedAlgebra` (class, L502), `SigmaGeneratedFrame` (class, L1239), `SigmaGeneratedStreaming` (class, L843), `SigmaPageVisibilityGpu` (struct, L818), `SigmaPageVisibilityGpu` (struct, L1108), `SigmaProbationGpu` (struct, L748), `SigmaProbationGpu` (struct, L1045), `SigmaProofCandidateGpu` (struct, L781), `SigmaProofCandidateGpu` (struct, L1075), `SigmaProofClosureGpu` (struct, L768), `SigmaProofClosureGpu` (struct, L1063), `SigmaProofPrefixGpu` (struct, L790), `SigmaProofPrefixGpu` (struct, L1083), `SigmaPublicationManifestGpu` (struct, L809), `SigmaPublicationManifestGpu` (struct, L1100), `SigmaSealedSourceBundleGpu` (struct, L736), `SigmaSealedSourceBundleGpu` (struct, L1034), `SigmaSourceHandleSegmentGpu` (struct, L757), `SigmaSourceHandleSegmentGpu` (struct, L1053), `SigmaStreamBudgetClass` (enum, L689), `SigmaStreamDiagnosticGpu` (struct, L832), `SigmaStreamDiagnosticGpu` (struct, L1120), `SigmaStreamOpcode` (enum, L685), `SigmaStreamPageReferenceGpu` (struct, L705), `SigmaStreamPageReferenceGpu` (struct, L1005), `SigmaStreamUInt4Gpu` (struct, L696), `SigmaStreamWorkItemGpu` (struct, L825), `SigmaStreamWorkItemGpu` (struct, L1114), `SigmaTransactionGpu` (struct, L712), `SigmaTransactionGpu` (struct, L1011), `basis_product` (function, L124), `build_descriptor` (function, L174), `build_kernel_execution_descriptor` (function, L366), `check_or_write` (function, L1294), `chunks` (function, L473), `conjugate_sign` (function, L141), `cs_array` (function, L478), `cs_values` (function, L674), `dyads` (function, L149), `fingerprint_words` (function, L562), `frame_abi_descriptor` (function, L1156), `hadamard_sign` (function, L145), `main` (function, L1307), `multiply_dyads` (function, L157), `render_cs` (function, L487), `render_frame_cs` (function, L1179), `render_frame_hlsl` (function, L1254), `render_hlsl` (function, L605), `render_hlsl_layout` (function, L566), `render_streaming_cs` (function, L666), `render_streaming_hlsl` (function, L897), `sha256` (function, L169), `uint_array` (function, L662), `upper_snake` (function, L1145), `validate_descriptor` (function, L340), `values` (function, L907)
