...
Source digest: `48c4c8dc2cb2e3bcc963881ac2f6fc2ea9d5d28ff70b84984867aa804fabcf59`

Scope: 110 files, 1882 symbols, 1528 functions/methods, 77 GPU kernels, 5 event links.
...
`AddOutward` (method, L1067), `AggregateFactorClasses` (method, L1184), `CanOmit` (method, L354), `ComputeFingerprint` (method, L504), `ComputeRawInformationNormSquare` (method, L1170), `ComputeTransferFingerprint` (method, L154), `Contains` (method, L500), `ContractJoint` (method, L975), `ContractNativeQuery` (method, L908), `DeriveIdentityPreservingTransport` (method, L1234), `DivideOutward` (method, L1100), `DotPoint` (method, L1142), `EmptyOptical` (method, L1154), `Equals` (method, L433), `Equals` (method, L441), `Equals` (method, L459), `Equals` (method, L461), `Equals` (method, L478), `Equals` (method, L480), `Equals` (method, L573), `Equals` (method, L578), `Equals` (method, L621), `Equals` (method, L629), `EvaluateAndReduce` (method, L796), `EvaluateAndReduceEyePair` (method, L806), `EvaluateMerkabaShadow` (method, L748), `EvaluateNativeQuery` (method, L766), `EvaluateNativeQuery` (method, L771), `EvaluateNativeRelation` (method, L1010), `EvaluateNativeRelation` (method, L1015), `FindAnnihilator` (method, L1202), `GetHashCode` (method, L443), `GetHashCode` (method, L463), `GetHashCode` (method, L482), `GetHashCode` (method, L580), `GetHashCode` (method, L631), `Hull` (method, L1126), `MultiplyOutward` (method, L1079), `Negate` (method, L1226), `NormalizeFactor` (method, L1157), `Overlaps` (method, L1135), `Point` (method, L1152), `ProvenStrictlyBefore` (method, L1138), `ReduceNativeQuery` (method, L823), `ReduceNativeQuery` (method, L828), `RelationPermitsClosure` (method, L1195), `RequireForwardExpression` (method, L1246), `RequireIntrinsicRelationExpression` (method, L1276), `RequireReverseExpression` (method, L1262), `SameGaugeCell` (method, L1241), `SelectNativeQuerySupport` (method, L739), `SigmaMerkabaSemanticOracle` (class, L728), `SigmaNativeCoherentQueryContext` (struct, L233), `SigmaNativeContractBranch` (struct, L658), `SigmaNativeContractResult` (class, L701), `SigmaNativeContribution` (struct, L365), `SigmaNativeDebugRequest` (enum, L17), `SigmaNativeDeltaWitness` (struct, L465), `SigmaNativeEyePairQuery` (class, L253), `SigmaNativeEyePairShadow` (struct, L446), `SigmaNativeNearSingularLaw` (struct, L484), `SigmaNativeOracleCell` (struct, L289), `SigmaNativeOracleQuery` (class, L168), `SigmaNativeOracleResolution` (enum, L10), `SigmaNativePhotometricChannelLaw` (class, L45), `SigmaNativePhotometricLaw` (class, L90), `SigmaNativePhotometricSegment` (struct, L23), `SigmaNativePreimageCandidate` (struct, L634), `SigmaNativeQuerySupportSummary` (struct, L331), `SigmaNativeRelationFactor` (struct, L547), `SigmaNativeRelationInput` (struct, L514), `SigmaNativeRelationWitness` (struct, L583), `SigmaNativeSceneShadow` (struct, L395), `SubtractOutward` (method, L1073), `SumOutward` (method, L1122), `SummarizeCell` (method, L730), `TryApply` (method, L121)

### `Tests/Editor/SigmaNativeOracleTests.cs`

`AssertGpuRelationsMatchCpu` (method, L1246), `AssertGpuShadowEqual` (method, L1964), `AssertGpuShadowMatchesCpu` (method, L1984), `Axis` (method, L1787), `BuildPhotometricQuery` (method, L1704), `Candidate` (method, L1641), `Cell` (method, L1660), `CpuCandidate` (method, L1647), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L185), `EmptyOptical` (method, L1792), `EntryPointIndex` (method, L1960), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L1354), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L238), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L434), `Factor` (method, L1796), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L307), `GetHashCode` (method, L39), `GpuShadow` (class, L41), `HashS16` (method, L1906), `Kernels` (method, L474), `Law` (method, L1736), `LeftQuery` (method, L1678), `LoadShader` (method, L2001), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L468), `Pack` (method, L1928), `PackGaugeCoordinate` (method, L1817), `PackGaugeMetadata` (method, L1825), `PackInterval` (method, L1857), `PackKeys` (method, L1809), `PackPhotometricLaw` (method, L1865), `PackRelationPlan` (method, L1843), `PackRows` (method, L1921), `PackStates` (method, L1925), `PackU256` (method, L1934), `PiecewiseLaw` (method, L1758), `Point` (method, L1790), `Query` (method, L1690), `Raw` (method, L1794), `ReduceWindows` (method, L1609), `RelationFor` (method, L1655), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L121), `RightQuery` (method, L1684), `RunGpuContractOverflow` (method, L935), `RunGpuEyePair` (method, L1380), `RunGpuQuery` (method, L1372), `RunGpuQuerySet` (method, L1387), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L396), `State` (method, L1664), `StateRaw` (method, L1667), `Summary` (method, L1800), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L1954), `UnpackKey` (method, L1957), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L650), `VulkanExportDebugAndEyePairExecuteDistinctGeneratedSemantics` (method, L719), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L602), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L508), `VulkanReducerHandlesMoreThan64AndSignalsBoundedColdContinuation` (method, L802), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L851), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L74)
