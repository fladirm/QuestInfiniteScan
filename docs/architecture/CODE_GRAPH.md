...
Source digest: `1cbd654a0397b4ad15f69cba1ba2e6fa1e3484e8138690c2f16f637cdd0b0f13`

Scope: 162 files, 2221 symbols, 1657 functions/methods, 185 GPU kernels, 17 event links.
...
- `PrismFilmSpawner.FilmsMutated` → `OnFilmsMutated` ([Runtime/Prism/Geometry/PrismMeshletBuilder.cs:214](../../Runtime/Prism/Geometry/PrismMeshletBuilder.cs#L214))
...
`Bind` (method, L380), `DispatchMaterialization` (method, L367), `EnsurePlanBuffers` (method, L652), `LateUpdate` (method, L243), `OnDestroy` (method, L228), `OnFilmsMutated` (method, L252), `PrismMeshletBuilder` (class, L15), `RequestBuild` (method, L269), `StartBuilding` (method, L151), `StopBuilding` (method, L220), `TryBuild` (method, L270), `TryIncrementalPublication` (method, L323), `TryInitialPublication` (method, L288)
...
`BindBoundaryCurveResources` (method, L669), `BindContourResources` (method, L517), `BindElasticResources` (method, L754), `BindHalfEdgeResources` (method, L578), `BindPortalResources` (method, L832), `CeilDiv` (method, L904), `CeilLog2` (method, L907), `DispatchAtlas` (method, L315), `FindKernels` (method, L439), `OnDestroy` (method, L292), `PrepareRestoredResidency` (method, L305), `PrismPressureManifoldAtlas` (class, L14), `ResetEmptyResidency` (method, L294), `SetChunkFrame` (method, L287), `StartAtlas` (method, L227), `StopAtlas` (method, L280)
...
`Frag` (gpu_function, L64), `Varyings` (struct, L36), `Vert` (gpu_function, L46)
...
`ActiveSegment` (gpu_function, L72), `AssignFrontierLoops` (gpu_function, L484), `BuildFrontierEndpointHash` (gpu_function, L349), `BuildHalfEdgeArguments` (gpu_function, L117), `BuildHalfEdgeSpatialHash` (gpu_function, L188), `ClearHalfEdgeDerivedState` (gpu_function, L154), `ClearHalfEdgeHashState` (gpu_function, L136), `ContactViewState` (gpu_function, L103), `CreateFrontierLoops` (gpu_function, L462), `FilmPoint` (gpu_function, L67), `FinalizeFrontierLoops` (gpu_function, L521), `FindLoopRoot` (gpu_function, L109), `HashCell` (gpu_function, L89), `HookFrontierComponents` (gpu_function, L440), `InitializeFrontierComponents` (gpu_function, L430), `MaterializeMeasuredHalfEdges` (gpu_function, L169), `OrderOuterHalfEdges` (gpu_function, L367), `ProveHalfEdgeTwins` (gpu_function, L205), `SegmentDomain` (gpu_function, L62), `ShortcutFrontierComponents` (gpu_function, L454), `WorldCell` (gpu_function, L98), `AssignFrontierLoops` (gpu_kernel, L13), `BuildFrontierEndpointHash` (gpu_kernel, L7), `BuildHalfEdgeArguments` (gpu_kernel, L1), `BuildHalfEdgeSpatialHash` (gpu_kernel, L5), `ClearHalfEdgeDerivedState` (gpu_kernel, L3), `ClearHalfEdgeHashState` (gpu_kernel, L2), `CreateFrontierLoops` (gpu_kernel, L12), `FinalizeFrontierLoops` (gpu_kernel, L14), `HookFrontierComponents` (gpu_kernel, L10), `InitializeFrontierComponents` (gpu_kernel, L9), `MaterializeMeasuredHalfEdges` (gpu_kernel, L4), `OrderOuterHalfEdges` (gpu_kernel, L8), `ProveHalfEdgeTwins` (gpu_kernel, L6), `ShortcutFrontierComponents` (gpu_kernel, L11)

### `Runtime/Resources/Prism/MeshletBuild.compute`

`AddMeshletBuildGroupOffsets` (gpu_function, L1249), `BootstrapCoverage` (gpu_function, L500), `BootstrapCoverageCell` (gpu_function, L490), `BoundaryCurveCache` (struct, L105), `BoundaryHashEntry` (struct, L93), `BoundaryHashKey` (gpu_function, L564), `BoundarySignedDistance` (gpu_function, L670), `BuildFilmCount` (gpu_function, L267), `BuildFilmIndex` (gpu_function, L273), `BuildFilmMeshletBoundaryTriangles` (gpu_function, L1673), `BuildFilmMeshletRegularTriangles` (gpu_function, L1651), `BuildFilmMeshletVertices` (gpu_function, L1424), `BuildMeshDispatchArguments` (gpu_function, L951), `BuildSurfaceVertex` (gpu_function, L1369), `CachedBoundarySegment` (gpu_function, L575), `CachedBoundarySide` (gpu_function, L584), `CellTouchesPersistentBoundary` (gpu_function, L656), `ChooseSubdivision` (gpu_function, L879), `ClassifyMaterialTriangle` (gpu_function, L774), `ClearMeshletBuild` (gpu_function, L932), `ClosestBoundaryPoint` (gpu_function, L603), `ClosestPointOnUvSegment` (gpu_function, L593), `CommitDirtyMeshletBuild` (gpu_function, L1009), `CommitFullMeshletRepack` (gpu_function, L1315), `ContactBoundaryHeader` (struct, L71), `ContactFilmHeader` (struct, L20), `ContactMeshletDescriptor` (struct, L52), `CountMeshletBuildPlans` (gpu_function, L1049), `CutIntersection` (gpu_function, L1391), `DisplacementCell` (struct, L130), `DisplacementMetrics` (gpu_function, L342), `DisplacementPageHeader` (struct, L113), `ElasticChartState` (struct, L178), `EmitBoundaryMaterialTriangle` (gpu_function, L1575), `EmitRegularMaterialTriangle` (gpu_function, L1513), `FilmMeshletRange` (struct, L164), `FilmSlotState` (struct, L173), `FinalizeDirtyMeshletFilms` (gpu_function, L1336), `FinalizeFilmMeshletDescriptors` (gpu_function, L1700), `FinalizeMeshletDrawArguments` (gpu_function, L1786), `Height` (gpu_function, L804), `LoadDisplacementCell` (gpu_function, L279), `LoadDisplacementChild` (gpu_function, L291), `LoadMeshletBuildContext` (gpu_function, L1406), `MaterialClassCounts` (gpu_function, L744), `MeshletBuildPlan` (struct, L144), `NonDegenerateCutScalar` (gpu_function, L753), `PrepareDirtyMeshletBuild` (gpu_function, L968), `PrepareFullMeshletRepack` (gpu_function, L1030), `RecoverPreviousMeshletGeneration` (gpu_function, L1759), `Reserve` (gpu_function, L859), `ReservedIndexCount` (gpu_function, L925), `ReservedSubdivision` (gpu_function, L911), `ReservedVertexCount` (gpu_function, L917), `ResolveDisplacementPage` (gpu_function, L301), `SampleDisplacement` (gpu_function, L394), `ScanMeshletBuildGroups` (gpu_function, L1227), `ScanMeshletBuildPlans` (gpu_function, L1191), `StableSurfaceSampleId` (gpu_function, L1358), `StoreTriangle` (gpu_function, L1399), `SurfaceCoverage` (gpu_function, L516), `SurfaceNormal` (gpu_function, L819), `SurfacePosition` (gpu_function, L850), `TriangleBoundaryCut` (gpu_function, L761), `TriangleClassAt` (gpu_function, L1465), `TriangleCoordinates` (gpu_function, L1492), `TriangleMask` (gpu_function, L737), `TrianglePrefixAt` (gpu_function, L1472), `ValidateDirtyMeshletBuild` (gpu_function, L982), `ValidateMeshletBuild` (gpu_function, L1264), `if` (gpu_function, L1598), `if` (gpu_function, L1631), `AddMeshletBuildGroupOffsets` (gpu_kernel, L6), `BuildFilmMeshletBoundaryTriangles` (gpu_kernel, L10), `BuildFilmMeshletRegularTriangles` (gpu_kernel, L9), `BuildFilmMeshletVertices` (gpu_kernel, L8), `BuildMeshDispatchArguments` (gpu_kernel, L2), `ClearMeshletBuild` (gpu_kernel, L1), `CommitDirtyMeshletBuild` (gpu_kernel, L17), `CommitFullMeshletRepack` (gpu_kernel, L19), `CountMeshletBuildPlans` (gpu_kernel, L3), `FinalizeDirtyMeshletFilms` (gpu_kernel, L16), `FinalizeFilmMeshletDescriptors` (gpu_kernel, L11), `FinalizeMeshletDrawArguments` (gpu_kernel, L13), `PrepareDirtyMeshletBuild` (gpu_kernel, L14), `PrepareFullMeshletRepack` (gpu_kernel, L18), `RecoverPreviousMeshletGeneration` (gpu_kernel, L12), `ScanMeshletBuildGroups` (gpu_kernel, L5), `ScanMeshletBuildPlans` (gpu_kernel, L4), `ValidateDirtyMeshletBuild` (gpu_kernel, L15), `ValidateMeshletBuild` (gpu_kernel, L7)
...
`DefaultMeshletBindingsRemainBelowStorageBindingLimit` (method, L27), `Load` (method, L105), `MeshletGpuAbiMatchesDeclaredStrides` (method, L16), `PrismMeshletContractTests` (class, L11), `ProductionMeshletPathContainsNoCpuReadback` (method, L89), `PublicationUsesDistinctFrontAndBackBuffers` (method, L70), `RequiredQ312ComputeKernelsImport` (method, L42)
