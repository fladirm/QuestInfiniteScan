...
Source digest: `4db2d9a540c51f1d6c8fda12db5e1f27e880224eb265df4180bd29dc03ea9d7e`

Scope: 107 files, 1598 symbols, 1298 functions/methods, 73 GPU kernels, 4 event links.
...
- `SigmaRenderer.PredictionReady` → `OnPredictionReady` ([Runtime/SigmaPrism/SigmaInverseController.cs:133](../../Runtime/SigmaPrism/SigmaInverseController.cs#L133))
...
`BindCarrier` (method, L1535), `BindEvaluate` (method, L1443), `BindExactClosureBase` (method, L865), `BindExactEdgeWindow` (method, L934), `BindExactTargetWindow` (method, L1237), `BindExecutionWindow` (method, L1726), `BindFootprintWindow` (method, L1752), `BindFrameConstants` (method, L1313), `BindPendingClosureReadWindow` (method, L1258), `BindPendingClosureWriteWindow` (method, L1273), `BindPendingInverseWindow` (method, L1512), `BindPendingProjectionInput` (method, L1491), `BindPendingProjectionOutput` (method, L1476), `BindProposal` (method, L1349), `BindPublicationBase` (method, L961), `BindPublicationSegment` (method, L1069), `BindPublicationTargetWindow` (method, L1057), `BindReductionCarrier` (method, L1293), `BindReductionCarrier` (method, L1298), `BindReductionSourceWindow` (method, L1191), `BindSourceOutputs` (method, L1553), `BindSourceRead` (method, L1584), `BindSourceReads` (method, L1571), `BindTargetReductionBase` (method, L1138), `BindTargetWindow` (method, L1213), `CameraPose` (method, L18), `CeilDiv` (method, L1689), `CreateBuffer` (method, L1662), `Dispose` (method, L852), `FindKernels` (method, L1666), `FirstSegment` (method, L1648), `FromCamera` (method, L14), `Intrinsics` (method, L1675), `Packed` (method, L1679), `RecordCompactWindow` (method, L1697), `RecordCompactWindow` (method, L409), `RecordDepthSource` (method, L1382), `RecordExactClosure` (method, L559), `RecordExactClosureOnly` (method, L574), `RecordMappedTargetSort` (method, L829), `RecordPendingProjection` (method, L360), `RecordPublication` (method, L709), `RecordPublicationScan` (method, L1092), `RecordRgbSource` (method, L1414), `RecordSourceAndResolve` (method, L238), `RecordTargetReduction` (method, L421), `RecordWindowChunks` (method, L1735), `RequireAlive` (method, L1759), `SetFrameMatrices` (method, L1602), `SigmaFrameGraph` (class, L86), `SigmaFrameInverseInput` (struct, L36), `SigmaRoomFrame` (class, L12), `Single` (method, L1638), `TryAcquire` (method, L219), `ValidatePublicationSegments` (method, L1107), `Window` (method, L1692)

### `Runtime/SigmaPrism/SigmaFrameResources.cs`

`AdditionalBytesFor` (method, L70), `BufferBytes` (method, L1061), `ComputeExecutionWindowFootprints` (method, L797), `ComputeSegmentRecordCapacity` (method, L784), `CreateBuffer` (method, L1052), `Dispose` (method, L106), `Dispose` (method, L220), `Dispose` (method, L241), `Dispose` (method, L279), `Dispose` (method, L947), `EstimateSourceBytes` (method, L769), `ExecutionWindow` (method, L823), `FrameSlot` (struct, L1108), `Get` (method, L231), `GetRetainedEvidence` (method, L866), `GetSources` (method, L848), `GrowTo` (method, L79), `IsPublishedEvidence` (method, L876), `Lower` (method, L211), `NextPowerOfTwo` (method, L1064), `Provenance` (method, L218), `Release` (method, L924), `ReleaseRetainedEvidence` (method, L883), `RequireAlive` (method, L1046), `RequireAlive` (method, L117), `RequireSlot` (method, L1036), `Retain` (method, L272), `Retain` (method, L856), `Segment` (method, L62), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameExecutionWindow` (struct, L1116), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L298), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L131), `SigmaOwnedFrameLease` (class, L250), `TransferEvidence` (method, L269), `TransferEvidence` (method, L908), `TryAcquireFrame` (method, L552), `TryEnsureCandidateCapacity` (method, L611), `TryEnsureClosureCapacity` (method, L729), `TryEnsureDirtyEdgeCapacity` (method, L706), `TryEnsurePendingCapacity` (method, L667), `TryEnsurePublicationCapacity` (method, L712), `TryEnsureRevisionCapacity` (method, L709), `TryEnsureTargetScratchCapacity` (method, L703), `TryGrow` (method, L1022), `TryReserve` (method, L1033), `UInt4` (method, L1074), `Upper` (method, L214), `ValidateGeneratedAbi` (method, L1077), `Validity` (method, L216), `WindowBuffer` (method, L833)
...
`BeginLine` (method, L404), `CaptureAndLogFrame` (method, L226), `ComputeLinearDispatchGrid` (method, L177), `CountSamples` (method, L418), `DispatchComputeProfiled` (method, L123), `DispatchComputeProfiled` (method, L97), `DispatchIndirectProfiled` (method, L192), `DispatchIndirectProfiled` (method, L209), `DispatchProfiled` (method, L144), `Entry` (class, L20), `FindProfiledKernel` (method, L83), `FormatSample` (method, L407), `FullName` (method, L391), `NanosecondsToMilliseconds` (method, L431), `OptionalEntry` (method, L381), `Register` (method, L305), `ReportRegistrationUnavailable` (method, L394), `RequireEntry` (method, L369), `Reset` (method, L66), `SetProfilingEnabledForTests` (method, L436), `SigmaGpuKernelTelemetry` (class, L15), `ValidateDirectDispatchDimensions` (method, L163)
...
`AbsNanoseconds` (method, L757), `Add` (method, L909), `AdvanceAge` (method, L1061), `Begin` (method, L976), `BuildTrackingPriorEnvelope` (method, L522), `CaptureTimingTelemetry` (method, L219), `CeilDiv` (method, L789), `ClassifyFrameCompletion` (method, L1146), `Complete` (method, L1093), `CountPendingTickets` (method, L716), `CreateArrayTexture` (method, L795), `CreateBuffer` (method, L792), `CreatePersistentResources` (method, L619), `DestroyTexture` (method, L825), `Dispose` (method, L1113), `ElapsedMilliseconds` (method, L1062), `EnsureCalibration` (method, L594), `EnsureDirectGraph` (method, L233), `EnsureFrameResources` (method, L1064), `EnsurePosePartials` (method, L1081), `FillCalibration` (method, L643), `FillRgbCalibration` (method, L680), `FindKernels` (method, L607), `FromRaw` (method, L894), `IndependenceKey` (method, L762), `IngressSlot` (class, L930), `LatchCompletionFault` (method, L371), `LateUpdate` (method, L168), `LatencyTracker` (class, L897), `MaxRigRotationResidual` (method, L581), `MaxRigTranslationResidual` (method, L568), `Mix` (method, L784), `NextRevision` (method, L740), `OnDestroy` (method, L836), `OnModuleInitialize` (method, L106), `OnPredictionReady` (method, L160), `OnScanStarted` (method, L138), `OnScanStopped` (method, L152), `Poll` (method, L1005), `PollIngress` (method, L341), `RecordCorrectedCalibration` (method, L461), `RecordNormalize` (method, L382), `RecordPoseGauge` (method, L407), `ReleasePendingIngress` (method, L728), `ReleaseTransientInputs` (method, L1135), `Reset` (method, L921), `SaturatingAdd` (method, L760), `SetQ` (method, L748), `SetQRaw` (method, L751), `SetRgbQ` (method, L753), `SetRgbQRaw` (method, L755), `SigmaFrameCompletionDisposition` (enum, L10), `SigmaInverseController` (class, L28), `SigmaPackedQ48` (struct, L885), `SubmitIngress` (method, L251), `TrackLast` (method, L734), `TryGetFreeIngressSlot` (method, L698), `UploadExactCalibration` (method, L489), `UploadPosePrior` (method, L502)
...
`ArrayRenderTexture` (method, L1720), `AssertCandidates` (method, L755), `AssertMatrix` (method, L1954), `AssertPublished` (method, L673), `AssertUInt4` (method, L711), `BuildCarrierPrior` (method, L1822), `BuildCpuOracle` (method, L786), `Candidate` (method, L919), `ClaimedFoldMatchesFullIntrinsicS16Oracle` (method, L561), `ClaimedUnresolvedEdgeDefersOnlyIncidentChanges` (method, L505), `ClearPrediction` (method, L1743), `CloseCurrentFrame` (method, L1063), `ClosureSnapshot` (class, L123), `ClosureTarget` (struct, L96), `ComposePose` (method, L1964), `ConstrainedLaneCount` (method, L889), `ContactZeroDivisorState` (method, L1838), `Contains` (method, L915), `ContinuationPublicationSnapshot` (class, L135), `CurrentPage` (method, L768), `DepthCalibration` (method, L1766), `Destroy` (method, L1948), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L241), `Dispose` (method, L1621), `ExactRegularEdgesJoinPendingAndAnchorContinuation` (method, L435), `FrameFixture` (class, L930), `GeometryRelationCell` (method, L1851), `Gpu4` (method, L1945), `Intrinsics` (method, L1671), `NormalizeDepth` (method, L1700), `Packed` (method, L1862), `PageMeta` (struct, L44), `PageState` (method, L778), `PendingCandidates` (method, L750), `PendingEdgesCrossExecutionWindowsWithoutChangingPhysics` (method, L643), `PendingEvidenceSurvivesAndReusesItsExactHandle` (method, L590), `PendingProjectionIsInvariantAcrossOneTwoAndSevenWindows` (method, L626), `PendingRetentionCannotOverwriteContinuationAnchor` (method, L465), `Production320FrameLargeBindingRecordsOnlyLegalDispatches` (method, L296), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L288), `ProfilingDisabledPreservesProductionDispatchContract` (method, L305), `PublicationSnapshot` (class, L70), `PublishCurrentClosure` (method, L1478), `RawDepthTexture` (method, L1688), `ReadPendingGauge` (method, L1075), `ReadSnapshot` (method, L1644), `RecordProductionGraphOnly` (method, L1223), `ReductionSnapshot` (class, L84), `RgbCalibration` (method, L1797), `RgbTexture` (method, L1676), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L144), `Run` (method, L1048), `RunBoundaryClosure` (method, L729), `RunExactClosure` (method, L1359), `RunPendingProjectionLayout` (method, L720), `RunPublished` (method, L1533), `RunSegmentedTargetFixture` (method, L1124), `RunTargetReduction` (method, L1247), `ScalarState` (method, L1835), `SeedPending` (method, L1081), `SeparatedExactCellsRemainDistinctWithoutPhysicalClaim` (method, L535), `Set` (method, L1812), `SetCandidateCell` (method, L1515), `SigmaFrameInverseTests` (class, L12), `Signed` (method, L927), `Snapshot` (class, L59), `SourceKey` (method, L901), `TargetReductionIsExactPermutationAndWindowInvariant` (method, L352), `UInt2` (struct, L28), `UInt4` (struct, L35), `UnobservedAdjacencyMakesNoTransitionClaim` (method, L416), `VisibleAtRoot` (method, L1600), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L175)

### `Tests/Editor/SigmaFrameResourceTests.cs`

`EvidenceTransferSurvivesExactFrameSlotReuse` (method, L98), `ExecutionWindowsAndDirectDispatchesRespectVulkanDimensions` (method, L61), `FrameCompletionDispositionIsTruthfulAndFailClosed` (method, L160), `GeneratedFrameAbiHasExactManagedStrides` (method, L23), `SigmaFrameResourceTests` (class, L11), `SourceStorageIsCompleteAndSegmentRangeNeverExceedsBinding` (method, L44), `UInt4` (struct, L14), `VulkanFixtureCompilesAllRecordsWithinEightUavs` (method, L207)
