...
Source digest: `d7cf710cf6f4f1af1fedf868b427136e4efef08fc0050bdd1385d4f1e0665bb5`

Scope: 133 files, 2151 symbols, 1729 functions/methods, 112 GPU kernels, 6 event links.
...
`BuildHistoricalDrawArguments` (gpu_function, L573), `CancelHistoricalRevalidation` (gpu_function, L767), `FinalizeHistoricalRevalidation` (gpu_function, L722), `PrepareHistoricalRevalidation` (gpu_function, L344), `RebuildHistoricalAssociation` (gpu_function, L644), `SigmaRevalidationBundleCurrent` (gpu_function, L230), `SigmaRevalidationCaptureEye` (gpu_function, L611), `SigmaRevalidationClaimAssociation` (gpu_function, L307), `SigmaRevalidationClearContext` (gpu_function, L109), `SigmaRevalidationClosedState` (gpu_function, L78), `SigmaRevalidationCurrentBundle` (gpu_function, L205), `SigmaRevalidationFindVisiblePage` (gpu_function, L164), `SigmaRevalidationLoadTransaction` (gpu_function, L187), `SigmaRevalidationPageVisible` (gpu_function, L139), `SigmaRevalidationPinMarker` (gpu_function, L117), `SigmaRevalidationPrepareFinalize` (gpu_function, L682), `SigmaRevalidationReclaimAssociation` (gpu_function, L254), `SigmaRevalidationReleaseSnapshotPin` (gpu_function, L122), `SigmaRevalidationResetEvaluation` (gpu_function, L63), `SigmaRevalidationSameCoordinate` (gpu_function, L155), `if` (gpu_function, L375), `if` (gpu_function, L411), `if` (gpu_function, L558), `if` (gpu_function, L566), `BuildHistoricalDrawArguments` (gpu_kernel, L2), `CancelHistoricalRevalidation` (gpu_kernel, L5), `FinalizeHistoricalRevalidation` (gpu_kernel, L4), `PrepareHistoricalRevalidation` (gpu_kernel, L1), `RebuildHistoricalAssociation` (gpu_kernel, L3)
...
`AssertProofEqual` (method, L712), `Bind` (method, L743), `Bounds` (method, L732), `BoundsEqual` (method, L698), `BoundsGpu` (struct, L41), `BuildPartitionedProofEvidence` (method, L599), `CloseProof` (method, L651), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L235), `MeetCertificates` (method, L657), `PageMetadataGpu` (struct, L17), `ProofCertificate` (method, L639), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L405), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L431), `ReadCompute` (method, L749), `ReadScript` (method, L756), `ReplayWindows` (method, L670), `SigmaStreamingContractTests` (class, L12), `StreamingRepairContractUsesProductionBindingsAndClosure` (method, L139), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L48), `TransactionTelemetryDecodesExecutionGeneration` (method, L195), `U4` (method, L727), `UInt2Gpu` (struct, L34)
