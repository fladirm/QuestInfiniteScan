...
Source digest: `fa6fb663351a49f95e346c5b436c2e7bc940a43574858cbce5c9387ccb817fee`

Scope: 113 files, 1620 symbols, 1316 functions/methods, 64 GPU kernels, 4 event links.
...
`BuildDepthSourceCells` (gpu_function, L344), `BuildFrameProposals` (gpu_function, L295), `BuildRgbSourceCells` (gpu_function, L472), `ClearFrameState` (gpu_function, L264), `CompactResolvedTargets` (gpu_function, L1087), `EvaluateCandidateMeets` (gpu_function, L825), `SigmaFrameBootstrapCoordinate` (gpu_function, L456), `SigmaFrameBuildNovelState` (gpu_function, L772), `SigmaFrameCandidateLess` (gpu_function, L236), `SigmaFrameCellAddress` (gpu_function, L129), `SigmaFrameEmptyCandidate` (gpu_function, L200), `SigmaFrameExactEnabled` (gpu_function, L116), `SigmaFrameFullBounds` (gpu_function, L121), `SigmaFrameLoadDepthJoint` (gpu_function, L418), `SigmaFrameLoadMetric` (gpu_function, L140), `SigmaFramePixel` (gpu_function, L134), `SigmaFramePredictionCandidate` (gpu_function, L210), `SigmaFrameProjectDepth` (gpu_function, L174), `SigmaFrameReferenceWorld` (gpu_function, L150), `SigmaFrameSameCandidate` (gpu_function, L254), `SigmaFrameSourceBounds` (gpu_function, L716), `SigmaFrameSourceProvenance` (gpu_function, L747), `SigmaFrameTransformRow` (gpu_function, L758), `if` (gpu_function, L727), `if` (gpu_function, L733), `if` (gpu_function, L876), `BuildDepthSourceCells` (gpu_kernel, L3), `BuildFrameProposals` (gpu_kernel, L2), `BuildRgbSourceCells` (gpu_kernel, L4), `ClearFrameState` (gpu_kernel, L1), `CompactResolvedTargets` (gpu_kernel, L6), `EvaluateCandidateMeets` (gpu_kernel, L5)
...
`BindCarrier` (method, L742), `BindClosureDepth` (method, L583), `BindClosureKernel` (method, L456), `BindEvaluate` (method, L723), `BindExecutionWindow` (method, L936), `BindFootprintWindow` (method, L962), `BindFrameConstants` (method, L598), `BindProposal` (method, L634), `BindPublishKernel` (method, L527), `BindSourceOutputs` (method, L760), `BindSourceRead` (method, L791), `BindSourceReads` (method, L778), `CameraPose` (method, L18), `CeilDiv` (method, L899), `CreateBuffer` (method, L872), `Dispose` (method, L443), `FindKernels` (method, L876), `FromCamera` (method, L14), `Intrinsics` (method, L885), `Packed` (method, L889), `RecordClosureAndPublish` (method, L367), `RecordCompactWindow` (method, L355), `RecordCompactWindow` (method, L907), `RecordDepthSource` (method, L662), `RecordRgbSource` (method, L694), `RecordSourceAndResolve` (method, L248), `RecordWindowChunks` (method, L945), `RequireAlive` (method, L969), `RequireSingleExecutionWindow` (method, L845), `SetFrameMatrices` (method, L809), `SigmaFrameGraph` (class, L129), `SigmaFrameInverseInput` (struct, L36), `SigmaFramePublicationTarget` (struct, L80), `SigmaRoomFrame` (class, L12), `Single` (method, L862), `TryAcquire` (method, L238), `Window` (method, L902)

### `Runtime/SigmaPrism/SigmaFrameResources.cs`

`AdditionalBytesFor` (method, L70), `BufferBytes` (method, L812), `ComputeExecutionWindowFootprints` (method, L634), `ComputeSegmentRecordCapacity` (method, L621), `CreateBuffer` (method, L803), `Dispose` (method, L106), `Dispose` (method, L220), `Dispose` (method, L241), `Dispose` (method, L276), `Dispose` (method, L717), `EstimateSourceBytes` (method, L606), `ExecutionWindow` (method, L659), `FrameSlot` (struct, L849), `Get` (method, L231), `GetSources` (method, L684), `GrowTo` (method, L79), `Lower` (method, L211), `Provenance` (method, L218), `Release` (method, L697), `RequireAlive` (method, L117), `RequireAlive` (method, L797), `RequireSlot` (method, L786), `Retain` (method, L269), `Retain` (method, L690), `Segment` (method, L62), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameExecutionWindow` (struct, L857), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L295), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L131), `SigmaOwnedFrameLease` (class, L250), `TryAcquireFrame` (method, L462), `TryEnsureCandidateCapacity` (method, L521), `TryEnsureClosureCapacity` (method, L560), `TryEnsureDirtyEdgeCapacity` (method, L554), `TryEnsurePendingGaugeCapacity` (method, L551), `TryEnsureRevisionCapacity` (method, L557), `TryGrow` (method, L772), `TryReserve` (method, L783), `UInt4` (method, L815), `Upper` (method, L214), `ValidateGeneratedAbi` (method, L818), `Validity` (method, L216), `WindowBuffer` (method, L669)
...
`ArrayRenderTexture` (method, L773), `AssertMatrix` (method, L930), `AssertPublished` (method, L231), `BuildCpuOracle` (method, L262), `Candidate` (method, L395), `ClearPrediction` (method, L796), `ComposePose` (method, L940), `ConstrainedLaneCount` (method, L365), `Contains` (method, L391), `CurrentPage` (method, L244), `DepthCalibration` (method, L819), `Destroy` (method, L924), `DirectFramePublicationIsAtomicAndLayoutInvariant` (method, L178), `Dispose` (method, L674), `FrameFixture` (class, L406), `Gpu4` (method, L921), `Intrinsics` (method, L724), `NormalizeDepth` (method, L753), `PageMeta` (struct, L43), `PageState` (method, L254), `ProductionFrameDispatchesEveryWindowAndNormalizesTargets` (method, L225), `PublicationSnapshot` (class, L69), `RawDepthTexture` (method, L741), `ReadSnapshot` (method, L697), `RgbCalibration` (method, L850), `RgbTexture` (method, L729), `RoomFrameKeepsCanonicalPoseStableAcrossAnchorCorrection` (method, L81), `Run` (method, L521), `RunPublished` (method, L634), `RunSegmentedTargetFixture` (method, L535), `Set` (method, L865), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L403), `Snapshot` (class, L58), `SourceKey` (method, L377), `UInt2` (struct, L27), `UInt4` (struct, L34), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L112)
