...
Source digest: `001fcfbfb5ac288cb28934588331af8d760ae7a0249c972e370078784fd4558c`
...
`BuildDepthProposals` (gpu_function, L441), `ClassifyDepthFrame` (gpu_function, L326), `ClearInverseFrame` (gpu_function, L304), `CommitDepthProposals` (gpu_function, L534), `CompactActivePages` (gpu_function, L413), `EvaluateDepthMeetFixture` (gpu_function, L693), `EvaluateNullDepthMeetFixture` (gpu_function, L752), `PromoteGaugePage` (gpu_function, L613), `SigmaAppendEvidence` (gpu_function, L278), `SigmaBuildMatchedEyeCell` (gpu_function, L233), `SigmaCaptureDepthRaw` (gpu_function, L127), `SigmaCaptureRgbRaw` (gpu_function, L105), `SigmaDepthWorldPointCandidate` (gpu_function, L192), `SigmaFirstHitSectorForPixel` (gpu_function, L202), `SigmaPackPixel16` (gpu_function, L93), `SigmaPackSourceNibbles` (gpu_function, L262), `SigmaPackUnorm4x8Exact` (gpu_function, L98), `SigmaPredictionHasContact` (gpu_function, L162), `SigmaPredictionMatchesSample` (gpu_function, L217), `SigmaProjectWorldToPixel` (gpu_function, L168), `SigmaWriteProofSample` (gpu_function, L140), `BuildDepthProposals` (gpu_kernel, L4), `ClassifyDepthFrame` (gpu_kernel, L2), `ClearInverseFrame` (gpu_kernel, L1), `CommitDepthProposals` (gpu_kernel, L5), `CompactActivePages` (gpu_kernel, L3), `EvaluateDepthMeetFixture` (gpu_kernel, L7), `EvaluateNullDepthMeetFixture` (gpu_kernel, L8), `PromoteGaugePage` (gpu_kernel, L6)
...
`SigmaAccumulateIndependentKey` (gpu_function, L366), `SigmaBuildJointProposal` (gpu_function, L406), `SigmaBuildRgbCell` (gpu_function, L257), `SigmaBuildRgbMeasurement` (gpu_function, L124), `SigmaJointMeetCoordinate` (gpu_function, L344), `SigmaProjectWorldToRgb` (gpu_function, L96), `SigmaRevalidateJointCandidate` (gpu_function, L377), `SigmaRgbBuildInequality` (gpu_function, L185), `SigmaRgbCalibrationValue` (gpu_function, L38), `SigmaRgbCeilHalfMagnitude` (gpu_function, L53), `SigmaRgbContractInequality` (gpu_function, L220), `SigmaRgbEvaluateRow` (gpu_function, L162), `SigmaRgbLoad` (gpu_function, L113), `SigmaRgbOperator` (gpu_function, L48), `SigmaRgbOperatorAddress` (gpu_function, L43), `SigmaRgbQuantizedComponent` (gpu_function, L62), `SigmaRgbQuantizedDirection` (gpu_function, L72), `SigmaRgbSignedOperator` (gpu_function, L178)
