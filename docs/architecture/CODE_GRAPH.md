...
Source digest: `ca578bdb94ee9b27433471b359274bf296a32bc23c9ddea2f4e2ba715e954495`

Scope: 110 files, 1849 symbols, 1502 functions/methods, 76 GPU kernels, 5 event links.
...
`AddOutward` (method, L880), `AggregateFactorClasses` (method, L982), `CanOmit` (method, L271), `ComputeFingerprint` (method, L386), `ComputeTransferFingerprint` (method, L148), `Contains` (method, L382), `ContractJoint` (method, L788), `ContractNativeQuery` (method, L721), `DeriveIdentityPreservingTransport` (method, L1025), `DivideOutward` (method, L913), `DotPoint` (method, L955), `EmptyOptical` (method, L967), `Equals` (method, L336), `Equals` (method, L342), `Equals` (method, L360), `Equals` (method, L362), `Equals` (method, L451), `Equals` (method, L455), `Equals` (method, L498), `Equals` (method, L506), `EvaluateAndReduce` (method, L663), `EvaluateMerkabaShadow` (method, L625), `EvaluateNativeQuery` (method, L643), `EvaluateNativeRelation` (method, L823), `EvaluateNativeRelation` (method, L828), `FindAnnihilator` (method, L993), `GetHashCode` (method, L344), `GetHashCode` (method, L364), `GetHashCode` (method, L457), `GetHashCode` (method, L508), `Hull` (method, L939), `MultiplyOutward` (method, L892), `Negate` (method, L1017), `NormalizeFactor` (method, L970), `Overlaps` (method, L948), `Point` (method, L965), `ProvenStrictlyBefore` (method, L951), `ReduceNativeQuery` (method, L673), `RequireForwardExpression` (method, L1037), `RequireIntrinsicRelationExpression` (method, L1067), `RequireReverseExpression` (method, L1053), `SameGaugeCell` (method, L1032), `SelectNativeQuerySupport` (method, L616), `SigmaMerkabaSemanticOracle` (class, L605), `SigmaNativeContractBranch` (struct, L535), `SigmaNativeContractResult` (class, L578), `SigmaNativeContribution` (struct, L282), `SigmaNativeDeltaWitness` (struct, L347), `SigmaNativeNearSingularLaw` (struct, L366), `SigmaNativeOracleCell` (struct, L214), `SigmaNativeOracleQuery` (class, L162), `SigmaNativeOracleResolution` (enum, L10), `SigmaNativePhotometricChannelLaw` (class, L39), `SigmaNativePhotometricLaw` (class, L84), `SigmaNativePhotometricSegment` (struct, L17), `SigmaNativePreimageCandidate` (struct, L511), `SigmaNativeQuerySupportSummary` (struct, L248), `SigmaNativeRelationFactor` (struct, L429), `SigmaNativeRelationInput` (struct, L396), `SigmaNativeRelationWitness` (struct, L460), `SigmaNativeSceneShadow` (struct, L309), `SubtractOutward` (method, L886), `SumOutward` (method, L935), `SummarizeCell` (method, L607), `TryApply` (method, L115)

### `Tests/Editor/SigmaNativeOracleTests.cs`

`AssertGpuRelationsMatchCpu` (method, L1095), `AssertGpuShadowEqual` (method, L1607), `AssertGpuShadowMatchesCpu` (method, L1621), `Axis` (method, L1452), `BuildPhotometricQuery` (method, L1369), `Candidate` (method, L1320), `Cell` (method, L1339), `CpuCandidate` (method, L1326), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L176), `EntryPointIndex` (method, L1603), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L1186), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L229), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L425), `Factor` (method, L1459), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L298), `GetHashCode` (method, L39), `GpuShadow` (class, L41), `HashS16` (method, L1569), `Kernels` (method, L465), `Law` (method, L1401), `LeftQuery` (method, L1346), `LoadShader` (method, L1633), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L459), `Pack` (method, L1591), `PackGaugeCoordinate` (method, L1480), `PackGaugeMetadata` (method, L1488), `PackInterval` (method, L1520), `PackKeys` (method, L1472), `PackPhotometricLaw` (method, L1528), `PackRelationPlan` (method, L1506), `PackRows` (method, L1584), `PackStates` (method, L1588), `PiecewiseLaw` (method, L1423), `Point` (method, L1455), `Query` (method, L1358), `Raw` (method, L1457), `ReduceWindows` (method, L1288), `RelationFor` (method, L1334), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L112), `RightQuery` (method, L1352), `RunGpuContractOverflow` (method, L788), `RunGpuQuery` (method, L1204), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L387), `State` (method, L1343), `Summary` (method, L1463), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L1597), `UnpackKey` (method, L1600), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L653), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L599), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L496), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L732), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L65)
