...
Source digest: `a3d3e68c16c73dae59a5ae287071ac5c477acae0e5d25037c498e7816a023dc6`

Scope: 110 files, 1868 symbols, 1517 functions/methods, 76 GPU kernels, 5 event links.
...
`AuthorityBoundaryAndExecutableIrAreFrozen` (method, L24), `Buffer` (method, L553), `CertificateMinimizerIsExactBoundedAndCouplingAware` (method, L323), `DirectionalActionCarriesIntervalsAndStopsAtFirstHit` (method, L260), `ExactZeroDivisorAndOneLsbResidualDoNotAlias` (method, L416), `Factor` (method, L524), `GaugeSplitTransportCollapseAndNormalizationAreConstructive` (method, L353), `GeneratedHlslMatchesCpuTablesIrAndDirectionalAction` (method, L441), `GeneratedReverseDescriptorsRetainZeroBranchesAndSceneDisjunction` (method, L287), `Permutations` (method, L530), `Permute` (method, L538), `QuerySupportSummaryMatchesIndependentExhaustiveEvaluation` (method, L226), `ShadowKernelDefaultAndExactFactorClassesFailClosed` (method, L172), `SigmaMerkabaProgramTests` (class, L12), `SignedXorAssociatorDiffractionMetricAndHolonomyAreExact` (method, L104), `UInt4` (struct, L15)
...
`SigmaCertificateFactor` (struct, L1847), `SigmaDefaultBackingKind` (enum, L1765), `SigmaDirectionalActionWitness` (struct, L1829), `SigmaExactFactorClass` (enum, L1758), `SigmaFrameUInt2Gpu` (struct, L2835), `SigmaFrameUInt4Gpu` (struct, L2842), `SigmaGaugeCell` (struct, L1877), `SigmaGeneratedAlgebra` (class, L1518), `SigmaGeneratedFrame` (class, L2853), `SigmaGeneratedMerkabaProgram` (class, L1893), `SigmaMerkabaDirectionalActionWitness` (struct, L2550), `SigmaMerkabaEntryPoint` (struct, L1815), `SigmaMerkabaExpression` (struct, L1795), `SigmaMerkabaIrNode` (struct, L1772), `SigmaMerkabaIrOpcode` (enum, L1726), `SigmaMerkabaRelationClass` (enum, L1740), `SigmaMerkabaReverseRule` (enum, L1735), `SigmaMerkabaValueKind` (enum, L1730), `SigmaMinimizedFactor` (struct, L1869), `SigmaNativeQueryClaim` (enum, L1751), `action_expression` (function, L448), `add_expression` (function, L321), `add_node` (function, L304), `associator_expression` (function, L351), `basis_product` (function, L129), `build_descriptor` (function, L1287), `build_executable_merkaba_ir` (function, L261), `build_merkaba_descriptor` (function, L1022), `certificate_minimizer_proof` (function, L855), `check_or_write` (function, L2914), `chunks` (function, L1489), `collapse_once` (function, L926), `conjugate_sign` (function, L146), `cs_array` (function, L1494), `default_representation_proof` (function, L768), `diffraction_expression` (function, L367), `diffraction_matrix` (function, L191), `dyads` (function, L154), `evaluate_actual_associator` (function, L637), `file_sha256` (function, L179), `fingerprint_words` (function, L1578), `frame_abi_descriptor` (function, L2761), `gauge_expression` (function, L479), `gauge_transport_proof` (function, L913), `hadamard_sign` (function, L150), `information_metric` (function, L242), `input_s16` (function, L342), `interpret_forward` (function, L789), `interval_add` (function, L557), `interval_mul` (function, L552), `interval_sub` (function, L560), `MerkabaDirectionalActionParity` (gpu_kernel, L2616), `MerkabaMatrixAndIrParity` (gpu_kernel, L2615), `MerkabaProgramParity` (gpu_kernel, L2614), `link_factor_expression` (function, L373), `main` (function, L2927), `matrix_multiply` (function, L234), `merkaba_shadow_numerator` (function, L206), `minimize` (function, L865), `multiply_dyads` (function, L162), `multiply_s16` (function, L624), `normalize` (function, L941), `normalized_associator_expression` (function, L391), `optical_expression` (function, L461), `plaquette_expression` (function, L405), `query_support_exhaustive_proof` (function, L708), `read_json` (function, L183), `render_authority_manifest` (function, L2688), `render_cs` (function, L1503), `render_frame_cs` (function, L2786), `render_frame_hlsl` (function, L2869), `render_hlsl` (function, L1621), `render_hlsl_layout` (function, L1582), `render_merkaba_cs` (function, L1678), `render_merkaba_fixture` (function, L2609), `render_merkaba_hlsl` (function, L2413), `reverse_complete_tree_proof` (function, L545), `reverse_expression` (function, L437), `reverse_mul` (function, L563), `sha256` (function, L174), `shadow_expression` (function, L421), `signed_morton` (function, L212), `split` (function, L921), `transpose` (function, L230), `uint_array` (function, L2746), `upper_snake` (function, L2750), `validate_descriptor` (function, L1463), `zig_zag` (function, L216)
