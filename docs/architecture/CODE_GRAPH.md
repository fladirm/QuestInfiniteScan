...
Source digest: `3b50cb77080d0941564df6c8aea168e2cf17d5834c2195b201238231161fb362`

Scope: 116 files, 1669 symbols, 1370 functions/methods, 70 GPU kernels, 6 event links.
...
- `SigmaRenderer.PredictionReady` → `OnPredictionReady` ([Runtime/SigmaPrism/SigmaInverseController.cs:212](../../Runtime/SigmaPrism/SigmaInverseController.cs#L212))
...
`BuildCarrierReadout` (gpu_function, L38), `CompactCurrentPages` (gpu_function, L80), `ResolveCarrierHalos` (gpu_function, L138), `SigmaReadoutI64Equal` (gpu_function, L120), `SigmaReadoutIncrementI64` (gpu_function, L125), `SigmaReadoutIndex` (gpu_function, L33), `BuildCarrierReadout` (gpu_kernel, L1), `CompactCurrentPages` (gpu_kernel, L2), `ResolveCarrierHalos` (gpu_kernel, L3)
...
`ClearInverseWorkGraph` (gpu_function, L98), `CommitInverseTransactions` (gpu_function, L372), `CompactInverseWork` (gpu_function, L126), `PlanRawReservations` (gpu_function, L289), `PrepareInverseTransactions` (gpu_function, L224), `SigmaCompactMorton` (gpu_function, L70), `SigmaPairFree` (gpu_function, L88), `SigmaSignedMortonLimb` (gpu_function, L81), `SigmaWorkNullLane` (gpu_function, L59), `ClearInverseWorkGraph` (gpu_kernel, L1), `CommitInverseTransactions` (gpu_kernel, L5), `CompactInverseWork` (gpu_kernel, L2), `PlanRawReservations` (gpu_kernel, L4), `PrepareInverseTransactions` (gpu_kernel, L3)
...
`AbsNanoseconds` (method, L1153), `AdvanceAge` (method, L1596), `BindExactCommon` (method, L865), `BindFrameConstants` (method, L932), `BindGaugeDemand` (method, L786), `BindInverseMutation` (method, L805), `BindInverseWork` (method, L856), `BindLedger` (method, L762), `BindWorkGraph` (method, L730), `BuildTrackingPriorEnvelope` (method, L1081), `CeilDiv` (method, L1455), `CreateArrayTexture` (method, L1472), `CreateBuffer` (method, L1465), `CreateIndirectBuffer` (method, L1469), `CreatePersistentResources` (method, L1330), `DestroyTexture` (method, L1502), `Dispose` (method, L1599), `EnsureBlockBuffers` (method, L1185), `EnsureCalibration` (method, L1159), `EnsureFrameResources` (method, L1171), `EnsurePosePartials` (method, L1198), `FillCalibration` (method, L1218), `FillRgbCalibration` (method, L1254), `FindKernels` (method, L1297), `FromRaw` (method, L1576), `GpuResident` (method, L1632), `GpuSubmission` (class, L1579), `IndependenceKey` (method, L1430), `IntrinsicsVector` (method, L1427), `LateUpdate` (method, L252), `MaxRigRotationResidual` (method, L1140), `MaxRigTranslationResidual` (method, L1127), `Mix` (method, L1450), `NextPowerOfTwo` (method, L1458), `NextRevision` (method, L1407), `OnDestroy` (method, L1513), `OnModuleInitialize` (method, L169), `OnPredictionReady` (method, L239), `OnScanStarted` (method, L217), `OnScanStopped` (method, L230), `Poll` (method, L1597), `PoseMatrix` (method, L1424), `RecordClearAndClassify` (method, L407), `RecordCorrectedCalibration` (method, L1054), `RecordGaugePromote` (method, L554), `RecordMatchedSolve` (method, L543), `RecordNormalize` (method, L963), `RecordPerformanceCounters` (method, L710), `RecordPoseGauge` (method, L985), `RecordPrepareTransactions` (method, L495), `RecordProofClear` (method, L502), `RecordProofCommit` (method, L689), `RecordProofGaugeDemand` (method, L663), `RecordProofRawCommit` (method, L633), `RecordProofReduce` (method, L585), `RecordRawPlan` (method, L565), `RecordRgbSource` (method, L519), `RecordWorkCompaction` (method, L471), `SaturatingAdd` (method, L1156), `SetFrameMatrices` (method, L1270), `SetQ` (method, L1415), `SetQRaw` (method, L1418), `SetRgbQ` (method, L1420), `SetRgbQRaw` (method, L1422), `SigmaInverseController` (class, L22), `SigmaInverseDiagnosticSnapshot` (struct, L1608), `SigmaPackedQ48` (struct, L1567), `SubmitGpuGraph` (method, L304), `UploadExactCalibration` (method, L1208)
...
`SigmaGeneratedAlgebra` (class, L299), `basis_product` (function, L28), `build_descriptor` (function, L78), `check_or_write` (function, L459), `chunks` (function, L270), `conjugate_sign` (function, L45), `cs_array` (function, L275), `dyads` (function, L53), `fingerprint_words` (function, L359), `hadamard_sign` (function, L49), `main` (function, L472), `multiply_dyads` (function, L61), `render_cs` (function, L284), `render_hlsl` (function, L402), `render_hlsl_layout` (function, L363), `sha256` (function, L73), `validate_descriptor` (function, L244)
