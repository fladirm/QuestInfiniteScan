...
Source digest: `258896377c051527974f155a28adb7d938613443c6303a7e9685ed8dadbd9a27`

Scope: 132 files, 2095 symbols, 1682 functions/methods, 112 GPU kernels, 6 event links.
...
`CoalesceProofWindow` (gpu_function, L965), `CompleteProofBlock` (gpu_function, L1642), `EmitProofCertificates` (gpu_function, L1486), `EvaluateProofRedundancyWindow` (gpu_function, L1310), `MergeProofRuns` (gpu_function, L872), `PrepareProofOrder` (gpu_function, L812), `PrepareProofRedundancy` (gpu_function, L1075), `ReduceTransactionSourceBlock` (gpu_function, L529), `RetainProofRawWindow` (gpu_function, L1572), `SigmaProofAdvanceSourceCursor` (gpu_function, L204), `SigmaProofAtomicAddDegree` (gpu_function, L159), `SigmaProofCandidateBound` (gpu_function, L103), `SigmaProofCandidateBoundAddress` (gpu_function, L93), `SigmaProofCandidateBoundRead` (gpu_function, L109), `SigmaProofCandidateLess` (gpu_function, L656), `SigmaProofDegree` (gpu_function, L135), `SigmaProofFailTransaction` (gpu_function, L1045), `SigmaProofFinishRedundancyRank` (gpu_function, L1054), `SigmaProofFullBounds` (gpu_function, L85), `SigmaProofIndependentEdge` (gpu_function, L744), `SigmaProofKept` (gpu_function, L722), `SigmaProofKeptRead` (gpu_function, L728), `SigmaProofLoadCurrentSource` (gpu_function, L182), `SigmaProofLoadPrior` (gpu_function, L305), `SigmaProofLoadReadWork` (gpu_function, L782), `SigmaProofLoadWork` (gpu_function, L756), `SigmaProofMergeCandidate` (gpu_function, L924), `SigmaProofPrefixBound` (gpu_function, L122), `SigmaProofPrefixBoundAddress` (gpu_function, L98), `SigmaProofPrepareReduceGroup` (gpu_function, L483), `SigmaProofReduceSource` (gpu_function, L344), `SigmaProofResetSweepScratch` (gpu_function, L1018), `SigmaProofSameKey` (gpu_function, L693), `SigmaProofSetCandidateBound` (gpu_function, L115), `SigmaProofSetKept` (gpu_function, L734), `SigmaProofSetPrefixBound` (gpu_function, L128), `SigmaProofSetSampleBit` (gpu_function, L234), `SigmaProofSetSortedIndex` (gpu_function, L714), `SigmaProofSortedIndex` (gpu_function, L702), `SigmaProofSortedIndexRead` (gpu_function, L708), `SigmaProofSourceCell` (gpu_function, L242), `SigmaProofSourceSlot` (gpu_function, L291), `if` (gpu_function, L1285), `CoalesceProofWindow` (gpu_kernel, L4), `CompleteProofBlock` (gpu_kernel, L9), `EmitProofCertificates` (gpu_kernel, L7), `EvaluateProofRedundancyWindow` (gpu_kernel, L6), `MergeProofRuns` (gpu_kernel, L3), `PrepareProofOrder` (gpu_kernel, L2), `PrepareProofRedundancy` (gpu_kernel, L5), `ReduceTransactionSourceBlock` (gpu_kernel, L1), `RetainProofRawWindow` (gpu_kernel, L8)
