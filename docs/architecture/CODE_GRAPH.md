...
Source digest: `f3cc870728322919e897e3042d3a232e268bc7b89cd2f96fa2f3998fcfff5445`

Scope: 132 files, 2080 symbols, 1671 functions/methods, 108 GPU kernels, 6 event links.
...
`EvaluateTransactionMicrotile` (gpu_function, L589), `SigmaEvalAccumulateKey` (gpu_function, L261), `SigmaEvalBuildBootstrap` (gpu_function, L301), `SigmaEvalButterflyStage` (gpu_function, L179), `SigmaEvalFullBounds` (gpu_function, L293), `SigmaEvalHadamard` (gpu_function, L204), `SigmaEvalMeet` (gpu_function, L271), `SigmaEvalPrepareGroup` (gpu_function, L531), `SigmaEvalReduceValidity` (gpu_function, L244), `SigmaEvalRgbEye` (gpu_function, L352), `SigmaStreamAssociationContact` (gpu_function, L157), `SigmaStreamAssociationEye` (gpu_function, L136), `SigmaStreamAssociationMatchesTarget` (gpu_function, L171), `SigmaStreamAssociationSame` (gpu_function, L163), `SigmaStreamCombineOutcome` (gpu_function, L122), `SigmaStreamJointAddress` (gpu_function, L89), `SigmaStreamLoadCurrentBundle` (gpu_function, L101), `SigmaStreamNullLane` (gpu_function, L78), `SigmaStreamSampleAddress` (gpu_function, L96), `if` (gpu_function, L849), `EvaluateTransactionMicrotile` (gpu_kernel, L1)
...
`BindBundleSource` (method, L482), `BindClearIngress` (method, L360), `BindCompactIngress` (method, L369), `BindDerived` (method, L706), `BindDormant` (method, L738), `BindFinalizeBundles` (method, L410), `BindInitializeGraph` (method, L335), `BindInitializeOwnership` (method, L350), `BindInitializeVisibility` (method, L692), `BindInverse` (method, L534), `BindPreparePages` (method, L461), `BindProof` (method, L577), `BindPublication` (method, L787), `BindReleaseProbation` (method, L454), `BindSchedule` (method, L419), `BindScheduleDiagnostics` (method, L443), `BindTransition` (method, L648), `CeilDiv` (method, L907), `DispatchIndirect` (method, L830), `Intrinsics` (method, L903), `PoseMatrix` (method, L900), `RecordCanonicalQuantum` (method, L247), `RecordDerivedQuantum` (method, L324), `RecordIngress` (method, L198), `RecordInitialize` (method, L186), `RequireCommand` (method, L870), `RequireShader` (method, L862), `Set` (method, L876), `SetFrameMatrices` (method, L837), `SetInt` (method, L892), `SetTexture` (method, L884), `SetUInt` (method, L896), `SigmaStreamingGraph` (class, L12)

### `Runtime/SigmaPrism/SigmaStreamingResources.cs`

`BufferBytes` (method, L327), `CreateStructured` (method, L306), `Dispose` (method, L338), `DisposeBuffer` (method, L409), `SigmaStreamingResources` (class, L14), `SumBytes` (method, L330), `ValidateBinding` (method, L314), `ValidateGeneratedAbi` (method, L255), `ValidateTransientBudget` (method, L243)
...
`AssertProofEqual` (method, L610), `Bind` (method, L641), `Bounds` (method, L630), `BoundsEqual` (method, L596), `BoundsGpu` (struct, L39), `BuildPartitionedProofEvidence` (method, L497), `CloseProof` (method, L549), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L133), `MeetCertificates` (method, L555), `PageMetadataGpu` (struct, L15), `ProofCertificate` (method, L537), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L303), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L329), `ReplayWindows` (method, L568), `SigmaStreamingContractTests` (class, L10), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L46), `U4` (method, L625), `UInt2Gpu` (struct, L32)
