...
Source digest: `563b67eae6ea42fd1fb80817034145a74859ff3b9eb58562372b5508b145e4ff`

Scope: 108 files, 1575 symbols, 1293 functions/methods, 59 GPU kernels, 5 event links.
...
- `SigmaRenderer.PredictionReady` → `OnPredictionReady` ([Runtime/SigmaPrism/SigmaInverseController.cs:210](../../Runtime/SigmaPrism/SigmaInverseController.cs#L210))
...
`ClassifyDepthFrame` (gpu_function, L321), `ClearInverseFrame` (gpu_function, L302), `EvaluateDepthMeetFixture` (gpu_function, L629), `EvaluateNullDepthMeetFixture` (gpu_function, L688), `PromoteGaugePage` (gpu_function, L549), `SigmaAppendEvidence` (gpu_function, L276), `SigmaBuildMatchedEyeCell` (gpu_function, L221), `SigmaCaptureDepthRaw` (gpu_function, L115), `SigmaCaptureRgbRaw` (gpu_function, L93), `SigmaDepthWorldPointCandidate` (gpu_function, L180), `SigmaFirstHitSectorForPixel` (gpu_function, L190), `SigmaPackPixel16` (gpu_function, L81), `SigmaPackSourceNibbles` (gpu_function, L250), `SigmaPackUnorm4x8Exact` (gpu_function, L86), `SigmaPredictionHasContact` (gpu_function, L150), `SigmaPredictionMatchesSample` (gpu_function, L205), `SigmaProjectWorldToPixel` (gpu_function, L156), `SigmaWriteProofSample` (gpu_function, L128), `SolveAndCommitPage` (gpu_function, L408), `ClassifyDepthFrame` (gpu_kernel, L2), `ClearInverseFrame` (gpu_kernel, L1), `EvaluateDepthMeetFixture` (gpu_kernel, L5), `EvaluateNullDepthMeetFixture` (gpu_kernel, L6), `PromoteGaugePage` (gpu_kernel, L4), `SolveAndCommitPage` (gpu_kernel, L3)
...
`BuildRgbSourceCells` (gpu_function, L114), `SigmaApplyRgbConstraintPriorLane` (gpu_function, L19), `SigmaRgbCombineLaneValidity` (gpu_function, L100), `SigmaRgbPhaseSample` (gpu_function, L92), `BuildRgbSourceCells` (gpu_kernel, L1)
...
`Bind` (method, L94), `Dispatch` (method, L51), `Dispose` (method, L102), `RequestDiagnosticStatus` (method, L68), `SigmaExactBackendGate` (class, L22), `SigmaExactBackendGateStatus` (enum, L8)
...
`AbortGaugeWrites` (method, L2298), `AbortMatchedWrites` (method, L2288), `AbortPendingWrites` (method, L2308), `AddTopologyRebuild` (method, L972), `BeginCarrierInverse` (method, L411), `BeginGaugePageCommits` (method, L1015), `BeginGaugeReadback` (method, L2274), `BeginInitialReadbacks` (method, L2226), `BeginInverse` (method, L264), `BeginLocalGaugeRequest` (method, L2250), `BeginLocalGaugeTransaction` (method, L2260), `BeginMatchedPageCommits` (method, L755), `BeginMatchedProofReadback` (method, L2238), `BindCommonInverseInputs` (method, L1326), `BindFrameInputs` (method, L1247), `BindFrameTextures` (method, L1300), `BindPromotion` (method, L1087), `BindRgbSourcePage` (method, L845), `BuildTopologyEvidenceMap` (method, L331), `CeilDiv` (method, L1765), `CompactMorton` (method, L1675), `CompareTo` (method, L1930), `CompleteGaugePromotions` (method, L665), `CompleteInFlight` (method, L349), `CompleteInitialReadback` (method, L440), `CompleteLocalGaugeRequest` (method, L539), `CompleteLocalGaugeTransaction` (method, L608), `CompleteMatchedProofs` (method, L458), `CompletePoseGauge` (method, L388), `ContinueAfterMatched` (method, L519), `ContinueWithLatentPromotions` (method, L651), `CreateArrayTexture` (method, L1732), `CreateBuffer` (method, L1761), `DestroyTexture` (method, L1776), `DetachOwnedResources` (method, L1814), `DetermineNextRevision` (method, L1689), `Dispose` (method, L1969), `Dispose` (method, L2014), `Dispose` (method, L2316), `EnsureCalibration` (method, L1365), `EnsureFlagBuffers` (method, L1390), `EnsureFrameResources` (method, L1376), `EnsurePosePartials` (method, L1211), `EnsureSegmentScratch` (method, L1411), `Equals` (method, L1935), `Equals` (method, L1936), `FillCalibration` (method, L1466), `FillRgbCalibration` (method, L1450), `FindFreeGaugeOrigin` (method, L1587), `FinishFrame` (method, L735), `From` (method, L2354), `FromRaw` (method, L1869), `GaugeImagePage` (struct, L1918), `GaugePose` (method, L1573), `GaugeRegionIsFree` (method, L1653), `GaugeTouchesResidentTransverseNeighbour` (method, L586), `GetHashCode` (method, L1938), `GlobalPageIndex` (method, L1727), `Id` (method, L1730), `InFlightFrame` (class, L2122), `InFlightPhase` (enum, L2112), `IndependenceKey` (method, L1698), `IntrinsicsVector` (method, L1583), `InverseOwnedResources` (class, L1976), `LateUpdate` (method, L241), `Matches` (method, L1964), `Mix` (method, L1718), `NextPowerOfTwo` (method, L1768), `OnCompleted` (method, L2094), `OnDestroy` (method, L1787), `OnModuleInitialize` (method, L127), `OnPredictionReady` (method, L228), `OnScanStarted` (method, L213), `OnScanStopped` (method, L219), `PendingGaugePublication` (struct, L1873), `PendingGaugeWrite` (struct, L1906), `PendingMatchedPublication` (struct, L1891), `PoseMatrix` (method, L1580), `ReadbackRetirementLatch` (class, L2047), `RebuildAffectedTopology` (method, L926), `RebuildTopologyCoordinates` (method, L951), `RecordClear` (method, L1221), `RecordNormalize` (method, L1110), `RecordPoseGauge` (method, L1132), `ReplacePrediction` (method, L2217), `Request` (method, L2052), `Request` (method, L2055), `ResolveTopologyEvidence` (method, L982), `RetireWhenComplete` (method, L2076), `RetireWhenReadbacksComplete` (method, L2285), `SegmentInverseScratch` (class, L1940), `SetFrameMatrices` (method, L1515), `SetFrameMatrices` (method, L1546), `SetQ` (method, L1503), `SetQRaw` (method, L1506), `SetRgbQ` (method, L1509), `SetRgbQRaw` (method, L1512), `SigmaInverseController` (class, L23), `SigmaInverseDiagnosticSnapshot` (struct, L2326), `SigmaPackedQ48` (struct, L1859), `SignedMortonCoordinate` (method, L1667), `TryFindAdjacentGaugeOrigin` (method, L1606), `TryOffset` (method, L999), `UpdateObservedTopologyPages` (method, L894), `UploadExactCalibration` (method, L1435), `Value` (method, L2361), `ZigZagDecode` (method, L1686)
...
`AccumulateEvidencePage` (method, L371), `BindEvidence` (method, L625), `BindEvidenceView` (method, L635), `BindPageState` (method, L650), `BindTopologyNeighbours` (method, L675), `BuildGeneration` (method, L293), `BuildPage` (method, L438), `CeilDiv` (method, L807), `ClearPage` (method, L746), `CopyPrior` (method, L732), `CreateBuffer` (method, L803), `CreateSegmentCache` (method, L761), `Dispose` (method, L885), `EnsureSegmentViews` (method, L254), `FinishGaugeGeneration` (method, L340), `FullStereo` (method, L52), `GaugeRebuild` (method, L58), `Matches` (method, L880), `MergeEvidenceIdentity` (method, L600), `OnDestroy` (method, L817), `OnModuleInitialize` (method, L187), `OnScanStarted` (method, L251), `OnScanStopped` (method, L253), `PrepareGaugeGeneration` (method, L318), `Proposals` (method, L35), `Publish` (method, L96), `PublishBuiltGeneration` (method, L430), `RebuildCurrent` (method, L350), `RequireInitialized` (method, L810), `ResolveEvidenceIdentity` (method, L582), `ResolveNeighbour` (method, L701), `SetUInt` (method, L784), `SigmaTopologyBuildToken` (struct, L83), `SigmaTopologyController` (class, L135), `SigmaTopologyEvidenceView` (struct, L7), `SigmaTopologyGaugeBinding` (struct, L104), `SigmaTopologySegmentView` (struct, L63), `TopologySegmentCache` (class, L847), `TryGetCurrentTopology` (method, L718), `TryGetSegmentView` (method, L280), `TryOffset` (method, L787), `ValidateEvidenceCoordinate` (method, L572)
...
`Awake` (method, L36), `Bind` (method, L109), `DebugMenuController` (class, L9), `Hide` (method, L84), `OnEnable` (method, L43), `Query` (method, L91), `RefreshStatus` (method, L119), `Set` (method, L224), `SetStatus` (method, L230), `Show` (method, L76), `StatusKind` (enum, L252), `Toggle` (method, L70), `Update` (method, L56)
