...
Source digest: `a55f1659da663ac86c6918627215c507cf6aa18e34239b08b152fbecf08a5bb9`

Scope: 103 files, 1986 symbols, 1663 functions/methods, 37 GPU kernels, 5 event links.
...
`BindPublication` (method, L2829), `BuildLocalityCertificate` (method, L2649), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L181), `CanonicalSeedPreservesGlobalCloseUnresolvedReceipt` (method, L694), `CertificateDifference` (method, L3101), `CertifiedConstraintRecord` (method, L3012), `CompactedBoundaryOrderIsExecutionOnlyAcrossAllResults` (method, L589), `Compare` (method, L3846), `CompletionClassificationRejectsWrongNonzeroGpuRevision` (method, L2126), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L2100), `ConstraintRecord` (method, L2982), `Count` (method, L2775), `CutEUsesDirectedWitnessWhenD4CellStreamsTie` (method, L2391), `DirectionModeMask` (method, L3082), `DispatchCutE` (method, L2784), `Equals` (method, L3834), `Equals` (method, L3837), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1845), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1623), `FindGaugeSample` (method, L3552), `Flatten` (method, L3596), `Flatten` (method, L3607), `From` (method, L3828), `FullFrameLinearDispatchGridIsQuestLegalAndBijective` (method, L100), `GaugeKey` (struct, L3807), `GaugeKeyComparer` (class, L3842), `GetHashCode` (method, L3839), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L1919), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L141), `LoadShader` (method, L2547), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L1953), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L2020), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1887), `Packed` (method, L3620), `PackedInterval` (method, L3626), `PageMeta` (struct, L3899), `PersistAndReload` (method, L3070), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1733), `PrepareRefinementScratch` (method, L3401), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L376), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L1084), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L733), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1406), `Q2` (method, L3677), `Q4` (method, L3093), `ReadAssetSource` (method, L3695), `ReadCertificate` (method, L3584), `ReadPageMeta` (method, L3544), `ReadState` (method, L3574), `RefinementAtFullPageBoundarySpillsIntoNextLogicalPage` (method, L2271), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L2181), `RefinementMultiplicityAndParentMeetArePermutationInvariant` (method, L2223), `RefinementSnapshot` (class, L3761), `RefinementStep` (struct, L3746), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L2066), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L2146), `RunRefinementSequence` (method, L3113), `RunStaticExclusion` (method, L2683), `ScatterConsumesMutationCountInsteadOfResidentWorldExtent` (method, L1512), `SeedBoundaryWorklist` (method, L3653), `SeedSingleFootprintClosedCutE` (method, L2560), `SetEqualCertificates` (method, L2959), `SetValidNextCertificate` (method, L2942), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L3859), `StateWithLane0` (method, L2676), `StaticExclusionSnapshot` (class, L3783), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1713), `ToRaw` (method, L3820), `ToString` (method, L3840), `U4` (method, L3683), `UInt2` (struct, L3883), `UInt2Buffer` (method, L3689), `UInt4` (struct, L3890), `UInt4Buffer` (method, L3692), `UIntBuffer` (method, L3686), `WriteEnvelope` (method, L3642), `WriteRepresentationCell` (method, L3505), `WriteState` (method, L3634), `ZeroArrayRenderTexture` (method, L3702), `ZeroRenderTexture` (method, L3727)
