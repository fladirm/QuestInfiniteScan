...
Source digest: `0137261ab6af40bca86ca9d8c7c9833a6f845bebf5556f91cb5a652c323bcec4`

Scope: 103 files, 1685 symbols, 1371 functions/methods, 30 GPU kernels, 5 event links.
...
`AssertFreshGpuMatchesCpu` (method, L2002), `AssertGpuRelationsMatchCpu` (method, L2333), `AssertGpuShadowEqual` (method, L3161), `AssertGpuShadowMatchesCpu` (method, L3181), `Axis` (method, L2980), `BuildPhotometricQuery` (method, L2897), `Candidate` (method, L2728), `Cell` (method, L2747), `CpuCandidate` (method, L2734), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L353), `EmptyOptical` (method, L2985), `EntryPointIndex` (method, L3153), `EntryPointIndex` (method, L3157), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L2441), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L480), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L676), `Factor` (method, L2989), `FreshBaseAdmissionStartsAtCoherentObservationAndMatchesVulkan` (method, L210), `FreshContractMarksOnlyExactStereoPreHitForStaticExclusion` (method, L406), `FreshObservation` (method, L2765), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L549), `GetHashCode` (method, L39), `GpuFreshAdmission` (class, L72), `GpuShadow` (class, L41), `HashS16` (method, L3099), `Kernels` (method, L736), `Law` (method, L2929), `LeftQuery` (method, L2871), `LoadShader` (method, L3198), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L718), `Pack` (method, L3121), `PackGaugeCoordinate` (method, L3010), `PackGaugeMetadata` (method, L3018), `PackInstrumentCodes` (method, L2864), `PackInterval` (method, L3050), `PackKeys` (method, L3002), `PackPhotometricLaw` (method, L3058), `PackRelationPlan` (method, L3036), `PackRows` (method, L3114), `PackStates` (method, L3118), `PackU256` (method, L3127), `PiecewiseLaw` (method, L2951), `Point` (method, L2983), `Query` (method, L2883), `Raw` (method, L2987), `ReduceWindows` (method, L2696), `RelationFor` (method, L2742), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L146), `RightQuery` (method, L2877), `RunGpuContractOverflow` (method, L2017), `RunGpuEyePair` (method, L2467), `RunGpuFreshAdmission` (method, L1817), `RunGpuQuery` (method, L2459), `RunGpuQuerySet` (method, L2474), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L638), `State` (method, L2751), `StateRaw` (method, L2754), `Summary` (method, L2993), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L3147), `UnpackKey` (method, L3150), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L1532), `VulkanConstructiveStitchSetMatchesGeneratedCpuAuthority` (method, L791), `VulkanExportDebugAndEyePairExecuteDistinctGeneratedSemantics` (method, L1601), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L1484), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L1389), `VulkanReducerHandlesMoreThan64AndSignalsBoundedColdContinuation` (method, L1684), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L1733), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L99)
