...
Source digest: `4c43336761803d8a900e98d59bd73eceebba9d28ad88ea62d57ef83cb06b81df`
...
`AssertFreshGpuMatchesCpu` (method, L1875), `AssertGpuRelationsMatchCpu` (method, L2206), `AssertGpuShadowEqual` (method, L3034), `AssertGpuShadowMatchesCpu` (method, L3054), `Axis` (method, L2853), `BuildPhotometricQuery` (method, L2770), `Candidate` (method, L2601), `Cell` (method, L2620), `CpuCandidate` (method, L2607), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L353), `EmptyOptical` (method, L2858), `EntryPointIndex` (method, L3026), `EntryPointIndex` (method, L3030), `Equals` (method, L35), `Equals` (method, L37), `EvaluateRelationWindows` (method, L2314), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L480), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L676), `Factor` (method, L2862), `FreshBaseAdmissionStartsAtCoherentObservationAndMatchesVulkan` (method, L210), `FreshContractMarksOnlyExactStereoPreHitForStaticExclusion` (method, L406), `FreshObservation` (method, L2638), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L549), `GetHashCode` (method, L39), `GpuFreshAdmission` (class, L72), `GpuShadow` (class, L41), `HashS16` (method, L2972), `Kernels` (method, L736), `Law` (method, L2802), `LeftQuery` (method, L2744), `LoadShader` (method, L3071), `OracleGpuGraphIsFixedParallelAndCardinalityInvariant` (method, L718), `Pack` (method, L2994), `PackGaugeCoordinate` (method, L2883), `PackGaugeMetadata` (method, L2891), `PackInstrumentCodes` (method, L2737), `PackInterval` (method, L2923), `PackKeys` (method, L2875), `PackPhotometricLaw` (method, L2931), `PackRelationPlan` (method, L2909), `PackRows` (method, L2987), `PackStates` (method, L2991), `PackU256` (method, L3000), `PiecewiseLaw` (method, L2824), `Point` (method, L2856), `Query` (method, L2756), `Raw` (method, L2860), `ReduceWindows` (method, L2569), `RelationFor` (method, L2615), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L146), `RightQuery` (method, L2750), `RunGpuContractOverflow` (method, L1890), `RunGpuEyePair` (method, L2340), `RunGpuFreshAdmission` (method, L1690), `RunGpuQuery` (method, L2332), `RunGpuQuerySet` (method, L2347), `SigmaNativeOracleTests` (class, L14), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L638), `State` (method, L2624), `StateRaw` (method, L2627), `Summary` (method, L2866), `UInt2` (struct, L22), `UInt4` (struct, L29), `Unpack` (method, L3020), `UnpackKey` (method, L3023), `VulkanBoundedQueryMatrixMatchesCpuAcrossRepresentationAndOrder` (method, L1405), `VulkanConstructiveStitchSetMatchesGeneratedCpuAuthority` (method, L791), `VulkanExportDebugAndEyePairExecuteDistinctGeneratedSemantics` (method, L1474), `VulkanFieldEntrypointsGroupRefinedU64SupportsBeforeReduction` (method, L1357), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L1262), `VulkanReducerHandlesMoreThan64AndSignalsBoundedColdContinuation` (method, L1557), `VulkanRelationWorklistMatchesBoundedCartesianCpuCorpus` (method, L1606), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L99)
