...
Source digest: `77ccfd491b6781e8e7793edc62989553df13b24a7b0a09151db18e480e65c486`

Scope: 76 files, 900 symbols, 750 functions/methods, 21 GPU kernels, 4 event links.
...
- `RoomAnchorManager.RoomReady` → `OnRoomReady` ([Runtime/Core/RoomScanner.cs:126](../../Runtime/Core/RoomScanner.cs#L126))
...
`BuildQuestInfiniteScanSmokeApk` (method, L122), `PrepareQuestInfiniteScanSmokeProject` (method, L24), `PrepareSmokeProjectAsync` (method, L32), `RoomScanSetupWizard` (class, L20)
...
`AddGameReadyComponentsToRoot` (method, L94), `EnsureDebugMenuAssets` (method, L139), `EnsureQuestVRManifest` (method, L134), `EnsureVRInput` (method, L161), `FindOrCreatePanelSettings` (method, L208), `FixAROcclusion` (method, L78), `FixARSession` (method, L69), `FixDebugModules` (method, L112), `FixShaderWiring` (method, L128), `MarkDirty` (method, L222), `OnEnable` (method, L29), `OnGUI` (method, L31), `Open` (method, L25), `Refresh` (method, L59), `RoomScanSetupWizard` (class, L17), `SetBool` (method, L194), `SetPanelRenderModeWorldSpace` (method, L200), `WireComponent` (method, L183)
...
`Awake` (method, L83), `ClearAllDataAsync` (method, L267), `ClearScan` (method, L260), `CreateScanAnchorAsync` (method, L296), `CycleRenderMode` (method, L284), `IsModeAvailable` (method, L291), `ObserveStart` (method, L246), `OnDestroy` (method, L147), `OnDisable` (method, L140), `OnRoomReady` (method, L130), `ReleaseScanResources` (method, L252), `RoomScanner` (class, L35), `ScanLifecycleState` (enum, L16), `ScanRenderMode` (enum, L10), `SetRenderMode` (method, L275), `Start` (method, L97), `StartScanningAsync` (method, L155), `StartScanningCoreAsync` (method, L169), `StopScanning` (method, L214), `ToggleDebugMenu` (method, L294), `ToggleScanning` (method, L236)
