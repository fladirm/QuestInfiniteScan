...
Source digest: `9369f29b5a8625e70810c4e3c6c4826198f76e768ec2e1d95a693e1e28d5dc7e`

Scope: 68 files, 811 symbols, 679 functions/methods, 16 GPU kernels, 3 event links.
...
- `RoomAnchorManager.RoomReady` → `OnRoomReady` ([Runtime/Core/RoomScanner.cs:122](../../Runtime/Core/RoomScanner.cs#L122))
...
`BuildQuestInfiniteScanSmokeApk` (method, L121), `PrepareQuestInfiniteScanSmokeProject` (method, L24), `PrepareSmokeProjectAsync` (method, L32), `RoomScanSetupWizard` (class, L20)
...
`AddGameReadyComponentsToRoot` (method, L94), `EnsureDebugMenuAssets` (method, L138), `EnsureQuestVRManifest` (method, L133), `EnsureVRInput` (method, L160), `FindOrCreatePanelSettings` (method, L207), `FixAROcclusion` (method, L78), `FixARSession` (method, L69), `FixDebugModules` (method, L111), `FixShaderWiring` (method, L127), `MarkDirty` (method, L221), `OnEnable` (method, L29), `OnGUI` (method, L31), `Open` (method, L25), `Refresh` (method, L59), `RoomScanSetupWizard` (class, L17), `SetBool` (method, L193), `SetPanelRenderModeWorldSpace` (method, L199), `WireComponent` (method, L182)
...
`Awake` (method, L80), `ClearAllDataAsync` (method, L263), `ClearScan` (method, L256), `CreateScanAnchorAsync` (method, L292), `CycleRenderMode` (method, L280), `IsModeAvailable` (method, L287), `ObserveStart` (method, L242), `OnDestroy` (method, L143), `OnDisable` (method, L136), `OnRoomReady` (method, L126), `ReleaseScanResources` (method, L248), `RoomScanner` (class, L34), `ScanLifecycleState` (enum, L16), `ScanRenderMode` (enum, L10), `SetRenderMode` (method, L271), `Start` (method, L93), `StartScanningAsync` (method, L151), `StartScanningCoreAsync` (method, L165), `StopScanning` (method, L210), `ToggleDebugMenu` (method, L290), `ToggleScanning` (method, L232)
...
`SigmaApplyMagnitudeSign` (gpu_function, L135), `SigmaHadamardRow` (gpu_function, L480), `SigmaI64Less` (gpu_function, L21), `SigmaI64ShiftRightRaw` (gpu_function, L95), `SigmaLeftBasisAction` (gpu_function, L438), `SigmaMagnitudeFitsSigned` (gpu_function, L128), `SigmaQ48AddChecked` (gpu_function, L168), `SigmaQ48DivLower` (gpu_function, L428), `SigmaQ48DivNearestEven` (gpu_function, L423), `SigmaQ48DivRounded` (gpu_function, L358), `SigmaQ48DivUpper` (gpu_function, L433), `SigmaQ48Less` (gpu_function, L153), `SigmaQ48Mask` (gpu_function, L142), `SigmaQ48Max` (gpu_function, L163), `SigmaQ48Min` (gpu_function, L158), `SigmaQ48MulLower` (gpu_function, L326), `SigmaQ48MulNearestEven` (gpu_function, L321), `SigmaQ48MulRounded` (gpu_function, L291), `SigmaQ48MulUpper` (gpu_function, L331), `SigmaQ48NegateChecked` (gpu_function, L180), `SigmaQ48Select` (gpu_function, L147), `SigmaQ48ShiftLeftChecked` (gpu_function, L199), `SigmaQ48ShiftRightNearestEven` (gpu_function, L212), `SigmaQ48SubChecked` (gpu_function, L187), `SigmaRightBasisAction` (gpu_function, L451), `SigmaRightSignedDyadAction` (gpu_function, L464), `SigmaU128` (struct, L237), `SigmaU128Bit` (gpu_function, L336), `SigmaU128SetBit` (gpu_function, L346), `SigmaU64AbsSigned` (gpu_function, L66), `SigmaU64Add` (gpu_function, L28), `SigmaU64AnyLowBits` (gpu_function, L108), `SigmaU64Bit` (gpu_function, L122), `SigmaU64Equal` (gpu_function, L9), `SigmaU64Increment` (gpu_function, L39), `SigmaU64Less` (gpu_function, L16), `SigmaU64MultiplyWide` (gpu_function, L242), `SigmaU64NegateRaw` (gpu_function, L59), `SigmaU64ShiftLeftRaw` (gpu_function, L83), `SigmaU64ShiftRight` (gpu_function, L71), `SigmaU64Subtract` (gpu_function, L48)

### `Runtime/Resources/SigmaPrism/SigmaCarrier.compute`

`AcknowledgeDirtyPages` (gpu_function, L201), `ClonePageGeneration` (gpu_function, L113), `CompactDirtyPages` (gpu_function, L172), `InitializeNullPage` (gpu_function, L92), `MarkPageDirty` (gpu_function, L147), `PublishPageGeneration` (gpu_function, L136), `ReleasePageSlot` (gpu_function, L158), `SigmaCarrierNullLane` (gpu_function, L63), `SigmaCarrierPageMetaGpu` (struct, L14), `SigmaRequestedPageMetadata` (gpu_function, L74), `AcknowledgeDirtyPages` (gpu_kernel, L7), `ClonePageGeneration` (gpu_kernel, L2), `CompactDirtyPages` (gpu_kernel, L6), `InitializeNullPage` (gpu_kernel, L1), `MarkPageDirty` (gpu_kernel, L4), `PublishPageGeneration` (gpu_kernel, L3), `ReleasePageSlot` (gpu_kernel, L5)
...
`Abort` (method, L451), `AcknowledgeDirtyBatch` (method, L364), `BeginNextGeneration` (method, L296), `BeginNullGeneration` (method, L275), `BindPageMutation` (method, L531), `BindReadable` (method, L324), `BindWritable` (method, L420), `BindWritable` (method, L71), `CarrierSegment` (class, L607), `CompactDirtyPages` (method, L337), `ComputeSegmentPageCapacity` (method, L249), `Create` (method, L679), `CreateDirtyBatch` (method, L665), `Dispose` (method, L469), `Dispose` (method, L669), `Dispose` (method, L92), `EnsureNoPendingCoordinate` (method, L551), `Equals` (method, L40), `Equals` (method, L44), `Equals` (method, L601), `Equals` (method, L603), `GetHashCode` (method, L46), `GetHashCode` (method, L605), `MarkDirty` (method, L384), `OnDestroy` (method, L487), `OnModuleInitialize` (method, L203), `OnScanStarted` (method, L246), `OnScanStopped` (method, L248), `PageGenerationKey` (struct, L589), `Publish` (method, L435), `Publish` (method, L81), `ReleaseSlot` (method, L658), `RequireAllocated` (method, L574), `RequireInitialized` (method, L583), `RequirePending` (method, L561), `ReserveGeneration` (method, L489), `SetUInt` (method, L548), `SigmaCarrier` (class, L127), `SigmaCarrierDirtyBatch` (struct, L101), `SigmaCarrierPageFlags` (enum, L8), `SigmaCarrierPageHandle` (struct, L15), `SigmaCarrierWriteLease` (class, L57), `ToString` (method, L48), `TryGetLatest` (method, L268), `TryReleaseRetiredGeneration` (method, L398), `TryReserveSlot` (method, L647)
