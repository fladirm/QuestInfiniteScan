...
Source digest: `96fd0ab4d05423427046aa3008b7e898bfabfa26f11ec0c81cb6e937e022f5ff`

Scope: 103 files, 1922 symbols, 1602 functions/methods, 35 GPU kernels, 5 event links.
...
`BindContract` (method, L509), `BindFrameKernels` (method, L281), `BindRelation` (method, L596), `BuildProvenanceReceipt` (method, L689), `CameraPose` (method, L16), `Dispose` (method, L274), `Dispose` (method, L87), `FromCamera` (method, L12), `Intrinsics` (method, L677), `OpticalTransfer` (method, L681), `RecordNativeCloseCommit` (method, L192), `Release` (method, L272), `SigmaNativeFrameGraph` (class, L103), `SigmaNativeFrameInput` (struct, L29), `SigmaNativeFrameLease` (class, L72), `SigmaRoomFrame` (class, L10), `TryAcquire` (method, L178), `WriteViewReceipt` (method, L713)
...
`BindPublication` (method, L2569), `BuildLocalityCertificate` (method, L2420), `BuildObservationWritesEvery320By320FootprintOnGpu` (method, L181), `CertificateDifference` (method, L2836), `CertifiedConstraintRecord` (method, L2747), `Compare` (method, L3557), `CompletionTransferBatchesWithoutBecomingIngressOwnership` (method, L1894), `ConstraintRecord` (method, L2717), `Count` (method, L2546), `CutEUsesDirectedWitnessWhenD4CellStreamsTie` (method, L2162), `DirectionModeMask` (method, L2817), `DispatchCutE` (method, L2555), `Equals` (method, L3545), `Equals` (method, L3548), `ExactConstraintJournalMinimizesWithoutBranchIdentity` (method, L1639), `FeasibleCurrentStateIsBytePreservedAndDoesNotClonePage` (method, L1417), `FindGaugeSample` (method, L3287), `Flatten` (method, L3331), `Flatten` (method, L3342), `From` (method, L3539), `FullFrameLinearDispatchGridIsQuestLegalAndBijective` (method, L98), `GaugeKey` (struct, L3518), `GaugeKeyComparer` (class, L3553), `GetHashCode` (method, L3550), `LegacyConstraintSnapshotMigratesOnceToBoundedDeltaStore` (method, L1713), `LiveGraphIsOneBoundedNativeCloseAndLegacyAbiIsAbsent` (method, L18), `LiveScratchOwnsOneFullFrameArenaAndOneTerminalJournal` (method, L141), `LoadShader` (method, L2318), `LocalityCertificateBoundsTenThousandRevisitsAndIsOrderIndependent` (method, L1747), `LocalityCertificatePreservesViewDiversityAndRawContradiction` (method, L1814), `MinimizedConstraintJournalPersistsAtomicallyOffFrameThread` (method, L1681), `Packed` (method, L3355), `PackedInterval` (method, L3361), `PageMeta` (struct, L3610), `PersistAndReload` (method, L2805), `PreRootFaultLeavesStateGaugeCertificateAndRootUntouched` (method, L1527), `PrepareRefinementScratch` (method, L3136), `ProductionBoundaryPlaneMatchesAcceptedGeneratedStitch` (method, L321), `ProductionGlobalCloseJoinsTilesAndRejectsInconsistentCycle` (method, L878), `ProductionTileCloseMatchesBoundedN2ClosureAndMeets256Hits` (method, L528), `ProvenFreshAdmissionPublishesExactlyOneRoot` (method, L1200), `Q2` (method, L3388), `Q4` (method, L2828), `ReadAssetSource` (method, L3406), `ReadCertificate` (method, L3319), `ReadPageMeta` (method, L3279), `ReadState` (method, L3309), `RefinementAtFullPageBoundarySpillsIntoNextLogicalPage` (method, L2042), `RefinementCopiesTheCompletePriorBeforeAddingDetail` (method, L1952), `RefinementMultiplicityAndParentMeetArePermutationInvariant` (method, L1994), `RefinementSnapshot` (class, L3472), `RefinementStep` (struct, L3457), `ReloadedCertificateMeetsLikeUninterruptedCertificate` (method, L1860), `RepeatedRefinementNormalizesIndependentlyOfSplitOrder` (method, L1917), `RunRefinementSequence` (method, L2848), `RunStaticExclusion` (method, L2454), `ScatterConsumesMutationCountInsteadOfResidentWorldExtent` (method, L1306), `SeedSingleFootprintClosedCutE` (method, L2331), `SetEqualCertificates` (method, L2694), `SetValidNextCertificate` (method, L2677), `SigmaNativeFrameTests` (class, L15), `SignedMorton` (method, L3570), `StateWithLane0` (method, L2447), `StaticExclusionSnapshot` (class, L3494), `StereoStaticExclusionPublishesOnlyZEmptyAtTheSameGauge` (method, L1507), `ToRaw` (method, L3531), `ToString` (method, L3551), `U4` (method, L3394), `UInt2` (struct, L3594), `UInt2Buffer` (method, L3400), `UInt4` (struct, L3601), `UInt4Buffer` (method, L3403), `UIntBuffer` (method, L3397), `WriteEnvelope` (method, L3377), `WriteRepresentationCell` (method, L3240), `WriteState` (method, L3369), `ZeroArrayRenderTexture` (method, L3413), `ZeroRenderTexture` (method, L3438)
