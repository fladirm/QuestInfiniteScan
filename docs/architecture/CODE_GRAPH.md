...
Source digest: `0f790dd208daf8c7753b23c879fe5dea0a409bf9ac340035d76678d46790e9da`

Scope: 110 files, 1808 symbols, 1467 functions/methods, 76 GPU kernels, 5 event links.
...
`AddOutward` (method, L544), `Apply` (method, L42), `CanOmit` (method, L151), `ContractJoint` (method, L496), `ContractNativeQuery` (method, L441), `DivideOutward` (method, L577), `DotPoint` (method, L619), `Equals` (method, L204), `Equals` (method, L210), `Equals` (method, L228), `Equals` (method, L230), `Equals` (method, L332), `Equals` (method, L335), `EvaluateAndReduce` (method, L399), `EvaluateMerkabaShadow` (method, L365), `EvaluateNativeQuery` (method, L383), `EvaluateNativeRelation` (method, L530), `GetHashCode` (method, L212), `GetHashCode` (method, L232), `GetHashCode` (method, L337), `Hull` (method, L603), `MultiplyOutward` (method, L556), `Overlaps` (method, L612), `Point` (method, L629), `ProvenStrictlyBefore` (method, L615), `ReduceNativeQuery` (method, L409), `RequireSensorExpressionShape` (method, L631), `SelectNativeQuerySupport` (method, L356), `SigmaMerkabaSemanticOracle` (class, L345), `SigmaNativeContractBranch` (struct, L257), `SigmaNativeContractResult` (class, L297), `SigmaNativeContribution` (struct, L162), `SigmaNativeDeltaWitness` (struct, L215), `SigmaNativeOracleCell` (struct, L94), `SigmaNativeOracleQuery` (class, L52), `SigmaNativeOracleResolution` (enum, L7), `SigmaNativePhotometricLaw` (struct, L14), `SigmaNativePreimageCandidate` (struct, L234), `SigmaNativeQuerySupportSummary` (struct, L128), `SigmaNativeRelationWitness` (struct, L318), `SigmaNativeSceneShadow` (struct, L184), `SubtractOutward` (method, L550), `SumOutward` (method, L599), `SummarizeCell` (method, L347)

### `Tests/Editor/SigmaNativeOracleTests.cs`

`Axis` (method, L736), `Candidate` (method, L690), `Cell` (method, L701), `CpuCandidate` (method, L695), `DirectionalMouldCorrectsNearSupportAndNeverActsBehindHit` (method, L152), `Equals` (method, L33), `Equals` (method, L35), `EvaluateRelationWindows` (method, L590), `ExactInformationAndPhotometricLawPreventWeakRevisitDegradation` (method, L202), `ExecutionWindowsAndOrderAreInvisibleAndScratchIsTestOnly` (method, L396), `Factor` (method, L743), `GaugeRefinementRelationsAndCoupledShadowModesRemainOneField` (method, L271), `GetHashCode` (method, L37), `GpuCandidate` (method, L756), `Law` (method, L728), `LeftQuery` (method, L708), `LoadShader` (method, L780), `Pack` (method, L771), `PackRows` (method, L765), `PackStates` (method, L768), `Point` (method, L739), `Query` (method, L720), `Raw` (method, L741), `ReduceWindows` (method, L658), `ReverseKeepsUnionAndResolvesOnlyUniqueOrCommonDelta` (method, L88), `RightQuery` (method, L714), `RunGpuContractOverflow` (method, L493), `RunGpuQuery` (method, L608), `SigmaNativeOracleTests` (class, L12), `SparseSupportIndexMatchesExhaustiveMixedRefinedAndNonresidentWorlds` (method, L358), `State` (method, L705), `Summary` (method, L747), `UInt2` (struct, L20), `UInt4` (struct, L27), `Unpack` (method, L777), `VulkanQueryContractOverflowAndWindowingMatchCpuOracle` (method, L430), `WholeQueryReductionOwnsFirstHitDisjunctionAndDefault` (method, L41)
