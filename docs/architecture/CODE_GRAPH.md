...
Source digest: `c223b3cdc7a50ac5e6ae6d192e5d38111f5640d73418b743f94dd1a39bd093c8`

Scope: 134 files, 2165 symbols, 1741 functions/methods, 113 GPU kernels, 6 event links.
...
- `RenderPipelineManager.endCameraRendering` → `OnEndCameraRendering` ([Runtime/SigmaPrism/SigmaRenderer.cs:331](../../Runtime/SigmaPrism/SigmaRenderer.cs#L331))
...
`BindBuild` (method, L816), `BindCancelHistoricalRevalidation` (method, L676), `BindCompaction` (method, L841), `BindFinalizeHistoricalRevalidation` (method, L650), `BindHaloResolve` (method, L866), `BindHistoricalDrawArguments` (method, L593), `BindPrepareHistoricalRevalidation` (method, L554), `BindRebuildHistoricalAssociation` (method, L607), `BindStreamingManifest` (method, L181), `BuildClipFromWorld` (method, L952), `CreateColor` (method, L1193), `DestroyMaterial` (method, L1121), `DestroyTexture` (method, L1219), `Dispose` (method, L1184), `Dispose` (method, L1299), `DrawSegments` (method, L885), `EnsureHistoricalRevalidationPageSnapshot` (method, L692), `EnsureHistoricalRevalidationTargets` (method, L439), `EnsureSegmentCaches` (method, L920), `HistoricalRevalidationTargets` (class, L1131), `LateUpdate` (method, L347), `Matches` (method, L1293), `OnDestroy` (method, L1039), `OnEndCameraRendering` (method, L980), `OnModuleInitialize` (method, L247), `OnScanStarted` (method, L334), `OnScanStopped` (method, L340), `PrepareReadoutCaches` (method, L791), `RecordDirectPreview` (method, L1007), `RecordHistoricalRevalidation` (method, L467), `RenderPrediction` (method, L715), `SegmentReadoutCache` (class, L1231), `SetMrt` (method, L1176), `SetMrt` (method, L944), `SetRevalidationBuffer` (method, L708), `SigmaRenderer` (class, L19), `TryAcquireLatest` (method, L236), `TryGetStreamingReadout` (method, L533), `TryGetStreamingReadoutDiagnostics` (method, L207), `TryRecordPoseGaugePrediction` (method, L393), `TryRender` (method, L366), `TryRenderPoseGauge` (method, L375), `UnbindStreamingManifest` (method, L197)
...
`BuildFoldedPage` (method, L321), `CreateColor` (method, L367), `CreateDepth` (method, L381), `Destroy` (method, L444), `DrawPrediction` (method, L416), `ExactLiftReadoutRoundTripsAndNullHasNoContact` (method, L52), `FillPatch` (method, L331), `GpuReadoutAndRasterSelectNearFoldWhileNullStaysEmpty` (method, L70), `MinPositiveDepth` (method, L402), `Pack` (method, L349), `PageMeta` (struct, L35), `SigmaForwardReadoutTests` (class, L11), `UInt2` (struct, L19), `UInt4` (struct, L26)
