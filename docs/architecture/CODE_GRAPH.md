...
Source digest: `16bf82ed3bd71a3c4bb2982eeafdf50b854cfdcb99d65d1c02f006f060b65398`

Scope: 142 files, 2348 symbols, 1872 functions/methods, 119 GPU kernels, 5 event links.
...
`BuildDepthSourceCells` (gpu_function, L337), `BuildFrameProposals` (gpu_function, L289), `BuildRgbSourceCells` (gpu_function, L465), `ClearFrameState` (gpu_function, L262), `CompactResolvedTargets` (gpu_function, L1080), `EvaluateCandidateMeets` (gpu_function, L818), `SigmaFrameBootstrapCoordinate` (gpu_function, L449), `SigmaFrameBuildNovelState` (gpu_function, L765), `SigmaFrameCandidateLess` (gpu_function, L234), `SigmaFrameCellAddress` (gpu_function, L127), `SigmaFrameEmptyCandidate` (gpu_function, L198), `SigmaFrameExactEnabled` (gpu_function, L114), `SigmaFrameFullBounds` (gpu_function, L119), `SigmaFrameLoadDepthJoint` (gpu_function, L411), `SigmaFrameLoadMetric` (gpu_function, L138), `SigmaFramePixel` (gpu_function, L132), `SigmaFramePredictionCandidate` (gpu_function, L208), `SigmaFrameProjectDepth` (gpu_function, L172), `SigmaFrameReferenceWorld` (gpu_function, L148), `SigmaFrameSameCandidate` (gpu_function, L252), `SigmaFrameSourceBounds` (gpu_function, L709), `SigmaFrameSourceProvenance` (gpu_function, L740), `SigmaFrameTransformRow` (gpu_function, L751), `if` (gpu_function, L720), `if` (gpu_function, L726), `if` (gpu_function, L869), `BuildDepthSourceCells` (gpu_kernel, L3), `BuildFrameProposals` (gpu_kernel, L2), `BuildRgbSourceCells` (gpu_kernel, L4), `ClearFrameState` (gpu_kernel, L1), `CompactResolvedTargets` (gpu_kernel, L6), `EvaluateCandidateMeets` (gpu_kernel, L5)
...
`BindCarrier` (method, L433), `BindEvaluate` (method, L415), `BindFootprintWindow` (method, L585), `BindFrameConstants` (method, L277), `BindProposal` (method, L313), `BindSourceOutputs` (method, L451), `BindSourceRead` (method, L484), `BindSourceReads` (method, L471), `CeilDiv` (method, L582), `CreateBuffer` (method, L561), `Dispose` (method, L264), `Intrinsics` (method, L568), `Packed` (method, L572), `PoseMatrix` (method, L565), `RecordDepthSource` (method, L341), `RecordRgbSource` (method, L379), `RecordSourceAndResolve` (method, L152), `RequireAlive` (method, L592), `RequireSingleExecutionWindow` (method, L534), `SetFrameMatrices` (method, L502), `SigmaFrameGraph` (class, L62), `SigmaFrameInverseInput` (struct, L12), `Single` (method, L551), `TryAcquire` (method, L142)

### `Runtime/SigmaPrism/SigmaFrameResources.cs`

`AdditionalBytesFor` (method, L62), `BufferBytes` (method, L632), `ComputeSegmentRecordCapacity` (method, L513), `CreateBuffer` (method, L623), `Dispose` (method, L212), `Dispose` (method, L233), `Dispose` (method, L268), `Dispose` (method, L559), `Dispose` (method, L98), `EstimateSourceBytes` (method, L498), `FrameSlot` (struct, L669), `Get` (method, L223), `GetSources` (method, L526), `GrowTo` (method, L71), `Lower` (method, L203), `Provenance` (method, L210), `Release` (method, L539), `RequireAlive` (method, L109), `RequireAlive` (method, L617), `RequireSlot` (method, L606), `Retain` (method, L261), `Retain` (method, L532), `SigmaFrameBufferSegment` (struct, L14), `SigmaFrameMemoryProfile` (enum, L8), `SigmaFrameResources` (class, L287), `SigmaFrameSegmentedBuffer` (class, L35), `SigmaFrameSourceStorage` (class, L123), `SigmaOwnedFrameLease` (class, L242), `TryAcquireFrame` (method, L403), `TryEnsureCandidateCapacity` (method, L462), `TryEnsureDirtyEdgeCapacity` (method, L492), `TryEnsurePendingGaugeCapacity` (method, L489), `TryEnsureRevisionCapacity` (method, L495), `TryGrow` (method, L592), `TryReserve` (method, L603), `UInt4` (method, L635), `Upper` (method, L206), `ValidateGeneratedAbi` (method, L638), `Validity` (method, L208)
...
`ArrayRenderTexture` (method, L477), `BuildCpuOracle` (method, L118), `Candidate` (method, L251), `ClearPrediction` (method, L499), `ConstrainedLaneCount` (method, L221), `Contains` (method, L247), `DepthCalibration` (method, L522), `Destroy` (method, L595), `Dispose` (method, L376), `FrameFixture` (class, L262), `Intrinsics` (method, L429), `NormalizeDepth` (method, L457), `RawDepthTexture` (method, L445), `ReadSnapshot` (method, L399), `RgbCalibration` (method, L553), `RgbTexture` (method, L434), `Run` (method, L362), `Set` (method, L568), `SigmaFrameInverseTests` (class, L11), `Signed` (method, L259), `Snapshot` (class, L41), `SourceKey` (method, L233), `UInt2` (struct, L27), `UInt4` (struct, L34), `WholeFrameFourSourceInverseIsExactAndPartitionInvariant` (method, L54)
...
`AssertProofEqual` (method, L1013), `Bind` (method, L1057), `Bounds` (method, L1033), `BoundsEqual` (method, L999), `BoundsGpu` (struct, L41), `BuildPartitionedProofEvidence` (method, L900), `CloseProof` (method, L952), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L521), `MeetCertificates` (method, L958), `NullPromotionLiftUsesCompleteMeetAndExactMass` (method, L244), `PageMetadataGpu` (struct, L17), `ProductionComputeDispatchesUseGpuTimestampWrapper` (method, L217), `ProofCertificate` (method, L940), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L706), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L732), `ProofSampleGpu` (struct, L48), `Q48` (method, L1044), `ReadCompute` (method, L1063), `ReadScript` (method, L1070), `ReplayWindows` (method, L971), `SigmaStreamingContractTests` (class, L12), `Signed` (method, L1054), `StreamingRepairContractUsesProductionBindingsAndClosure` (method, L145), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L54), `TransactionTelemetryDecodesExecutionGeneration` (method, L481), `U4` (method, L1028), `UInt2Gpu` (struct, L34)
...
`SigmaAssociationSampleGpu` (struct, L805), `SigmaAssociationSampleGpu` (struct, L1097), `SigmaFrameUInt2Gpu` (struct, L1236), `SigmaFrameUInt4Gpu` (struct, L1243), `SigmaGeneratedAlgebra` (class, L509), `SigmaGeneratedFrame` (class, L1254), `SigmaGeneratedStreaming` (class, L850), `SigmaPageVisibilityGpu` (struct, L825), `SigmaPageVisibilityGpu` (struct, L1115), `SigmaProbationGpu` (struct, L755), `SigmaProbationGpu` (struct, L1052), `SigmaProofCandidateGpu` (struct, L788), `SigmaProofCandidateGpu` (struct, L1082), `SigmaProofClosureGpu` (struct, L775), `SigmaProofClosureGpu` (struct, L1070), `SigmaProofPrefixGpu` (struct, L797), `SigmaProofPrefixGpu` (struct, L1090), `SigmaPublicationManifestGpu` (struct, L816), `SigmaPublicationManifestGpu` (struct, L1107), `SigmaSealedSourceBundleGpu` (struct, L743), `SigmaSealedSourceBundleGpu` (struct, L1041), `SigmaSourceHandleSegmentGpu` (struct, L764), `SigmaSourceHandleSegmentGpu` (struct, L1060), `SigmaStreamBudgetClass` (enum, L696), `SigmaStreamDiagnosticGpu` (struct, L839), `SigmaStreamDiagnosticGpu` (struct, L1127), `SigmaStreamOpcode` (enum, L692), `SigmaStreamPageReferenceGpu` (struct, L712), `SigmaStreamPageReferenceGpu` (struct, L1012), `SigmaStreamUInt4Gpu` (struct, L703), `SigmaStreamWorkItemGpu` (struct, L832), `SigmaStreamWorkItemGpu` (struct, L1121), `SigmaTransactionGpu` (struct, L719), `SigmaTransactionGpu` (struct, L1018), `basis_product` (function, L131), `build_descriptor` (function, L181), `build_kernel_execution_descriptor` (function, L373), `check_or_write` (function, L1312), `chunks` (function, L480), `conjugate_sign` (function, L148), `cs_array` (function, L485), `cs_values` (function, L681), `dyads` (function, L156), `fingerprint_words` (function, L569), `frame_abi_descriptor` (function, L1163), `hadamard_sign` (function, L152), `main` (function, L1325), `multiply_dyads` (function, L164), `render_cs` (function, L494), `render_frame_cs` (function, L1187), `render_frame_hlsl` (function, L1269), `render_hlsl` (function, L612), `render_hlsl_layout` (function, L573), `render_streaming_cs` (function, L673), `render_streaming_hlsl` (function, L904), `sha256` (function, L176), `uint_array` (function, L669), `upper_snake` (function, L1152), `validate_descriptor` (function, L347), `values` (function, L914)
