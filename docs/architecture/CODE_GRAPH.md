...
Source digest: `f309f190bf6b748a36d4c94a5b109cebeb60ff8e5b0199bf3c5e03a3b152d0d1`

Scope: 133 files, 2147 symbols, 1725 functions/methods, 112 GPU kernels, 6 event links.
...
- `SigmaRenderer.PredictionReady` → `OnPredictionReady` ([Runtime/SigmaPrism/SigmaInverseController.cs:162](../../Runtime/SigmaPrism/SigmaInverseController.cs#L162))
...
`SigmaInverseWorkGpu` (struct, L14), `SigmaInverseWorkImageX` (gpu_function, L20), `SigmaInverseWorkImageY` (gpu_function, L25), `SigmaStreamBundleGeneration` (gpu_function, L103), `SigmaStreamBundleState` (gpu_function, L108), `SigmaStreamDispatchAddress` (gpu_function, L87), `SigmaStreamFirstIncompleteBlock` (gpu_function, L206), `SigmaStreamFirstSetBit` (gpu_function, L200), `SigmaStreamHandleValid` (gpu_function, L138), `SigmaStreamMaskIntersects` (gpu_function, L193), `SigmaStreamRawTileAddress` (gpu_function, L98), `SigmaStreamRawWordAddress` (gpu_function, L92), `SigmaStreamSetCompletedBlock` (gpu_function, L227), `SigmaStreamSetSourceHandle` (gpu_function, L152), `SigmaStreamSourceHandle` (gpu_function, L143), `SigmaStreamSourceSegmentValid` (gpu_function, L185), `SigmaStreamTicket` (gpu_function, L123), `SigmaStreamTicketEqual` (gpu_function, L133), `SigmaStreamTicketLess` (gpu_function, L128), `SigmaStreamTransactionGeneration` (gpu_function, L118), `SigmaStreamTransactionState` (gpu_function, L113), `SigmaStreamWorkAddress` (gpu_function, L82), `if` (gpu_function, L163), `if` (gpu_function, L170)

### `Runtime/Resources/SigmaPrism/SigmaInverseWorkGraph.compute`

`ClearIngressWork` (gpu_function, L266), `CompactIngressBundles` (gpu_function, L280), `FinalizeExtractedBundles` (gpu_function, L498), `FinalizeStreamingScheduleDiagnostics` (gpu_function, L1175), `InitializeStreamingGraph` (gpu_function, L213), `InitializeStreamingOwnership` (gpu_function, L247), `PrepareTransactionPages` (gpu_function, L1250), `ReleaseProbationAssociations` (gpu_function, L1226), `ScheduleSigmaTransactions` (gpu_function, L790), `SigmaAppendSourceHandle` (gpu_function, L572), `SigmaBundleAffectedMask` (gpu_function, L119), `SigmaBundleHasOwnedRawRange` (gpu_function, L163), `SigmaBundleKeysIndependent` (gpu_function, L530), `SigmaBundleRecordsOverlap` (gpu_function, L138), `SigmaBundleSealsAlone` (gpu_function, L521), `SigmaBundleTransactionOverlap` (gpu_function, L149), `SigmaClaimSourceSegment` (gpu_function, L537), `SigmaCompactMorton` (gpu_function, L69), `SigmaFindProbation` (gpu_function, L653), `SigmaGaugeMask64` (gpu_function, L97), `SigmaHasEarlierUnsealedOverlap` (gpu_function, L732), `SigmaOpenProbation` (gpu_function, L699), `SigmaProbationFirstHandle` (gpu_function, L636), `SigmaSameLogicalPage` (gpu_function, L133), `SigmaSealSourceStream` (gpu_function, L606), `SigmaSignedMortonLimb` (gpu_function, L80), `SigmaStreamAddTicket` (gpu_function, L88), `SigmaStreamDependencySatisfied` (gpu_function, L177), `SigmaStreamPageSlotFree` (gpu_function, L170), `SigmaStreamResetDispatch` (gpu_function, L205), `SigmaTransactionOpcode` (gpu_function, L761), `SigmaTransactionSemanticMask` (gpu_function, L126), `if` (gpu_function, L885), `ClearIngressWork` (gpu_kernel, L3), `CompactIngressBundles` (gpu_kernel, L4), `FinalizeExtractedBundles` (gpu_kernel, L5), `FinalizeStreamingScheduleDiagnostics` (gpu_kernel, L7), `InitializeStreamingGraph` (gpu_kernel, L1), `InitializeStreamingOwnership` (gpu_kernel, L2), `PrepareTransactionPages` (gpu_kernel, L9), `ReleaseProbationAssociations` (gpu_kernel, L8), `ScheduleSigmaTransactions` (gpu_kernel, L6)
...
`CopySealedBundleMetadata` (gpu_function, L212), `ExtractSealedBundleSamples` (gpu_function, L278), `SigmaBundleCaptureAssociation` (gpu_function, L177), `SigmaBundleCaptureDepth` (gpu_function, L142), `SigmaBundleCaptureRgb` (gpu_function, L154), `SigmaBundleGaugeWorld` (gpu_function, L118), `SigmaBundleLoadRgb` (gpu_function, L112), `SigmaBundleMatchedWorld` (gpu_function, L126), `SigmaBundlePackPixel` (gpu_function, L54), `SigmaBundlePackUnorm4x8` (gpu_function, L59), `SigmaBundleProjectDepth` (gpu_function, L66), `SigmaBundleProjectRgb` (gpu_function, L92), `CopySealedBundleMetadata` (gpu_kernel, L1), `ExtractSealedBundleSamples` (gpu_kernel, L2)
...
`FinalizeDormantParking` (gpu_function, L296), `ParkDormantSegments` (gpu_function, L245), `ParkDormantSources` (gpu_function, L219), `PrepareDormantParking` (gpu_function, L165), `RecheckDormantProbations` (gpu_function, L366), `ReleaseDormantPage` (gpu_function, L277), `SigmaDormantDependencyChanged` (gpu_function, L343), `SigmaDormantLoadMutableWork` (gpu_function, L63), `SigmaDormantLoadWork` (gpu_function, L43), `SigmaDormantReleaseAssociation` (gpu_function, L202), `SigmaDormantSameCoordinate` (gpu_function, L334), `SigmaDormantSourceAt` (gpu_function, L83), `SigmaDormantValidateStream` (gpu_function, L116), `FinalizeDormantParking` (gpu_kernel, L5), `ParkDormantSegments` (gpu_kernel, L3), `ParkDormantSources` (gpu_kernel, L2), `PrepareDormantParking` (gpu_kernel, L1), `RecheckDormantProbations` (gpu_kernel, L6), `ReleaseDormantPage` (gpu_kernel, L4)
...
`CoalesceProofWindow` (gpu_function, L1025), `CompleteProofBlock` (gpu_function, L1702), `EmitProofCertificates` (gpu_function, L1546), `EvaluateProofRedundancyWindow` (gpu_function, L1370), `MergeProofRuns` (gpu_function, L932), `PrepareProofOrder` (gpu_function, L872), `PrepareProofRedundancy` (gpu_function, L1135), `ReduceTransactionSourceBlock` (gpu_function, L631), `RetainProofRawWindow` (gpu_function, L1632), `SigmaProofAdvanceSourceCursor` (gpu_function, L204), `SigmaProofAtomicAddDegree` (gpu_function, L159), `SigmaProofCandidateBound` (gpu_function, L103), `SigmaProofCandidateBoundAddress` (gpu_function, L93), `SigmaProofCandidateBoundRead` (gpu_function, L109), `SigmaProofCandidateLess` (gpu_function, L716), `SigmaProofCommitReducedBlock` (gpu_function, L569), `SigmaProofDegree` (gpu_function, L135), `SigmaProofFailTransaction` (gpu_function, L1105), `SigmaProofFinishRedundancyRank` (gpu_function, L1114), `SigmaProofFullBounds` (gpu_function, L85), `SigmaProofIndependentEdge` (gpu_function, L804), `SigmaProofKept` (gpu_function, L782), `SigmaProofKeptRead` (gpu_function, L788), `SigmaProofLoadCurrentSource` (gpu_function, L182), `SigmaProofLoadPrior` (gpu_function, L305), `SigmaProofLoadReadWork` (gpu_function, L842), `SigmaProofLoadWork` (gpu_function, L816), `SigmaProofMergeCandidate` (gpu_function, L984), `SigmaProofPrefixBound` (gpu_function, L122), `SigmaProofPrefixBoundAddress` (gpu_function, L98), `SigmaProofPrepareReduceGroup` (gpu_function, L523), `SigmaProofReduceSource` (gpu_function, L344), `SigmaProofResetSweepScratch` (gpu_function, L1078), `SigmaProofSameKey` (gpu_function, L753), `SigmaProofSetCandidateBound` (gpu_function, L115), `SigmaProofSetKept` (gpu_function, L794), `SigmaProofSetPrefixBound` (gpu_function, L128), `SigmaProofSetSampleBit` (gpu_function, L234), `SigmaProofSetSortedIndex` (gpu_function, L774), `SigmaProofSortedIndex` (gpu_function, L762), `SigmaProofSortedIndexRead` (gpu_function, L768), `SigmaProofSourceCell` (gpu_function, L242), `SigmaProofSourceSlot` (gpu_function, L291), `if` (gpu_function, L1345), `CoalesceProofWindow` (gpu_kernel, L4), `CompleteProofBlock` (gpu_kernel, L9), `EmitProofCertificates` (gpu_kernel, L7), `EvaluateProofRedundancyWindow` (gpu_kernel, L6), `MergeProofRuns` (gpu_kernel, L3), `PrepareProofOrder` (gpu_kernel, L2), `PrepareProofRedundancy` (gpu_kernel, L5), `ReduceTransactionSourceBlock` (gpu_kernel, L1), `RetainProofRawWindow` (gpu_kernel, L8)

### `Runtime/Resources/SigmaPrism/SigmaStreamPublication.compute`

`InitializeManifestVisibility` (gpu_function, L45), `PreparePublicationManifest` (gpu_function, L137), `PublishPublicationManifest` (gpu_function, L234), `ResolvePublishedPageCaches` (gpu_function, L258), `RetirePublishedTransaction` (gpu_function, L321), `SigmaPublicationPage` (gpu_function, L96), `SigmaPublicationPageCount` (gpu_function, L108), `SigmaPublicationReleaseAssociation` (gpu_function, L304), `SigmaPublicationRetainsRaw` (gpu_function, L292), `SigmaPublicationWork` (gpu_function, L77), `InitializeManifestVisibility` (gpu_kernel, L5), `PreparePublicationManifest` (gpu_kernel, L1), `PublishPublicationManifest` (gpu_kernel, L2), `ResolvePublishedPageCaches` (gpu_kernel, L3), `RetirePublishedTransaction` (gpu_kernel, L4)
...
`SigmaCandidateCloseRecord` (gpu_function, L564), `SigmaCandidateDyadL1` (gpu_function, L322), `SigmaCandidateEndpointLane` (gpu_function, L229), `SigmaCandidateEndpointStatus` (gpu_function, L281), `SigmaCandidateI64Equal` (gpu_function, L73), `SigmaCandidateIncrementI64` (gpu_function, L78), `SigmaCandidateLoadCell` (gpu_function, L548), `SigmaCandidateNullLane` (gpu_function, L133), `SigmaCandidateOutsideSlot` (gpu_function, L223), `SigmaCandidatePageReference` (gpu_function, L104), `SigmaCandidatePageVisible` (gpu_function, L88), `SigmaCandidatePrepareGroup` (gpu_function, L144), `SigmaCandidateRecordAddress` (gpu_function, L63), `SigmaCandidateResolveNeighbours` (gpu_function, L176), `SigmaCandidateSampleAddress` (gpu_function, L68), `SigmaCandidateTauL1` (gpu_function, L346), `SigmaCandidateTransactionPage` (gpu_function, L113), `SigmaCandidateTransitionLane` (gpu_function, L300), `ValidateCandidateAssociatorChunk` (gpu_function, L601), `ValidateCandidateTransitionChunk` (gpu_function, L357), `if` (gpu_function, L503), `ValidateCandidateAssociatorChunk` (gpu_kernel, L2), `ValidateCandidateTransitionChunk` (gpu_kernel, L1)
...
`AbsNanoseconds` (method, L997), `Add` (method, L1192), `AdvanceAge` (method, L1174), `AdvanceAge` (method, L1282), `Begin` (method, L1261), `BuildTrackingPriorEnvelope` (method, L735), `CaptureTimingTelemetry` (method, L253), `CeilDiv` (method, L1032), `Complete` (method, L1322), `CountPendingTickets` (method, L945), `CreateArrayTexture` (method, L1046), `CreateBuffer` (method, L1042), `CreatePersistentResources` (method, L833), `DestroyTexture` (method, L1076), `Dispose` (method, L1335), `ElapsedMilliseconds` (method, L1175), `ElapsedMilliseconds` (method, L1283), `EnsureCalibration` (method, L805), `EnsureFrameResources` (method, L1285), `EnsurePosePartials` (method, L1310), `FillCalibration` (method, L880), `FillRgbCalibration` (method, L916), `FindKernels` (method, L818), `FromRaw` (method, L1156), `IndependenceKey` (method, L1007), `IngressSlot` (class, L1213), `IntrinsicsVector` (method, L1004), `LatchCompletionFault` (method, L515), `LateUpdate` (method, L201), `LatencyTracker` (class, L1180), `MaxRigRotationResidual` (method, L792), `MaxRigTranslationResidual` (method, L779), `Mix` (method, L1027), `NextPowerOfTwo` (method, L1035), `NextRevision` (method, L980), `OnDestroy` (method, L1087), `OnModuleInitialize` (method, L113), `OnPredictionReady` (method, L193), `OnScanStarted` (method, L168), `OnScanStopped` (method, L184), `Poll` (method, L1177), `Poll` (method, L1279), `PollCanonical` (method, L473), `PollDerived` (method, L494), `PollIngress` (method, L443), `PollInitialization` (method, L422), `PoseMatrix` (method, L1002), `RecordClassification` (method, L551), `RecordCorrectedCalibration` (method, L675), `RecordGraphInitialization` (method, L269), `RecordNormalize` (method, L526), `RecordPoseGauge` (method, L621), `ReleasePendingIngress` (method, L961), `Reset` (method, L1204), `SaturatingAdd` (method, L1000), `SetQ` (method, L988), `SetQRaw` (method, L991), `SetRgbQ` (method, L993), `SetRgbQRaw` (method, L995), `SigmaInverseController` (class, L22), `SigmaPackedQ48` (struct, L1147), `Submission` (class, L1159), `SubmitCanonicalAndDerived` (method, L372), `SubmitIngress` (method, L289), `TrackLast` (method, L967), `TryGetFreeIngressSlot` (method, L932), `UpdatePeak` (method, L973), `UploadExactCalibration` (method, L702), `UploadPosePrior` (method, L715)
...
`BindBundleSource` (method, L526), `BindClearIngress` (method, L402), `BindCompactIngress` (method, L411), `BindDerived` (method, L760), `BindDormant` (method, L792), `BindFinalizeBundles` (method, L452), `BindInitializeGraph` (method, L377), `BindInitializeOwnership` (method, L392), `BindInitializeVisibility` (method, L746), `BindInverse` (method, L578), `BindPreparePages` (method, L505), `BindProof` (method, L631), `BindPublication` (method, L841), `BindReleaseProbation` (method, L498), `BindSchedule` (method, L461), `BindScheduleDiagnostics` (method, L485), `BindTransition` (method, L702), `CeilDiv` (method, L965), `DispatchIndirect` (method, L884), `Intrinsics` (method, L961), `PoseMatrix` (method, L958), `RecordCanonicalQuantum` (method, L260), `RecordCanonicalRound` (method, L281), `RecordDerivedQuantum` (method, L366), `RecordDormantStage` (method, L345), `RecordIngress` (method, L211), `RecordInitialize` (method, L199), `RecordInverseStage` (method, L624), `RecordProofClosureStage` (method, L352), `RecordPublicationStage` (method, L359), `RequireCommand` (method, L928), `RequireShader` (method, L920), `Set` (method, L934), `SetFrameMatrices` (method, L891), `SetInt` (method, L950), `SetTexture` (method, L942), `SetUInt` (method, L954), `SigmaStreamingGraph` (class, L12)
