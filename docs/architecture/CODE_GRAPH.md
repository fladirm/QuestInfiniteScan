...
Source digest: `760e03f86e8cf8f2310c6922f8b62852f2aa47afe6bd0845f78476426cffe2c0`

Scope: 111 files, 1590 symbols, 1303 functions/methods, 67 GPU kernels, 4 event links.
...
`ClearInverseWorkGraph` (gpu_function, L115), `CommitInverseTransactions` (gpu_function, L392), `CompactInverseWork` (gpu_function, L139), `PlanRawReservations` (gpu_function, L299), `PrepareInverseTransactions` (gpu_function, L234), `SigmaCompactMorton` (gpu_function, L86), `SigmaPairFree` (gpu_function, L104), `SigmaSignedMortonLimb` (gpu_function, L97), `SigmaWorkNullLane` (gpu_function, L60), `SigmaWorkPrefix` (gpu_function, L71), `ClearInverseWorkGraph` (gpu_kernel, L1), `CommitInverseTransactions` (gpu_kernel, L5), `CompactInverseWork` (gpu_kernel, L2), `PlanRawReservations` (gpu_kernel, L4), `PrepareInverseTransactions` (gpu_kernel, L3)
...
`BuildFoldedPage` (method, L259), `CreateColor` (method, L305), `CreateDepth` (method, L319), `Destroy` (method, L368), `DrawPrediction` (method, L340), `ExactLiftReadoutRoundTripsAndNullHasNoContact` (method, L52), `FillPatch` (method, L269), `GpuReadoutAndRasterSelectNearFoldWhileNullStaysEmpty` (method, L70), `Pack` (method, L287), `PageMeta` (struct, L35), `SigmaForwardReadoutTests` (class, L11), `UInt2` (struct, L19), `UInt4` (struct, L26)
