...
Source digest: `8d93e5b1143d7153b82f5611f1daf1893065dd00ef4b14faf2f95f01a17fa9db`

Scope: 133 files, 2152 symbols, 1730 functions/methods, 112 GPU kernels, 6 event links.
...
`EvaluateTransactionMicrotile` (gpu_function, L1224), `EvaluateTransactionRgbLeft` (gpu_function, L979), `EvaluateTransactionRgbRight` (gpu_function, L988), `MeetTransactionMicrotile` (gpu_function, L998), `PrepareTransactionMicrotile` (gpu_function, L832), `SigmaEvalAccumulateKey` (gpu_function, L564), `SigmaEvalAdvanceTransaction` (gpu_function, L790), `SigmaEvalBuildBootstrap` (gpu_function, L424), `SigmaEvalBuildProjective` (gpu_function, L475), `SigmaEvalButterflyStage` (gpu_function, L336), `SigmaEvalCompletePhase` (gpu_function, L247), `SigmaEvalFailWork` (gpu_function, L156), `SigmaEvalFullBounds` (gpu_function, L416), `SigmaEvalHadamard` (gpu_function, L361), `SigmaEvalLoadPreparedProjective` (gpu_function, L773), `SigmaEvalMeet` (gpu_function, L574), `SigmaEvalOwnerY` (gpu_function, L151), `SigmaEvalPrepareGroup` (gpu_function, L174), `SigmaEvalReduceValidity` (gpu_function, L400), `SigmaEvalRgbEye` (gpu_function, L596), `SigmaEvalSample` (gpu_function, L123), `SigmaEvaluateTransactionRgb` (gpu_function, L915), `SigmaStreamAssociationContact` (gpu_function, L300), `SigmaStreamAssociationEye` (gpu_function, L279), `SigmaStreamAssociationMatchesTarget` (gpu_function, L314), `SigmaStreamAssociationSame` (gpu_function, L306), `SigmaStreamCombineOutcome` (gpu_function, L322), `SigmaStreamEvalAddress` (gpu_function, L112), `SigmaStreamJointAddress` (gpu_function, L105), `SigmaStreamLoadCurrentBundle` (gpu_function, L130), `SigmaStreamNullLane` (gpu_function, L94), `SigmaStreamSampleAddress` (gpu_function, L118), `if` (gpu_function, L1162), `EvaluateTransactionMicrotile` (gpu_kernel, L5), `EvaluateTransactionRgbLeft` (gpu_kernel, L2), `EvaluateTransactionRgbRight` (gpu_kernel, L3), `MeetTransactionMicrotile` (gpu_kernel, L4), `PrepareTransactionMicrotile` (gpu_kernel, L1)
...
`AppendRange` (method, L877), `AppendTo` (method, L317), `AppendTo` (method, L355), `AppendTo` (method, L478), `AppendTo` (method, L583), `Batch` (class, L228), `BitsToFloat` (method, L601), `BufferKind` (enum, L215), `Complete` (method, L135), `Copy` (method, L851), `Dispose` (method, L205), `FormatLogLine` (method, L785), `From` (method, L671), `IsDue` (method, L40), `IsFinite` (method, L604), `Request` (method, L120), `RequestFailed` (method, L669), `RequestRange` (method, L127), `SelectNextReadoutPage` (method, L178), `Set` (method, L265), `SigmaDiagnosticTelemetry` (class, L13), `SigmaReadoutVertexTelemetry` (struct, L519), `SigmaRuntimeTelemetrySnapshot` (class, L608), `SigmaRuntimeTimingTelemetry` (struct, L332), `SigmaStageLatencyTelemetry` (struct, L301), `SigmaTransactionTelemetry` (struct, L372), `Tick` (method, L43), `WeightedLoad` (method, L859), `Word` (method, L201), `Word` (method, L514), `Word` (method, L869)
...
`AbsNanoseconds` (method, L1001), `Add` (method, L1196), `AdvanceAge` (method, L1178), `AdvanceAge` (method, L1286), `Begin` (method, L1265), `BuildTrackingPriorEnvelope` (method, L739), `CaptureTimingTelemetry` (method, L257), `CeilDiv` (method, L1036), `Complete` (method, L1326), `CountPendingTickets` (method, L949), `CreateArrayTexture` (method, L1050), `CreateBuffer` (method, L1046), `CreatePersistentResources` (method, L837), `DestroyTexture` (method, L1080), `Dispose` (method, L1339), `ElapsedMilliseconds` (method, L1179), `ElapsedMilliseconds` (method, L1287), `EnsureCalibration` (method, L809), `EnsureFrameResources` (method, L1289), `EnsurePosePartials` (method, L1314), `FillCalibration` (method, L884), `FillRgbCalibration` (method, L920), `FindKernels` (method, L822), `FromRaw` (method, L1160), `IndependenceKey` (method, L1011), `IngressSlot` (class, L1217), `IntrinsicsVector` (method, L1008), `LatchCompletionFault` (method, L519), `LateUpdate` (method, L205), `LatencyTracker` (class, L1184), `MaxRigRotationResidual` (method, L796), `MaxRigTranslationResidual` (method, L783), `Mix` (method, L1031), `NextPowerOfTwo` (method, L1039), `NextRevision` (method, L984), `OnDestroy` (method, L1091), `OnModuleInitialize` (method, L113), `OnPredictionReady` (method, L197), `OnScanStarted` (method, L172), `OnScanStopped` (method, L188), `Poll` (method, L1181), `Poll` (method, L1283), `PollCanonical` (method, L477), `PollDerived` (method, L498), `PollIngress` (method, L447), `PollInitialization` (method, L426), `PoseMatrix` (method, L1006), `RecordClassification` (method, L555), `RecordCorrectedCalibration` (method, L679), `RecordGraphInitialization` (method, L273), `RecordNormalize` (method, L530), `RecordPoseGauge` (method, L625), `ReleasePendingIngress` (method, L965), `Reset` (method, L1208), `SaturatingAdd` (method, L1004), `SetQ` (method, L992), `SetQRaw` (method, L995), `SetRgbQ` (method, L997), `SetRgbQRaw` (method, L999), `SigmaInverseController` (class, L22), `SigmaPackedQ48` (struct, L1151), `Submission` (class, L1163), `SubmitCanonicalAndDerived` (method, L376), `SubmitIngress` (method, L293), `TrackLast` (method, L971), `TryGetFreeIngressSlot` (method, L936), `UpdatePeak` (method, L977), `UploadExactCalibration` (method, L706), `UploadPosePrior` (method, L719)
...
`BindBundleSource` (method, L528), `BindClearIngress` (method, L404), `BindCompactIngress` (method, L413), `BindDerived` (method, L772), `BindDormant` (method, L804), `BindFinalizeBundles` (method, L454), `BindInitializeGraph` (method, L377), `BindInitializeOwnership` (method, L394), `BindInitializeVisibility` (method, L758), `BindInverse` (method, L582), `BindPreparePages` (method, L507), `BindProof` (method, L635), `BindPublication` (method, L857), `BindReleaseProbation` (method, L500), `BindSchedule` (method, L463), `BindScheduleDiagnostics` (method, L487), `BindTransition` (method, L714), `CeilDiv` (method, L981), `DispatchIndirect` (method, L900), `Intrinsics` (method, L977), `PoseMatrix` (method, L974), `RecordCanonicalQuantum` (method, L260), `RecordCanonicalRound` (method, L281), `RecordDerivedQuantum` (method, L366), `RecordDormantStage` (method, L345), `RecordIngress` (method, L211), `RecordInitialize` (method, L199), `RecordInverseStage` (method, L628), `RecordProofClosureStage` (method, L352), `RecordPublicationStage` (method, L359), `RequireCommand` (method, L944), `RequireShader` (method, L936), `Set` (method, L950), `SetFrameMatrices` (method, L907), `SetInt` (method, L966), `SetTexture` (method, L958), `SetUInt` (method, L970), `SigmaStreamingGraph` (class, L12)

### `Runtime/SigmaPrism/SigmaStreamingResources.cs`

`BufferBytes` (method, L334), `CreateStructured` (method, L313), `Dispose` (method, L345), `DisposeBuffer` (method, L418), `SigmaStreamingResources` (class, L14), `SumBytes` (method, L337), `ValidateBinding` (method, L321), `ValidateGeneratedAbi` (method, L262), `ValidateTransientBudget` (method, L250)
...
`AssertProofEqual` (method, L740), `Bind` (method, L771), `Bounds` (method, L760), `BoundsEqual` (method, L726), `BoundsGpu` (struct, L41), `BuildPartitionedProofEvidence` (method, L627), `CloseProof` (method, L679), `HistoricalSnapshotIsPinnedAndNeverUpgradesInFlight` (method, L248), `MeetCertificates` (method, L685), `PageMetadataGpu` (struct, L17), `ProofCertificate` (method, L667), `ProofClosureIsIndependentOfWindowsAndInterleaving` (method, L433), `ProofGpuReverseSweepMatchesCanonicalEssentialSet` (method, L459), `ReadCompute` (method, L777), `ReadScript` (method, L784), `ReplayWindows` (method, L698), `SigmaStreamingContractTests` (class, L12), `StreamingRepairContractUsesProductionBindingsAndClosure` (method, L139), `StreamingWorkGraphKernelsAndHistoricalRasterCompile` (method, L48), `TransactionTelemetryDecodesExecutionGeneration` (method, L208), `U4` (method, L755), `UInt2Gpu` (struct, L34)
