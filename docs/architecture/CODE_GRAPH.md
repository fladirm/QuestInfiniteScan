...
Source digest: `c42a93604f1dd098753f667e7d217ab6fe86c067bc0e384cac3452edb9ad0a13`

Scope: 107 files, 1588 symbols, 1290 functions/methods, 73 GPU kernels, 4 event links.
...
`EvidenceTransferSurvivesExactFrameSlotReuse` (method, L86), `ExecutionWindowsAndDirectDispatchesRespectVulkanDimensions` (method, L61), `GeneratedFrameAbiHasExactManagedStrides` (method, L23), `SigmaFrameResourceTests` (class, L11), `SourceStorageIsCompleteAndSegmentRangeNeverExceedsBinding` (method, L44), `UInt4` (struct, L14), `VulkanFixtureCompilesAllRecordsWithinEightUavs` (method, L148)
