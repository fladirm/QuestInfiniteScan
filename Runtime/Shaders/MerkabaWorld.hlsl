...
#define M8_COUNTER_DUAL_QUERY_BLOCKS 31u
#define M8_COUNTER_WRITEBACK_TILES 32u
#define M8_COUNTER_READOUT_UNRESOLVED 33u
#define M8_COUNTER_EVICTION_NEEDED 34u
#define M8_COUNTER_OBSERVATION_FAILURE 35u
#define M8_COUNTER_FAILED_OBSERVATIONS 36u
#define M8_COUNTER_FREE_TILE_COUNT 37u
#define M8_COUNTER_EVICTION_CLEAN_BUDGET 38u
#define M8_COUNTER_OBSERVATION_CHANGE_MASK 39u
#define M8_OBSERVATION_CHANGED_R1 1u
#define M8_OBSERVATION_CHANGED_DUAL 2u
#define M8_COUNTER_DIRTY_TILE_COUNT 40u
#define M8_COUNTER_THROUGH_EVIDENCE_DECREMENTS 41u
#define M8_COUNTER_THROUGH_OCCUPIED_TO_FREE 42u
#define M8_COUNTER_UNRESOLVED_OBSERVATION_TILES 43u
#define M8_COUNTER_RESIDENCY_EPOCH 44u
#define M8_COUNTER_NEW_TILE_RESERVATION_BASE 45u
#define M8_COUNTER_EVICTION_CLEAN_TICKET 46u
#define M8_COUNTER_CLEANUP_TOUCHED_COUNT 47u
#define M8_COUNTER_CLEANUP_PENDING_COUNT 48u
#define M8_COUNTER_READOUT_EMITTED_TRIANGLES 49u
#define M8_COUNTER_READOUT_EMITTED_VERTICES 50u
#define M8_COUNTER_DUAL_STORAGE_INTENT_COUNT 51u
#define M8_COUNTER_DUAL_TOUCH_PUBLICATION 52u
#define M8_COUNTER_REFINEMENT_PENDING_TILES 53u
#define M8_COUNTER_REFINEMENT_WORK_PROGRESS 54u
#define M8_COUNTER_REFINEMENT_BACKPRESSURE 55u
#define M8_COUNTER_REFINEMENT_UNRESOLVED 56u
#define M8_COUNTER_COUNT 57u
